...
-----------40-41 Badlands
	[4041] = {
		...
		items = {
			...
			[2] = { str = "Go to #COORDS[53,43]# accept “Fiery Blaze Enchantment”, “Mirages”, and “A Dwarf and His Tools”", x = 53, y = 43, zone = "Badlands" },
			[3] = { str = "Stop at #COORDS[42,52]# and hand in “Martek the Exiled” accept “Indurium”", x = 45, y = 52, zone = "Badlands" },
			...
			[6] = { str = "Go to #COORDS[25,44]# and accept “Study of the Elements: Rock pt.1” and “Coolant Heads Prevail” then turn it back in and accept “Gyro… What?” then turn that back in. ", x = 25, y = 44, zone = "Badlands" },
			...
			[16] = { str = "Go up to #COORDS[42,52]# and turn in “Barbecued Buzzard Wings” and “Indurium” accept “News for Fizzle”", x = 45, y = 52, zone = "Badlands" },
			[17] = { str = "Go to #COORDS[18,41]# and kill the lesser rock elementals for “Study of the Elements: Rock pt.1” and “Badlands Reagent Run”", x = 18, y = 41, zone = "Badlands" },
			[18] = { str = "Go back to #COORDS[26,44]# turn in “Study of the Elements: Rock pt.1” accept “Study of the Elements: Rock pt.2” and do it by killing rock elemental", x = 26, y = 44, zone = "Badlands" },
			...
			[25] = { str = "Go to #COORDS[53,43]# and turn in “Scrounging”", x = 53, y = 43, zone = "Badlands" },
			[26] = { str = "Go to #COORDS[61,54]# and turn in “Tremors of the Earth” SKIP the next part", x = 61, y = 54, zone = "Badlands" },
...
-----------41-41 Swamp of Sorrows
	[4141] = {
		...
		items = {
			...
			[2] = { str = "Run into the Swamp of Sorrows, go to #COORDS[12,58]# and kill the whelps for “Dream Dust In the Swamp” low droprate but they respawn fast", x = 12, y = 58, zone = "Swamp of Sorrows" },
			[3] = { str = "Go to #COORDS[26,59]# and accept “Enroaching Wildlife” and go do it. Kill the 3 mob types around him and north. It’s all close to the quest giver", x = 26, y = 59, zone = "Swamp of Sorrows" },
			[4] = { str = "Go up and find Noboru the Cudgel he circles around #COORDS[43,38]# and drops an item that starts “Noboru the Cudgel”", x = 43, y = 38, zone = "Swamp of Sorrows" },
			[5] = { str = "Go back to #COORDS[26,59]# and turn in “Enroaching Wildlife” accept “The Lost Caravan”", x = 26, y = 59, zone = "Swamp of Sorrows" },
			[6] = { str = "Grind up to #COORDS[25,31]# and turn in “Noboru the Cudgel” accept “Draenethyst Crystals”", x = 25, y = 31, zone = "Swamp of Sorrows" },
			[7] = { str = "Go up to the sanctuary that starts at #COORDS[54,29]# and start collecting the “Draenethyst Crystals”", x = 54, y = 29, zone = "Swamp of Sorrows" },
			[8] = { str = "When you get to the last camp with the npc in the cage at #COORDS[65,18]# first grab the chest off the cart to the left for “The Lost Caravan”", x = 65, y = 18, zone = "Swamp of Sorrows" },
...
-----------41-42 Desolace
	[4142] = {
		...
		items = {
			...
			[5] = { str = "Run to #COORDS[47,61]# and accept “Ghost-O-Plasm Round Up”", x = 47, y = 61, zone = "Desolace" },
			[6] = { str = "Kill the demons around #COORDS[51,75]# for “Reagents For Reclaimers Inc pt.3”", x = 51, y = 75, zone = "Desolace" },
			[7] = { str = "Kill undead ravagers around #COORDS[61,90]# for “Down the Scarlet Path” and “Ghost-O-Plasm Round Up” between the 2 skeletons in the middle", x = 61, y = 90, zone = "Desolace" },
...
-----------42-43 Stranglethron Vale
	[4243] = {
		...
		items = {
			...
			[8] = { str = "Go out of BB and to the right and south. All around #COORDS[31,79]# You’re gonna kill the buccaneers for “Up To Snuff” and “Keep An Eye Out”", x = 31, y = 79, zone = "Stranglethorn Vale" },
			...
			[16] = { str = "Go up to the Ruins of Aboraz and kill Chucky (#COORDS[40,58]#) for “Voodoo Dues” while killing the mobs for “Zanzil's Secret” you only need 8-10", x = 40, y = 58, zone = "Stranglethorn Vale" },
			[17] = { str = "Go up to the Ruins of Jubawal and kill Jon-Jon (#COORDS[34,51]#) and Maury (#COORDS[35,51]#) for “Voodoo Dues” and the rest of “Zanzil's Secret”", x = 35, y = 51, zone = "Stranglethorn Vale" },
			[18] = { str = "Go kill Tethis for “Raptor Mastery pt.4” behind the arena around #COORDS[31,43]# then turn it in at nessingways at #COORDS[35,10]# accept “Big Game Hunter”", x = 31, y = 43, zone = "Stranglethorn Vale" },
...
-----------43-43 Tanaris
	[4343] = {
		...
		items = {
			...
			[7] = { str = "Go to The Shimmering Flats to #COORDS[77,77]# and turn in “Rumors for Kravel” accept “Back to Booty Bay”", x = 77, y = 77, zone = "Thousand Needles" },
...
-----------43-45 Feralas
	[4345] = {
		...
		items = {
			...
			[7] = { str = "Go to the gazebo at #COORDS[26,52]# and turn in “The Ruins of Solarsal” accept “Return to Feathermoon Stronghold”", x = 26, y = 52, zone = "Feralas" },
			...
			[25] = { str = "Grind east and kill the Brutes around #COORDS[60,56]#, and warlocks and shamans around #COORDS[59,66]# for “The High Wilderness” I kill any I see", x = 60, y = 56, zone = "Feralas" },
			[26] = { str = "Go up to #COORDS[65,45]# and accept “Freedom For All Creatures” It’s pretty hidden, just NW of the camp entrance is a path that doesn’t even look like you can walk on it. To do this simply escort her to the cage, open it and kill anything until it says complete. ", x = 65, y = 45, zone = "Feralas" },
			[27] = { str = "Hand it back in and accept “Doling Justice pt.1 The mobs can be found in this camp." },
			[28] = { str = "Turn “Doling Justice pt.1 in at #COORDS[65,45]# and accept “Doling Justice pt.2", x = 65, y = 45, zone = "Feralas" },
			...
			[36] = { str = "Fly out to Thalanaar (spot between 1k needles and here) turn in “Thalanaar Delivery” at #COORDS[89,46]#", x = 89, y = 46, zone = "Feralas" },
...
-----------46-47 The Hinterlands
	[4647] = {
		...
		items = {
			...
			[7] = { str = "Follow the path up to #COORDS[26,48]# and turn in “Rhapsody Shindigger” accept “Rhapsody's Kalimdor Kocktail”", x = 26, y = 48, zone = "The Hinterlands" },
			[8] = { str = "Go back down and to the troll camp and clear most of them out at #COORDS[23,58]# and open the 2 cages for “Witherbark Cages”", x = 23, y = 58, zone = "The Hinterlands" },
			...
			[17] = { str = "Go up past the FP in the cave at #COORDS[9,44]# and turn in “Witherbark Cages” accept “The Altar of Zul”", x = 9, y = 44, zone = "The Hinterlands" },
			[18] = { str = "Go run up top of the Altar of Zul at #COORDS[48,68]# for “The Altar of Zul” ", x = 48, y = 68, zone = "The Hinterlands" },
			...
			[26] = { str = "Run to the house at #COORDS[55,92]# and turn in “Favored of Elune?”", x = 55, y = 92, zone = "The Hinterlands" },
...
-----------47-47 Feralas
	[4747] = {
		...
		items = {
			...
			[6] = { str = "Beside the dock at #COORDS[44,33]# accept “Zapped Giants” and “Fuel for Zapping”", x = 44, y = 33, zone = "Feralas" },
			...
			[8] = { str = "Go back to #COORDS[44,33]# and turn in “Zapped Giants” and “Fuel for Zapping” You can now do those again, but I wouldn’t, for about 500 xp per turn in. Now he opens his store to you.", x = 44, y = 33, zone = "Feralas" },
...
-----------47-48 Tanaris
	[4748] = {
		...
		items = {
			...
			[6] = { str = "Go south to the skeleton in the ground at #COORDS[49,36]# and #COORDS[44,39]# and #COORDS[47,45]# kill Rocs for “Rhapsody's Kalimdor Kocktail” If it’s busy just do it later.", x = 49, y = 36, zone = "Tanaris" },
			[7] = { str = "Ride over to #COORDS[52,45]# turn in “The Sunken Temple” and accept “The Stone Circle” and “Gahz'Ridian”", x = 52, y = 45, zone = "Tanaris" },
			...
			[15] = { str = "Go west to #COORDS[29,66]# and kill Gnarled Thistlegrub and Thistlegrub Rootshapers for Thistleshrub Valley and the dew collectors for The Thirsty Goblin You should hit 48 here", x = 29, y = 66, zone = "Tanaris" },
			[16] = { str = "If you find Tooga, accept Tooga’s Quest I found him at #COORDS[29,73]# near the zepplin, but you can find him anywhere around this valley. He follows you, you don’t have to follow him ", x = 29, y = 73, zone = "Tanaris" },
			[17] = { str = "Go up to the noxious lair around #COORDS[34,46]# and kill centipaar there for Noxious Lair Investigation If you can’t get them all before tooga has 10 minutes left, go turn that in and then come back.", x = 34, y = 76, zone = "Tanaris" },
			[18] = { str = "Turn in Tooga’s Quest near steamwheedle port at #COORDS[66,25]#", x = 66, y = 25, zone = "Tanaris" },
			...
			[28] = { str = "Run down to #COORDS[52,45]# and turn in Gahz'Ridian", x = 52, y = 45, zone = "Tanaris" },
...
-----------48-48 The Hinterlands
	[4848] = {
		...
		items = {
			...
			[2] = { str = "Go in the base downstairs to #COORDS[14,43]# and turn in The Newest Member of the Family accept Food For Baby", x = 14, y = 43, zone = "The Hinterlands" },
			[3] = { str = "Run up to #COORDS[26,48]# and turn in Rhapsody's Kalimdor Kocktail Accept Rhapsody's Tale", x = 26, y = 48, zone = "The Hinterlands" },
			[4] = { str = "Grind down to the lake at #COORDS[40,59]# and Violet Tragan (Mushroom) from the bottom of the lake for Sprinkle's Secret Ingredient", x = 40, y = 59, zone = "The Hinterlands" },
			[5] = { str = "Grind until you’re east of #COORDS[57,47]# and kill Silvermane Stalkers for Food For Baby", x = 57, y = 47, zone = "The Hinterlands" },
...
-----------48-49 Stranglethorn Vale
	[4849] = {
		...
		items = {
			...
			[8] = { str = "Go kill gorillas around #COORDS[34,63]# for Stranglethorn Fever then go up into the cave at #COORDS[35,60]# turn it in. the guy in the cave asks for 10 gorilla fangs, then he summons 3 waves of gorillas. Mokk is in the 3rd wave. They’re all around level 42-44 it starts with 3, then 5 then I think 6 or 7. It can get tough. Just kill Mokk first in case you die.", x = 35, y = 60, zone = "Stranglethorn Vale" },
			...
			[26] = { str = "Follow the road until it forks and the left fork has a bridge at #COORDS[22,48]# and under it is A Soggy Scroll which turns in “Cortello's Riddle pt.1” accept “Cortello's Riddle pt.2”", x = 22, y = 48, zone = "Swamp of Sorrow" },
...
--------49-50 Blasted Lands
	[4950] = {
		...
		items = {
			...
			[30] = { str = "Run down into the Badlands all the way west to #COORDS[1,62]# and enter the Searing Gorge", x = 1, y = 62, zone = "Badlands" },
		}
	},
}
