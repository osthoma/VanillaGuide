...
-----------40-41 Badlands
	[4041] = {
		...
		items = {
			...
			[6] = { str = "Go to #C_[25,44]# and accept 'Study of the Elements: Rock'and 'Coolant Heads Prevail' then turn it back in and accept 'Gyro… What?' then turn that back in.", x = 25, y = 44, zone = "Badlands" },
			...
			[17] = { str = "Go to #C_[18,41]# and kill the lesser rock elementals for 'Study of the Elements: Rock'and 'Badlands Reagent Run'.", x = 18, y = 41, zone = "Badlands" },
			[18] = { str = "Go back to #C_[26,44]# turn in 'Study of the Elements: Rock. Accept 'Study of the Elements: Rock'(2) and do it by killing rock elemental.", x = 26, y = 44, zone = "Badlands" },
			[19] = { str = "Go back to #C_[26,44]# turn in 'Study of the Elements: Rock(2). Accept 'Study of the Elements: Rock'(3).", x = 26, y = 44, zone = "Badlands" },
			...
			[23] = { str = "Go back to #C_[26,44]# turn in 'Study of the Elements: Rock(3). Accept 'This Is Going To Be Hard'turn around and hand it in, accept 'This Is Going To Be Hard'(2) then turn around and hand it in, accept 'This Is Going To Be Hard'(3).", x = 26, y = 44, zone = "Badlands" },
...
-----------41-42 Desolace
	[4142] = {
		...
		items = {
			...
			[4] = { str = "Go down accept 'Reagents For Reclaimers Inc'(3)." },
			[5] = { str = "Run to #C_[47,61]# and accept 'Ghost-O-Plasm Round Up'.", x = 47, y = 61, zone = "Desolace" },
			[6] = { str = "Kill the demons around #C_[51,75]# for 'Reagents For Reclaimers Inc'(3).", x = 51, y = 75, zone = "Desolace" },
			...
			[12] = { str = "Go just south of the Inn, turn in 'Reagents For Reclaimers Inc(3). Accept 'Reagents For Reclaimers Inc'(4)." },
			[13] = { str = "Fly to Theramore, Boat to #A_Menethil Harbor# and Fly to #A_Ironforge#." },
			[14] = { str = "Turn in 'Reagents For Reclaimers Inc'(4) at #C_[67,17]#.", x = 67, y = 17, zone = "Ironforge" },
...
-----------42-43 Stranglethron Vale
	[4243] = {
		...
		items = {
			...
			[3] = { str = "Make #A_Booty Bay# your home." },
			[4] = { str = "Accept 'Zanzil's Secret' and 'Whiskey Slim's Lost Grog'." },
			[5] = { str = "Go near the Bank, accept 'Akiris By the Bundle '." },
			...
			[8] = { str = "Go out of #A_Booty Bay# and to the right and south. All around #C_[31,79]# You’re gonna kill the buccaneers for #Q_'Up To Snuff'# and #Q_'Keep An Eye Out'#.", x = 31, y = 79, zone = "Stranglethorn Vale" },
			[9] = { str = "Kill the swashbucklers around the two camps at #C_[29,81]#(bloodsail charts are here on the box) and #C_[27,82]# (bloodsail orders, on the box, NE tent) for 'The Bloodsail Buccaneers'(4).", x = 27, y = 82, zone = "Stranglethorn Vale" },
			[10] = { str = "Run back up into #A_Booty Bay#, and turn left." },

			[11] = { str = "Turn in #Q_'Keep An Eye Out'# near the forge." },
			[12] = { str = "Go up in the Inn, turn in #Q_'Up To Snuff'#." },
			[13] = { str = "Go just outside and hand in 'The Bloodsail Buccaneers(4). Accept 'The Bloodsail Buccaneers'(5)." },
			[14] = { str = "Go kill naga around #C_[25,63]# for 'Akiris By the Bundle '.", x = 25, y = 63, zone = "Stranglethorn Vale" },
			[15] = { str = "Grind on the nagas until you’re at least 50% into 43." },
			[16] = { str = "Go up to the Ruins of Aboraz and kill Chucky (#C_[40,58]#) for #Q_'Voodoo Dues'# while killing the mobs for 'Zanzil's Secret' you only need 8-10.", x = 40, y = 58, zone = "Stranglethorn Vale" },
			[17] = { str = "Go up to the Ruins of Jubawal and kill Jon-Jon (#C_[34,51]#) and Maury (#C_[35,51]#) for #Q_'Voodoo Dues'# and the rest of 'Zanzil's Secret'.", x = 35, y = 51, zone = "Stranglethorn Vale" },
			[18] = { str = "Go kill Tethis for 'Raptor Mastery'(4) behind the arena around #C_[31,43]# then turn it in at nessingways at #C_[35,10]# accept #Q_'Big Game Hunter'#.", x = 31, y = 43, zone = "Stranglethorn Vale" },
...
-----------43-43 Tanaris
	[4343] = {
		...
		items = {
			...
			[14] = { str = "Go to around #C_[63,30]# and kill the mobs here for #Q_'Wastewander Justice'# and #Q_'Water Pouch Bounty'# Look for Caliph Scorpidsting and kill him for 'WANTED: Caliph Scorpidsting' while here. He has 2 stealthed guards but is fairly easy. He patrols up and down.", x = 63, y = 30, zone = "Tanaris" },
			[15] = { str = "Run over to the cave at #C_[68,41]# and go through to Lost Rigger Cove.", x = 68, y = 41, zone = "Tanaris" },
			[16] = { str = "Start killing the mobs all back here for #Q_'Southsea Shakedown'# and 'Pirate Hats Ahoy!'." },
...
-----------43-45 Feralas
	[4345] = {
		...
		items = {
			...
			[4] = { str = "Go into the big building across from the Inn, accept 'The Missing Courier'and 'The Ruins of Solarsal'." },
			[5] = { str = "Go to the building just west accept #Q_'In Search of Knowledge'# and #Q_'The High Wilderness'#." },
			[6] = { str = "Go upstairs turn in 'The Missing Courier. Accept 'The Missing Courier'(2)." },
			...
			[8] = { str = "Go back to Feathermoon to the big building, turn in #Q_'Return to Feathermoon Stronghold'# accept 'Against the Hatecrest'turn around and hand it in accept 'Against the Hatecrest'(2)." },
			[9] = { str = "Kill naga around #C_[26,54]# for 'Against the Hatecrest'(2).", x = 26, y = 54, zone = "Feralas" },
			...
			[11] = { str = "Go back to Feathermoon to the big building, turn in 'Against the Hatecrest(2). Accept 'Against Lord Shalzaru'." },
			...
			[17] = { str = "Go down to #C_[45,65]# and touch the wrecked boat to turn in 'The Missing Courier(2). Accept 'Boat Wreckage'.", x = 45, y = 65, zone = "Feralas" },
			...
			[27] = { str = "Hand it back in and accept 'Doling Justice The mobs can be found in this camp." },
			[28] = { str = "Turn 'Doling Justice in at #C_[65,45]# and accept 'Doling Justice(2).", x = 65, y = 45, zone = "Feralas" },
...
-----------46-47 The Hinterlands
	[4647] = {
		...
		items = {
			...
			[7] = { str = "Follow the path up to #C_[26,48]# and turn in #Q_'Rhapsody Shindigger'# accept 'Rhapsody's Kalimdor Kocktail'.", x = 26, y = 48, zone = "The Hinterlands" },
			...
			[11] = { str = "Go NE up to #C_[46,42]#, collecting feathers if you still need them on the way, and kill the Green Sludges for 'Skulk Rock Clean-Up'.", x = 46, y = 62, zone = "The Hinterlands" },
			[12] = { str = "Go to #C_[49,37]# if you found OOX-09/HL Distress Beacon.", x = 49, y = 37, zone = "The Hinterlands" },
			[13] = { str = "Go to #C_[56,41]# and kill Jade Oozes for of 'Skulk Rock Clean-Up'(2).", x = 56, y = 41, zone = "The Hinterlands" },
...
-----------47-48 Tanaris
	[4748] = {
		...
		items = {
			...
			[7] = { str = "Ride over to #C_[52,45]# turn in #Q_'The Sunken Temple'# and accept #Q_'The Stone Circle'# and 'Gahz'Ridian'.", x = 52, y = 45, zone = "Tanaris" },
			...
			[33] = { str = "Go back up on the hill, turn in Insect Part Analysis(2) accept Rise of the Silithid." },
...
-----------48-49 Stranglethorn Vale
	[4849] = {
		...
		items = {
			...
			[14] = { str = "Run to the shore just east of #A_Booty Bay# and open blue bottles until you get Carefully Folded Note which starts Message in A Bottle." },
			...
			[16] = { str = "Go to #C_[38,80]# and turn in Message in A Bottle SKIP the next part, unless you can get a group to kill the 51 ape.", x = 38, y = 80, zone = "Stranglethorn Vale" },
			[17] = { str = "Go down to the pirate ships, 1 is at #C_[33,87]# and the other 2 are at #C_[30,88]# You want to go to the 2nd floor near the front of the ship and kill the captain of each for 'The Bloodsail Buccaneers'(5).", x = 33, y = 87, zone = "Stranglethorn Vale" },
			[18] = { str = "Look for a scroll on one of the ships called Cortello's Riddle which starts 'Cortello's Riddle '." },
