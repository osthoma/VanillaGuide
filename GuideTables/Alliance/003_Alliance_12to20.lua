...
-----------12-14 Darkshore
	[1214] = {
		...
		items = {
			...
			[2] = { str = "Once you land grab Washed Ashore pt.1 right in front of you at #C_[37,46]#.", x = 37, y = 46, zone = "Darkshore" },
			...
			[8] = { str = "Buy some 6 slot bags if you haven’t found 3 by now at #C_[37,40]# then grab Bashal'Aran pt.1 and Tools of the Highborne.", x = 37, y = 40, zone = "Darkshore" },
			[9] = { str = "Go south over the bridge, grab Plagued Lands." },
			[10] = { str = "Run inside, grab How Big a Threat? pt.1." },

			[11] = { str = "Go do Washed Ashore pt.1 at #C_[36,50]# grind from town to there to get Crawler legs for Buzzbox 827.", x = 36, y = 50, zone = "Darkshore" },
			...
			[14] = { str = "Do Washed Ashore pt.2 at #C_[31,46]# in the water west of boat dock. Turn it in.", x = 31, y = 46, zone = "Darkshore" },
			...
			[17] = { str = "Bashal'Aran pt.1 at #C_[44,36]# grinding along the way, accept Bashal'Aran pt.2 killing grells around him for earrings.", x = 44, y = 36, zone = "Darkshore" },
			[18] = { str = "Turn in Bashal'Aran pt.2 at #C_[44,36]# accept Bashal’Aran pt.3.", x = 44, y = 36, zone = "Darkshore" },
			...
			[21] = { str = "Grind to #C_[40,53]# to find the camp for How Big a Threat? pt.1.", x = 40, y = 53, zone = "Darkshore" },
...
-----------14-17 Darkshore
	[1417] = {
		...
		items = {
			...
			[2] = { str = "Go back to Darkshore. Turn in Trouble In Darkshore? at #C_[37,42]#. Then turn in Bashal’Aran pt.4 at #C_[44,36]#.", x = 44, y = 36, zone = "Darkshore" },
			...
			[30] = { str = "Go to #C_[54,24]# turn in The Tower of Althalaxx pt.1 Accept The Tower of Althalaxx pt.2 do it. Kill any mob around the tower, NOT in it.", x = 54, y = 24, zone = "Darkshore" },
...
-----------17-18 Loch Modan
	[1718] = {
		...
		items = {
			...
			[17] = { str = "Run up to the dam from the west side and accept A Dark Threat Looms pt.1 at #C_[45,13]# then run out the east entrance and turn it in on the barrel guarded by 2 sappers accept A Dark Threat Looms pt.2.", x = 45, y = 13, zone = "Loch Modan" },
			[18] = { str = "Turn in A Dark Threat Looms pt.2 at #C_[45,13]#.", x = 45, y = 13, zone = "Loch Modan" },
			[19] = { str = "Run down the west coast Turn in Excavation Progress Report in Thelsamar, accept Report to Ironforge." },
			[20] = { str = "Go to #C_[38,61]# and do Vyrin's Revenge pt.1.", x = 38, y = 61, zone = "Loch Modan" },
