...
-----------12-14 Darkshore
	[1214] = {
		...
		items = {
			...
			[2] = { str = "Once you land grab Washed Ashore right in front of you at #C_[37,46]#.", x = 37, y = 46, zone = "Darkshore" },
			...
			[4] = { str = "Make Auberdine your home. Run out on the docks of Auberdine grab For Love Eternal at #C_[35,43]#.", x = 35, y = 43, zone = "Darkshore" },
			...
			[8] = { str = "Buy some 6 slot bags if you haven’t found 3 by now at #C_[37,40]# then grab Bashal'Aran and Tools of the Highborne.", x = 37, y = 40, zone = "Darkshore" },
			[9] = { str = "Go south over the bridge, grab Plagued Lands." },
			[10] = { str = "Run inside, grab How Big a Threat?." },

			[11] = { str = "Go do Washed Ashore at #C_[36,50]# grind from town to there to get Crawler legs for Buzzbox 827.", x = 36, y = 50, zone = "Darkshore" },
			[12] = { str = "Turn in Buzzbox 827 at #C_[36,46]# accept Buzzbox 411.", x = 36, y = 46, zone = "Darkshore" },
			[13] = { str = "Turn in Washed Ashore accept Washed Ashore (2)." },
			[14] = { str = "Do Washed Ashore (2) at #C_[31,46]# in the water west of boat dock. Turn it in.", x = 31, y = 46, zone = "Darkshore" },
			[15] = { str = "Buzzbox 411 Threshers look like loch ness in the water, Turn it in at #C_[41,28]# accept Buzzbox 323.", x = 41, y = 28, zone = "Darkshore" },
			[16] = { str = "Stop at #C_[42,32]# accept Beached Sea Creature.", x = 42, y = 32, zone = "Darkshore" },
			[17] = { str = "Bashal'Aran at #C_[44,36]# grinding along the way, accept Bashal'Aran (2) killing grells around him for earrings.", x = 44, y = 36, zone = "Darkshore" },
			[18] = { str = "Turn in Bashal'Aran (2) at #C_[44,36]# accept Bashal’Aran (3).", x = 44, y = 36, zone = "Darkshore" },
			[19] = { str = "Do Bashal’Aran (3) by killing satyr’s and turn it in accept Bashal’Aran (4)." },
			[20] = { str = "Grind to #C_[47,48]# and do The Red Crystal.", x = 47, y = 48, zone = "Darkshore" },

			[21] = { str = "Grind to #C_[40,53]# to find the camp for How Big a Threat?.", x = 40, y = 53, zone = "Darkshore" },
			[22] = { str = "Run down to Ameth’Aran at #C_[40,59]# and accept The Fall of Ameth'Aran do it at #C_[43,58]# and #C_[42,63]#.", x = 40, y = 59, zone = "Darkshore" },
			[23] = { str = "Do Tools of the Highborne while in here, killing mobs for them." },
			[24] = { str = "Do For Love Eternal at #C_[41,58]# she’s lvl 16 but easy.", x = 41, y = 58, zone = "Darkshore" },
			[25] = { str = "Do Bashal’Aran (4) at #C_[42,61]#.", x = 42, y = 61, zone = "Darkshore" },
			...
			[29] = { str = "Go inside hand in How Big a Threat? accept How Big a Threat? Pt.2." },
			[30] = { str = "Accept Thundris Windweaver." },

			[31] = { str = "Go Upstairs accept The Tower of Althalaxx." },
...
-----------14-17 Darkshore
	[1417] = {
		...
		items = {
			...
			[2] = { str = "Go back to Darkshore. Turn in Trouble In Darkshore? at #C_[37,42]#. Then turn in Bashal’Aran (4) at #C_[44,36]#.", x = 44, y = 36, zone = "Darkshore" },
			[3] = { str = "Kill Moonstalkers and Rabid Thistle Bears all around #C_[48,30]# while you head to #C_[50,25]# for The Cliffspring River.", x = 50, y = 25, zone = "Darkshore" },
			[4] = { str = "Accept Beached Sea Turtle at #C_[44,20]#.", x = 44, y = 20, zone = "Darkshore" },
			[5] = { str = "Turn in Buzzbox 323 at #C_[51,24]# accept Buzzbox 525.", x = 51, y = 24, zone = "Darkshore" },
			[6] = { str = "Go to #C_[54,32]# and do Cave Mushrooms.", x = 54, y = 32, zone = "Darkshore" },
			[7] = { str = "Head south stopping at #C_[47,48]# to turn in As Water Cascades accept The Fragments Within.", x = 47, y = 48, zone = "Darkshore" },
			[8] = { str = "Grind to #C_[40,53]# and do How Big a Threat? Pt.2.", x = 40, y = 53, zone = "Darkshore" },
			[9] = { str = "Stop at #C_[37,62]# and grab Beached Sea Turtle.", x = 37, y = 62, zone = "Darkshore" },
			[10] = { str = "Follow the shore and grab another Beached Sea Creature at #C_[36,70]#.", x = 36, y = 70, zone = "Darkshore" },

			[11] = { str = "Turn in Grove of the Ancients at #C_[43,76]# if you have it.", x = 43, y = 76, zone = "Darkshore" },
			...
			[19] = { str = "Accept The Absent Minded Prospector at #C_[37,41]#.", x = 37, y = 41, zone = "Darkshore" },
			...
			[30] = { str = "Go to #C_[54,24]# turn in The Tower of Althalaxx Accept The Tower of Althalaxx (2) do it. Kill any mob around the tower, NOT in it.", x = 54, y = 24, zone = "Darkshore" },

			[31] = { str = "Hand in The Tower of Althalaxx (2) accept The Tower of Althalaxx (3)." },
...
-----------17-18 Loch Modan
	[1718] = {
		...
		items = {
			...
			[2] = { str = "Stop right in Loch Modan tower at #C_[24,18]# and accept Filthy Paws and Stormpike's Order.", x = 24, y = 18, zone = "Loch Modan" },
			[3] = { str = "Run in the Cave at #C_[35,18]# and do Filthy Paws Boxes are on the ground. Then turn it back in at #C_[24,18]#.", x = 35, y = 18, zone = "Loch Modan" },
			[4] = { str = "Arrive at Thelsamar get Flight Point at #C_[33,50]#.", x = 33, y = 50, zone = "Loch Modan" },
			[5] = { str = "Grab Ironband's Excavation in the last house on the right." },
			[6] = { str = "Turn in Ironband's Excavation at #C_[64,66]# Accept Gathering Idols.", x = 64, y = 66, zone = "Loch Modan" },
			[7] = { str = "Grab Excavation Progress Report at #C_[65,65]#.", x = 65, y = 65, zone = "Loch Modan" },
			...
			[12] = { str = "Turn in A Hunter's Boast accept A Hunter's Challenge do it,mobs are around #C_[75,41]#.", x = 75, y = 41, zone = "Loch Modan" },
			[13] = { str = "Turn in A Hunter's Challenge Accept Vyrin's Revenge." },
			[14] = { str = "Go to #C_[63,47]# and accept Bingles' Missing Supplies. Requieries pre-quest Find Bingles from Gnoarn at #C_[69,50]# in Ironforge.", x = 63, y = 47, zone = "Loch Modan" },
			[15] = { str = "Do Crocolisk Hunting here on the shore and the island at #C_[54,38]#.", x = 54, y = 38, zone = "Loch Modan" },
			[16] = { str = "Grab all the parts for Bingles' Missing Supplies at (#C_[54,27]# blastencapper), (#C_[48,30]# wrench), (#C_[51,23]# hammer), (#C_[48,20]# screwdriver).", x = 54, y = 27, zone = "Loch Modan" },
			[17] = { str = "Run up to the dam from the west side and accept A Dark Threat Looms at #C_[45,13]# then run out the east entrance and turn it in on the barrel guarded by 2 sappers accept A Dark Threat Looms (2).", x = 45, y = 13, zone = "Loch Modan" },
			[18] = { str = "Turn in A Dark Threat Looms (2) at #C_[45,13]#.", x = 45, y = 13, zone = "Loch Modan" },
			[19] = { str = "Run down the west coast Turn in Excavation Progress Report in Thelsamar, accept Report to Ironforge." },
			[20] = { str = "Go to #C_[38,61]# and do Vyrin's Revenge.", x = 38, y = 61, zone = "Loch Modan" },

			[21] = { str = "Run back to the house at #C_[83,62]# turn in Crocolisk Hunting and Vyrin's Revenge accept Wyrin’s Revenge (2).", x = 83, y = 62, zone = "Loch Modan" },
			[22] = { str = "Turn in Wyrin’s Revenge (2) behind you." },
...
-----------18-20 Redridge Mountains
	[1820] = {
		...
		items = {
			...
			[2] = { str = "Accept Encroaching Gnolls from the patrol around #C_[15,71]#.", x = 15, y = 71, zone = "Redridge Mountains" },
			[3] = { str = "Turn in Encroaching Gnolls at #C_[30,60]# Accept Assessing the Threat.", x = 30, y = 60, zone = "Redridge Mountains" },
			...
			[12] = { str = "Then head toward #C_[41,54]# to do The Lost Tools and do Selling Fish by killing murlocs, keep an eye out for a glinting mud pile underwater for Hilary's Necklace Save at least 8 murloc fins for a later quest.", x = 41, y = 54, zone = "Redridge Mountains" },
			...
			[17] = { str = "Turn in A Free Lunch around #C_[14,70]# accept Visit the Herbalist.", x = 14, y = 70, zone = "Redridge Mountains" },
			[18] = { str = "Kill spiders for Redridge Goulash between #C_[14,70]# and #C_[29,83]#.", x = 29, y = 83, zone = "Redridge Mountains" },
