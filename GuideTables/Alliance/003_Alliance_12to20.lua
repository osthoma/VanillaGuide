...
-----------12-14 Darkshore
	...
	[1214] = {
		...
		items = {
			...
			[39] = { str = "You should be 14 by now get skills in Darnassus and be sure to accept the quest Trouble In Darkshore? from Chief Archaeologist Greywhisker at 31,84", x = 31, y = 84, zone = "Darnassus" },
		}
	},
...
-----------14-17 Darkshore
	...
	[1417] = {
		...
		items = {
			...
			[2] = { str = "Go back to Darkshore. Turn in Trouble In Darkshore? at 37,42. Then turn in  Bashal’Aran pt.4  at 44,36.", x = 44, y = 36, zone = "Darkshore" },
			...
			[7] = { str = "Head south stopping at 47,48 to turn in  As Water Cascades  accept  The Fragments Within.", x = 47, y = 48, zone = "Darkshore" },
			...
			[10] = { str = "Follow the shore and grab another  Beached Sea Creature  at 36,70.", x = 36, y = 70, zone = "Darkshore" },
			[11] = { str = "Turn in  Grove of the Ancients  at 43,76 if you have it", x = 43, y = 76, zone = "Darkshore" },
...
-----------17-18 Loch Modan
	...
	[1718] = {
		...
		items = {
			...
			[24] = { str = "If you don't have IF flight path, run down to 22,70 and follow the path North into Dun Morogh", x = 22, y = 70, zone = "Loch Modan" },
			...
			[27] = { str = "If you don't have SW flight path, get on the tram at 76,51", x = 76, y = 51, zone = "Ironforge" },
...
-----------18-20 Redridge Mountains
	...
	[1820] = {
		...
		items = {
			...
			[19] = { str = "Kill gnolls for Assessing the Threat at 31,82", x = 31, y = 82, zone = "Redridge Mountains" },
