...
-----------23-24 Darkshore
	[2324] = {
 		...
 		items = {
			...
			[6] = { str = "Fly to #A_Darnassus# and turn in The Absent Minded Prospector pt.3 outside the Temple of the Moon at #C_[31,84]# accept The Absent Minded Prospector pt.4 Get talents if you need them.", x = 31, y = 84, zone = "Darnassus" },
