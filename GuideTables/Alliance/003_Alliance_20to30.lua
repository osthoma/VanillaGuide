...
-----------20-21 Darkshore
	[2021] = {
 		...
 		items = {
			...
			[10] = { str = "Accept #Q_'The Sleeper Has Awakened'# (escort) the sleeping bear behind Onu. Hotbar his horn because he falls asleep every minute or so. This quest will bring you into Ashenvale. Horn is in the box beside him. Note: since he follows you, with aspect of the cheetah on you can skip mobs by running down the road or taking the offroad." },
 		}
	},
...
-----------21-22 Ashenvale
	[2122] = {
 		...
 		items = {
			...
			[19] = { str = "Turn in #Q_'The Ancient Statuette'# at #C_[14,31]# accept #Q_'Ruuzel'#.", x = 14, y = 31, zone = "Ashenvale" },
...
-----------22-23 Stonetalon Mountains
	[2223] = {
		...
		items = {
			...
			[5] = { str = "Kill Loggers and Deforesters for #Q_'A Gnome’s Respite'# and Operators for #Q_'Super Reaper 6000'# all around Windshear Crag. Operators hang out around buildings only." },
			[6] = { str = "Turn in #Q_'Super Reaper 6000'# at the hut #C_[58,62]# SKIP #Q_'Further Instructions'# Unless you want to run to #A_Ratchet# (#A_The Barrens#).", x = 58, y = 62, zone = "Stonetalon Mountains" },
...
-----------23-24 Darkshore
	[2324] = {
 		...
 		items = {
			...
			[16] = { str = "Run down to #C_[41,81]# and do /wave at Grimclaw He’ll point southwest at the cave. Go to it at #C_[45,85]# and turn in #Q_'A Lost Master'#(2) accept #Q_'Escape Through Force'# Run him back to Grimclaw at #C_[41,81]#.", x = 41, y = 81, zone = "Darkshore" },
...
-----------24-25 Ashenvale
	[2425] = {
 		...
 		items = {
			...
			[5] = { str = "Grind every mob down into Fire Scar Shrine and kill Ilkruk Mathrull at #C_[25,61]# for #Q_'The Tower of Althalaxx'#(5) Take him out as fast as you can. He summons 2 voidwalkers if you take too long.", x = 25, y = 61, zone = "Ashenvale" },
			[6] = { str = "Grind a path up to between #C_[35,33]# and #C_[36,36]# (he patrols) and kill Dal Bloodclaw for #Q_'Culling the Threat'#.", x = 35, y = 33, zone = "Ashenvale" },
...
-----------25-27 Wetlands
	[2526] = {
 		...
 		items = {
			...
			[11] = { str = "On the bridge accept #Q_'In Search of the Excavation Team'#." },
			[12] = { str = "Kill Young Crocolisks just east of the bridge around #C_[14,52]# and north on the land of the lake also along the road to #Q_'The Greenwarden'# for #Q_'Young Crocolisk Skins'#.", x = 14, y = 52, zone = "Wetlands" },
			[13] = { str = "Kill Bluegill Murlocs and Gobbler at #C_[18,40]# for #Q_'Claws From the Deep'#.", x = 18, y = 40, zone = "Wetlands" },
			[14] = { str = "Kill Mottled Raptors and Screechers around #C_[25,46]# to get Stone of Relu for #Q_'The Absent Minded Prospector'#(5).", x = 25, y = 46, zone = "Wetlands" },
			...
			[25] = { str = "Do #Q_'Ormer’s Revenge'#(3) atop the hill at #C_[32,51]# Sarltooth is a 29 But he’s as easy as the others. Go turn it back in at #C_[38,52]#.", x = 32, y = 51, zone = "Wetlands" },
			[26] = { str = "Go in to #Q_'Angerfang Encampment'# at #C_[43,40]# and do #Q_'War Banners'#.", x = 43, y = 40, zone = "Wetlands" },
			[27] = { str = "Stop at #C_[49,39]#. Accept #Q_'Daily Delivery'#.", x = 49, y = 39, zone = "Wetlands" },
			[28] = { str = "Run straight East from here to #C_[56,40]# and turn in #Q_'The Greenwarden'#. Accept #Q_'Tramping Paws'#.", x = 56, y = 40, zone = "Wetlands" },
			[29] = { str = "Kill Mosshide around #C_[56,74]# for #Q_'Tramping Paws'# at the camp. They’re a fast respawn I couldn’t kill em fast enough. Turn it in at #C_[56,40]# and accept #Q_'Fire Taboo'# You should be 26 by now, if not you will be soon.", x = 56, y = 74, zone = "Wetlands" },
			...
			[39] = { str = "Touch the damaged crate at #C_[13,41]# turn in #Q_'Reclaiming Goods'#. Accept #Q_'The Search Continues'#.", x = 13, y = 41, zone = "Wetlands" },
			[40] = { str = "Go just north to the next camp Touch the sealed barrel at #C_[13,38]# turn in #Q_'The Search Continues'#. Accept #Q_'Search More Hovels'#.", x = 13, y = 38, zone = "Wetlands" },
...
-----------28-29 Duskwood
	[2829] = {
 		...
 		items = {
			...
			[15] = { str = "Run to the house at #C_[81,59]# turn in #Q_'Look to the Stars'#(2) accept #Q_'Look to the Stars'#(3).", x = 81, y = 59, zone = "Duskwood" },
			...
			[28] = { str = "Kill black widow’s east of the #A_Graveyard# for the last part of #Q_'The Totem of Infliction'#." },
			...
			[48] = { str = "Fly to #A_Menethil Harbor# (#A_The Wetlands#) and get on the boat to #A_Auberdine# (#A_Darkshore#), Fly to #A_Astranaar# (#A_Ashenvale#)." },
 		}
	},
...
-----------29-30 Ashenvale
	[2930] = {
 		...
 		items = {
			...
			[6] = { str = "Go to #C_[85,44]# and turn in #Q_'Kayneth Stillwind'# accept #Q_'Forsaken Diseases'#.", x = 85, y = 44, zone = "Ashenvale" },
			[7] = { str = "Go to #C_[81,48]# and get the second part of #Q_'The Tower of Althalaxx'#(6).", x = 81, y = 48, zone = "Ashenvale" },
			[8] = { str = "Go to #C_[66,81]# and do #Q_'Fallen Sky Lake'# the mob is in the center.", x = 66, y = 81, zone = "Ashenvale" },
			[9] = { str = "Kill rotting slimes until a chest falls east of the road near the lake for #Q_'Raene’s Cleansing'#(5)." },
...
-----------30-30 Wetlands
	[3030] = {
 		...
 		items = {
			...
			[10] = { str = "Turn in #Q_'Fall of Dun Modr'# at #C_[49,18]# accept #Q_'The Thandol Span'#(1).", x = 49, y = 18, zone = "Wetlands" },
