...
-----------20-21 Darkshore
	[2021] = {
 		...
 		items = {
			...
			[2] = { str = "First thing, talk to your #N_Class Trainer# in Darnassus to learn new spells and abilities. Then fly back." },
			...
			[7] = { str = "Turn in The Absent Minded Prospector pt.1 at #C_[35,83]# accept The Absent Minded Prospector pt.2 and do it.", x = 35, y = 83, zone = "Darkshore" },
...
-----------21-22 Ashenvale
	[2122] = {
 		...
 		items = {
			...
			[4] = { str = "Kill mobs around #C_[31,31]# in ruins of Ordil’Aran for The Tower of Althalaxx pt.4 I then clear the camp a total of 4 times. If I find it early I still clear it 4 times total. I am then half way to 22.", x = 31, y = 31, zone = "Ashenvale" },
			...
			[22] = { str = "Turn in Raene's Cleansing pt.1 at #C_[20,42]# accept Raene’s Cleansing pt.2 Kill murlocs for the gem.", x = 20, y = 42, zone = "Ashenvale" },
			[23] = { str = "Use your #I_[Hearthstone]# to return to Astranaar." },
			...
			[27] = { str = "Go to #C_[49,56]# then grind north to #C_[53,46]# turn in Raene’s Cleansing pt.3 accept Raene’s Cleansing pt.4.", x = 49, y = 56, zone = "Ashenvale" },
			[28] = { str = "You should already be 22. Go to #C_[55,61]# and do An Aggressive Defense.", x = 55, y = 61, zone = "Ashenvale" },
			[29] = { str = "Use your #I_[Hearthstone]# to return to Astranaar." },
			[30] = { str = "Turn in An Aggressive Defense." },

			[31] = { str = "Go to the east exit house, turn in Elune's Tear accept The Ruins of Stardust." },
			[32] = { str = "Exit Astranaar out the east exit follow the south path till you are at #C_[33,66]# and grab stardust covered bushes for The Ruins of Stardust.", x = 33, y = 66, zone = "Ashenvale" },
...
-----------22-23 Stonetalon Mountains
	[2223] = {
		...
		items = {
			...
			[3] = { str = "Then go to #C_[59,66]# and turn in On Guard in Stonetalon pt.1 accept On Guard in Stonetalon pt.2.", x = 59, y = 66, zone = "Stonetalon Mountains" },
			...
			[6] = { str = "Turn in Super Reaper 6000 at the hut #C_[58,62]# SKIP Further Instructions Unless you want to run to Ratchet.", x = 58, y = 62, zone = "Stonetalon Mountains" },
...
-----------23-24 Darkshore
	[2324] = {
 		...
 		items = {
			...
			[6] = { str = "Fly to Darnassus and turn in The Absent Minded Prospector pt.3 outside the Temple of the Moon at #C_[31,84]# accept The Absent Minded Prospector pt.4 Get talents if you need them.", x = 31, y = 84, zone = "Darnassus" },
			...
			[16] = { str = "Run down to #C_[41,81]# and do /wave at Grimclaw He’ll point southwest at the cave. Go to it at #C_[45,85]# and turn in A Lost Master pt.2 accept Escape Through Force Run him back to Grimclaw at #C_[41,81]#.", x = 41, y = 81, zone = "Darkshore" },
			...
			[20] = { str = "Talk to your #N_Class Trainer# in Darnassus to learn new spells and abilities. Then Fly to Astranaar." },
 		}
	},
...
-----------24-25 Ashenvale
	[2425] = {
 		...
 		items = {
			...
			[5] = { str = "Grind every mob down into Fire Scar Shrine and kill Ilkruk Mathrull at #C_[25,61]# for The Tower of Althalaxx pt.5 Take him out as fast as you can. He summons 2 voidwalkers if you take too long.", x = 25, y = 61, zone = "Ashenvale" },
			...
			[8] = { str = "Then run to Maestra’s Post at #C_[26,38]# turn in The Tower of Althalaxx pt.5 accept The Tower of Althalaxx pt.6.", x = 26, y = 38, zone = "Ashenvale" },
...
-----------25-27 Wetlands
	[2526] = {
 		...
 		items = {
			...
			[14] = { str = "Kill Mottled Raptors and Screechers around #C_[25,46]# to get Stone of Relu for The Absent Minded Prospector pt.5.", x = 25, y = 46, zone = "Wetlands" },
			[15] = { str = "Enter the Excavation Site at #C_[34,40]#.", x = 34, y = 40, zone = "Wetlands" },
			[16] = { str = "Run up the path on the left and grab the fossil near the 2 npc’s at #C_[38,52]# for The Absent Minded Prospector pt.5.", x = 38, y = 52, zone = "Wetlands" },
			...
			[20] = { str = "Go back to where you killed the raptors a few minutes ago at #C_[25,46]# and do Ormer's Revenge pt.1 by killing mottled raptors and screechers.", x = 25, y = 46, zone = "Wetlands" },

			[21] = { str = "Run back up to the cave at #C_[38,52]# and turn in Ormer's Revenge pt.1 accept Ormer’s Revenge pt.2.", x = 38, y = 52, zone = "Wetlands" },
			...
			[23] = { str = "Go back up to #C_[38,52]# and turn in Ormer’s Revenge pt.2 accept Ormer’s Revenge pt.3.", x = 38, y = 52, zone = "Wetlands" },
			[24] = { str = "Turn in Uncovering the Past." },
			[25] = { str = "Do Ormer’s Revenge pt.3 atop the hill at #C_[32,51]# Sarltooth is a 29 But he’s as easy as the others. Go turn it back in at #C_[38,52]#.", x = 32, y = 51, zone = "Wetlands" },
...
-----------28-29 Duskwood
	[2829] = {
 		...
 		items = {
			...
			[11] = { str = "Start off doing Worgen in the Woods pt.1 to the east of Duskwood around #C_[64,46]# by killing Nightbane Shadow Weaver.", x = 64, y = 46, zone = "Duskwood" },
			[12] = { str = "Turn in Worgen in the Woods pt.1 back in the center of town, accept Worgen in the Woods pt.2." },
			[13] = { str = "Go back to around #C_[64,46]# and kill Nightbane Dark Runners now for Worgen in the Woods pt.2 There are a lot in the camps.", x = 64, y = 46, zone = "Duskwood" },
			[14] = { str = "Go turn in Worgen in the Woods pt.2 in the center of town again and accept Worgen in the Woods pt.3." },
			[15] = { str = "Run to the house at #C_[81,59]# turn in Look to the Stars pt.2 accept Look to the Stars pt.3.", x = 81, y = 59, zone = "Duskwood" },
			[16] = { str = "Do The Night Watch pt.1 and the skeleton finger part of The Totem of Infliction at Tranquil Garden Cemetary around #C_[79,70]#.", x = 79, y = 70, zone = "Duskwood" },
			[17] = { str = "Ger Mary’s Looking Glass for Look to the Stars pt.3 inside the chapel here from the insane ghoul." },
			[18] = { str = "Kill the mobs around #C_[73,73]# inside and out of the cave for Worgen in the Woods pt.3.", x = 73, y = 73, zone = "Duskwood" },
			...
			[40] = { str = "Go to the underground at #C_[23,35]# kill plagued spreaders just around here and down inside for The Night Watch pt.3 you probably won’t get them all in 1 pass.", x = 23, y = 35, zone = "Duskwood" },
...
-----------29-30 Ashenvale
	[2930] = {
 		...
 		items = {
			...
			[3] = { str = "Stop at #C_[66,56]# and touch the crystal for the first part of The Tower of Althalaxx pt.6.", x = 66, y = 56, zone = "Ashenvale" },
			[4] = { str = "Kill Withered Ancients for the Wooden Key for Raene’s Cleansing pt.4 around #C_[55,35]# then use the key on the chest at #C_[54,35]#.", x = 55, y = 35, zone = "Ashenvale" },
			[5] = { str = "Run to #C_[53,46]# turn in Raene’s Cleansing pt.4 accept Raene’s Cleansing pt.5.", x = 53, y = 46, zone = "Ashenvale" },
			[6] = { str = "Go to #C_[85,44]# and turn in Kayneth Stillwind accept Forsaken Diseases.", x = 85, y = 44, zone = "Ashenvale" },
			[7] = { str = "Go to #C_[81,48]# and get the second part of The Tower of Althalaxx pt.6.", x = 81, y = 48, zone = "Ashenvale" },
			...
			[12] = { str = "Use your #I_[Hearthstone]# to return to Astranaar." },
			[13] = { str = "Turn in Fallen Sky Lake at the last house on the east side of town." },
			[14] = { str = "Go to #C_[53,46]# turn in Raene’s Cleansing pt.5 accept Raene's Cleansing pt.5 Go turn it in at the shrine inside the tree at #C_[56,49]# accept Raene’s Cleansing pt.6 Turn it back in at the moonwell at #C_[53,46]# accept Raene’s Cleansing pt.7 die so you end up near town.", x = 53, y = 46, zone = "Ashenvale" },
			...
			[16] = { str = "Go to #C_[26,38]# turn in The Tower of Althalaxx pt.6 SKIP the rest.", x = 26, y = 38, zone = "Ashenvale" },
			[17] = { str = "Fly to Darnassus and talk to your #N_Class Trainer# to learn new spells and abilities." },
...
-----------30-30 Wetlands
	[3030] = {
 		...
 		items = {
			...
			[10] = { str = "Turn in Fall of Dun Modr at #C_[49,18]# accept The Thandol Span pt.1.", x = 49, y = 18, zone = "Wetlands" },
