...
-----------20-21 Darkshore
	[2021] = {
 		...
 		items = {
			...
			[6] = { str = "Accept Therylune's Escape (escort) at #COORDS[38,87]# and do it.", x = 38, y = 87, zone = "Darkshore" },
			[7] = { str = "Turn in The Absent Minded Prospector pt.1 at #COORDS[35,83]# accept The Absent Minded Prospector pt.2 and do it.", x = 35, y = 83, zone = "Darkshore" },
			[8] = { str = "Go west to #COORDS[32,80]#, #COORDS[31,83]#, #COORDS[31,85]# and #COORDS[31,87]# and accept Beached Sea Turtle at all four.", x = 32, y = 80, zone = "Darkshore" },
			[9] = { str = "Go back to #COORDS[43,76]# and turn in Return to Onu accept Mathystra Relics.", x = 43, y = 76, zone = "Darkshore" },
...
-----------21-22 Ashenvale
	[2122] = {
 		...
 		items = {
			...
			[4] = { str = "Kill mobs around #COORDS[31,31]# in ruins of Ordil’Aran for The Tower of Althalaxx pt.4 I then clear the camp a total of 4 times. If I find it early I still clear it 4 times total. I am then half way to 22.", x = 31, y = 31, zone = "Ashenvale" },
			[5] = { str = "Grab plant bundles for Bathran's Hair at #COORDS[31,21]# in Bathran’s Haunt", x = 31, y = 21, zone = "Ashenvale" },
			[6] = { str = "Go back to Maestra’s Post at #COORDS[26,38]# and turn in The Tower of Althalaxx pt.4 Accept The Tower of Althalaxx pt.5.", x = 26, y = 36, zone = "Ashenvale" },
			...
			[16] = { str = "Go to The Zoram Strand. Stop at #COORDS[14,31]# accept The Ancient Statuette ", x = 14, y = 31, zone = "Ashenvale" },
			...
			[26] = { str = "Grind to #COORDS[46,46]# and grab Elune's Tear", x = 46, y = 46, zone = "Ashenvale" },
			[27] = { str = "Go to #COORDS[49,56]# then grind north to #COORDS[53,46]# turn in Raene’s Cleansing pt.3 accept Raene’s Cleansing pt.4.", x = 49, y = 56, zone = "Ashenvale" },
...
-----------22-23 Stonetalon Mountains
	[2223] = {
		...
		items = {
			...
			[3] = { str = "Then go to #COORDS[59,66]# and turn in On Guard in Stonetalon pt.1 accept On Guard in Stonetalon pt.2.", x = 59, y = 66, zone = "Stonetalon Mountains" },
			...
			[6] = { str = "Turn in Super Reaper 6000 at the hut #COORDS[58,62]# SKIP Further Instructions Unless you want to run to Ratchet.", x = 58, y = 62, zone = "Stonetalon Mountains" },
			[7] = { str = "Then go to #COORDS[59,66]# and turn in A Gnome’s Respite accept An Old Colleague and A Scroll From Mauren We’ll do these later.", x = 59, y = 66, zone = "Stonetalon Mountains" },
			[8] = { str = "Stop at Mirkfallon Lake at #COORDS[48,40]# and kill Pridewings for Pridewings of Stonetalon South and East of it.", x = 48, y = 40, zone = "Stonetalon Mountains" },
			[9] = { str = "Run to #COORDS[37,8]# turn in Journey to Stonetalon Peak SKIP Reclaiming The Charred Vale for now", x = 37, y = 8, zone = "Stonetalon Mountains" },
			[10] = { str = "Grab FP at #COORDS[36,7]# and Fly to Auberdine.", x = 36, y = 7, zone = "Stonetalon Mountains" },
 		}
	},
...
-----------23-24 Darkshore
	[2324] = {
 		...
 		items = {
			...
			[6] = { str = "Fly to Darnassus and turn in The Absent Minded Prospector pt.3 outside the Temple of the Moon at #COORDS[31,84]# accept The Absent Minded Prospector pt.4 Get talents if you need them.", x = 31, y = 84, zone = "Darnassus" },
			...
			[15] = { str = "Run down to #COORDS[43,76]# turn in Mathystra Relics.", x = 43, y = 76, zone = "Darkshore" },
			[16] = { str = "Run down to #COORDS[41,81]# and do /wave at Grimclaw He’ll point southwest at the cave. Go to it at #COORDS[45,85]# and turn in A Lost Master pt.2 accept Escape Through Force Run him back to Grimclaw at #COORDS[41,81]#.", x = 41, y = 81, zone = "Darkshore" },
...
-----------24-25 Ashenvale
	[2425] = {
 		...
 		items = {
			...
			[5] = { str = "Grind every mob down into Fire Scar Shrine and kill Ilkruk Mathrull at #COORDS[25,61]# for The Tower of Althalaxx pt.5 Take him out as fast as you can. He summons 2 voidwalkers if you take too long.", x = 25, y = 61, zone = "Ashenvale" },
			[6] = { str = "Grind a path up to between #COORDS[35,33]# and #COORDS[36,36]# (he patrols) and kill Dal Bloodclaw for Culling the Threat.", x = 35, y = 33, zone = "Ashenvale" },
...
-----------25-27 Wetlands
	[2526] = {
 		...
 		items = {
			...
			[15] = { str = "Enter the Excavation Site at #COORDS[34,40]#.", x = 34, y = 40, zone = "Wetlands" },
			[16] = { str = "Run up the path on the left and grab the fossil near the 2 npc’s at #COORDS[38,52]# for The Absent Minded Prospector pt.5", x = 38, y = 52, zone = "Wetlands" },
			...
			[25] = { str = "Do Ormer’s Revenge pt.3 atop the hill at #COORDS[32,51]# Sarltooth is a 29 But he’s as easy as the others. Go turn it back in at #COORDS[38,52]#.", x = 32, y = 51, zone = "Wetlands" },
			[26] = { str = "Go in to Angerfang Encampment at #COORDS[43,40]# and do War Banners", x = 43, y = 40, zone = "Wetlands" },
			[27] = { str = "Stop at #COORDS[49,39]# accept Daily Delivery.", x = 49, y = 39, zone = "Wetlands" },
...
-----------27-28 Lakeshire
	[2728] = {
 		...
 		items = {
			...
			[7] = { str = "Just west of town at the house past the inn, accept An Unwelcome Guest now go do it just west of this house at #COORDS[16,49]# (Bellygrub) kill him then hand it back in.", x = 16, y = 49, zone = "Redridge Mountains" },
...
-----------28-29 Duskwood
	[2829] = {
 		...
 		items = {
			...
			[3] = { str = "Follow the road until you get to Darkshire and get FP at #COORDS[72,44]#", x = 72, y = 44, zone = "Duskwood" },
			[4] = { str = "Go to the house just south of FP at #COORDS[79,47]# accept Look to the Stars pt.1 Buy a bronze tube from the gnome engineer just south of here at #COORDS[78,48]# and hand it back in, accept Look to the Stars pt.2 ", x = 79, y = 47, zone = "Duskwood" },
			...
			[15] = { str = "Run to the house at #COORDS[81,59]# turn in Look to the Stars pt.2 accept Look to the Stars pt.3", x = 81, y = 59, zone = "Duskwood" },
			[16] = { str = "Do The Night Watch pt.1 and the skeleton finger part of The Totem of Infliction at Tranquil Garden Cemetary around #COORDS[79,70]#.", x = 79, y = 70, zone = "Duskwood" },
			...
			[25] = { str = "Stop at the front of Raven Hill at #COORDS[18,56]# and turn in Raven Hill SKIP the rest since they’re grey", x = 18, y = 56, zone = "Duskwood" },
			...
			[27] = { str = "Kill ghouls in the northern part of the cemetery at #COORDS[22,38]# to get ghoul fangs for The Totem of Infliction", x = 22, y = 38, zone = "Duskwood" },
			...
			[37] = { str = "Go to Blind Mary in the house at #COORDS[81,59]# turn in Ghost Hair Thread accept Return the Comb Go turn it in at the house east of the Inn, accept Deliver the Thread ", x = 81, y = 59, zone = "Duskwood" },
			...
			[47] = { str = "If you happened to find An Old History Book (drops off all mobs in Duskwood) start the quest An Old History Book and Fly to SW and turn it in at #COORDS[74,7]# and accept Southshore ", x = 74, y = 7, zone = "Duskwood" },
...
-----------29-30 Ashenvale
	[2930] = {
 		...
 		items = {
			...
			[3] = { str = "Stop at #COORDS[66,56]# and touch the crystal for the first part of The Tower of Althalaxx pt.6.", x = 66, y = 56, zone = "Ashenvale" },
			[4] = { str = "Kill Withered Ancients for the Wooden Key for Raene’s Cleansing pt.4 around #COORDS[55,35]# then use the key on the chest at #COORDS[54,35]#", x = 55, y = 35, zone = "Ashenvale" },
			[5] = { str = "Run to #COORDS[53,46]# turn in Raene’s Cleansing pt.4 accept Raene’s Cleansing pt.5", x = 53, y = 46, zone = "Ashenvale" },
			[6] = { str = "Go to #COORDS[85,44]# and turn in Kayneth Stillwind accept Forsaken Diseases", x = 85, y = 44, zone = "Ashenvale" },
			[7] = { str = "Go to #COORDS[81,48]# and get the second part of The Tower of Althalaxx pt.6 ", x = 81, y = 48, zone = "Ashenvale" },
...
-----------30-30 Wetlands
	[3030] = {
 		...
 		items = {
			...
			[3] = { str = "Go to #COORDS[14,25]# and kill Captain Halyndor for his key on top of the ship, the chest is in the bottom of the ship. Send your pet in to grab all the aggro, then send it out to attack a murloc so it trains them all out. Touch the chest and turn in Lifting the Curse accept The Eye of Paleth", x = 14, y = 25, zone = "Wetlands" },
			[4] = { str = "Touch the catapult at #COORDS[47,47]#, hand in Nek'Rosh's Gambit accept Defeat Nek’Rosh", x = 47, y = 47, zone = "Wetlands" },
			[5] = { str = "Go to #COORDS[53,55]# and clear the left side, walk up and around the back, to do Defeat Nek’Rosh clear anything he might aggro, die doing so if you must. He’s kinda weak. Pretty easy for a 32 elite.", x = 53, y = 55, zone = "Wetlands" },
			...
			[17] = { str = "Stop at #COORDS[27,49]# and run south into Stormgarde Keep, at the first intersection go right and hug the wall around over the bridge, buy all 3 first aid books at #COORDS[26,58]#", x = 27, y = 49, zone = "Arathi Highlands" },
