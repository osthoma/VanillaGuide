...
-----------38-40 Stranglethorn Vale
	[3840] = {
		...
		items = {
			...
			[19] = { str = "Go out of #A_Booty Bay# and turn left to the camp of pirates at #C_[27,69]# and touch the letter on the barrel, turn in 'The Bloodsail Buccaneers pt.1' accept 'The Bloodsail Buccaneers pt.2'.", x = 27, y = 69, zone = "Stranglethorn Vale" },
