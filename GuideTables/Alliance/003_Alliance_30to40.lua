...
-----------31-31 Alterac Mountains
	[3131] = {
		...
		items = {
			...
			[3] = { str = "Go east of AV and do Syndicate Assassins at the camp around #COORDS[55,67]#. There is a camp close to AV but this one has a quest you can grab near the tents on the table. Clear the camp and touch the syndicate document, accept Foreboding Plans and Encrypted Letter.", x = 55, y = 67, zone = "Alterac Mountains" },
...
-----------31-32 Arathi Highlands
	[3132] = {
		...
		items = {
			...
			[4] = { str = "Go to the hall of explorers at #COORDS[69,20]# in IF accept Reclaimers' Business in Desolace then go turn in Letter to Stormpike accept Further Mysteries.", x = 69, y = 20, zone = "Arathi Highlands" },
			[5] = { str = "Accept The Brassbolts Brothers in The Hall of Arms at #COORDS[72,93]# then talk to your #NPCClass Trainer# to learn new spells and abilities.", x = 72, y = 93, zone = "Arathi Highlands" },
			[6] = { str = "Make IF your home at #COORDS[18,51]# Buy some Bloodstone Ore for a quest later in STV. If there is none check the AH in Booty Bay.", x = 18, y = 51, zone = "Arathi Highlands" },
			[7] = { str = "Fly to SW" },
			[8] = { str = "Go to the Keep at #COORDS[72,15]# and hand in Reassignment.", x = 72, y = 15, zone = "Stormwind City" },
			[9] = { str = "Go to #COORDS[39,27]# in the Cathedral and hand in Cleansing the Eye.", x = 39, y = 27, zone = "Stormwind City" },
			[10] = { str = "Fly to Duskwood, then run to #COORDS[44,66]# and go south into STV.", x = 44, y = 66, zone = "Duskwood" }
		}
	},
...
-----------32-32 Stranglethorn Vale
	[3232] = {
		...
		items = {
			...
			[5] = { str = "Go to Nessingway’s at #COORDS[35,10]# and accept Welcome to the Jungle then turn it in behind you. This opens the 3 quest givers here.", x = 35, y = 10, zone = "Stranglethorn Vale" },
			...
			[7] = { str = "Do Panther Mastery pt.1 & Tiger Mastery pt.1 Tigers are just behind Nessingway’s, and the Panthers are to the east some but centralized around #COORDS[41,9]#", x = 41, y = 9, zone = "Stranglethorn Vale" },
...
-----------32-33 Thousand Needles (Shimmering Flats)
	[3233] = {
		...
		items = {
			...
			[4] = { str = "Go to #COORDS[78,77]# and turn in The Brassbolts Brothers accept Hardened Shells and Salt Flat Venom.", x = 78, y = 77, zone = "Thousand Needles" },
			[5] = { str = "Go a little beside these guys and grab Rocket Car Parts, Wharfmaster Dizzywig and Hemet Nesingwary" },
			[6] = { str = "Go east to #COORDS[80,75]# and accept Load Lightening.", x = 80, y = 75, zone = "Thousand Needles" },
			[7] = { str = "Go to #COORDS[81,77]# and accept A Bump in the Road.", x = 81, y = 77, zone = "Thousand Needles" },
			...
			[16] = { str = "Run east to #COORDS[80,75]# turn in Load Lightening accept Goblin Sponsorship pt.1.", x = 80, y = 75, zone = "Thousand Needles" },
			[17] = { str = "Go to #COORDS[81,77]# and turn in A Bump in the Road.", x = 81, y = 77, zone = "Thousand Needles" },
...
-----------33-35 Desolace
	[3335] = {
		...
		items = {
			...
			[16] = { str = "Go to the Kodo Graveyard around #COORDS[51,58]#. Do Bone Collector everytime you come to pick up a kodo for roundup.", x = 51, y = 58, zone = "Desolace" },
			...
			[25] = { str = "Go to #COORDS[62,38]# and turn in Bone Collector.", x = 62, y = 38, zone = "Desolace" },
			[26] = { str = "Run back to #COORDS[38,27]# and turn in Sceptre of Light accept Book of the Ancients.", x = 38, y = 27, zone = "Desolace" },
			[27] = { str = "Swim all the way NW on the map to Ranazjar Isle and open the chest at #COORDS[30,9]# for Claim Rackmore's Treasure!", x = 30, y = 9, zone = "Desolace" },
			...
			[36] = { str = "Get on the Boat at #COORDS[43,42]# and grab the FP in Feathermoon. Fly to Theramore, then to Rachet.", x = 43, y = 42, zone = "Desolace" },
			[37] = { str = "Go to the engineer hut at #COORDS[62,36]# and hand in Goblin Sponsorship pt.1 accept Goblin Sponsorship pt.2 Then run out on the dock and hand in Wharfmaster Dizzywig accept Parts for Kravel.", x = 62, y = 36, zone = "Desolace" },
...
-----------35-36 Stranglethorn Vale
	[3536] = {
		...
		items = {
			...
			[7] = { str = "Go around #COORDS[48,21]# and Kill Shadowmaw Panthers for Panther Mastery pt.3.", x = 48, y = 21, zone = "Stranglethorn Vale" },
			...
			[15] = { str = "Go up to the rebel camp at #COORDS[37,3]# and hand in Supplies to Private Thorsen, If he’s not here look south of the camp, if you save him when he patrols you can also get Jungle Secrets then u turn that in at the camp and get Bookie Herod.", x = 37, y = 3, zone = "Stranglethorn Vale" },
			...
			[25] = { str = "Kill Bloodscalp at #COORDS[29,19]# for Bloodscalp Ears You’ll probably have to clear it 2-3 times. They’re easy.", x = 29, y = 19, zone = "Stranglethorn Vale" },
			...
			[34] = { str = "Fly to IF and talk to your #NPCClass Trainer# to learn new spells and abilities. Then fly to Menethil Harbor, make it your home, and boat to Theramore" },
			[35] = { str = "If you’re first aid is at 225 go do Triage then fly to Gadgetzan" },
			[36] = { str = "Run out to Shimmering Flats at #COORDS[77,77]# and turn in Parts for Kravel accept Delivery to the Gnomes then turn around and hand it in.", x = 77, y = 77, zone = "Stranglethorn Vale" },
			...
			[38] = { str = "Grab The Rumormonger at #COORDS[77,77]# then Hearth to Menethil Harbor.", x = 77, y = 77, zone = "Stranglethorn Vale" },
		}
	},
...
-----------36-37 Alterac Mountains
 	[3637] = {
		...
		items = {
			...
			[4] = { str = "Run into Alterac Mountains to #COORDS[47,55]# and kill ogres for Crushridge Bounty.", x = 47, y = 55, zone = "Alterac Mountains" },
			[5] = { str = "Grind up to Strahnbrad around #COORDS[60,43]# and kill the syndicate and grab their rings for Noble Deaths You can also kill shadow mages here for Dark Council which is easier than killing them in the camps later.", x = 60, y = 43, zone = "Alterac Mountains" },
			[6] = { str = "Grind your way west to to the house at #COORDS[39,16]# and kill Nagaz for Dark Council. I take out the first camp you come across then grind anything in my way west that’s not in a camp.", x = 39, y = 16, zone = "Alterac Mountains" },
...
-----------37-38 Arathi Highlands
	[3738] = {
		...
		items = {
			...
			[15] = { str = "Run SW of here, there is a path that leads behind Stromgarde at #COORDS[31,64]# follow it around to the cave path at #COORDS[21,75]#", x = 31, y = 64, zone = "Arathi Highlands" },
			...
			[28] = { str = "Fly to Stormwind and talk to your #NPCClass Trainer# to learn new spells and abilities. Get the quest Morgan Stern from Angus Stern at 41 89, then fly to Menethil and boat to Theramore.", x = 41, y = 89, zone = "Stormwind" },
		}
	},
...
-----------38-38 Dustwallow Marsh
	[3838] = {
		...
		items = {
			...
			[5] = { str = "Buy 3 soothing spices from the trade supplies person in the houst at #COORDS[66,51]# (for upcoming quest).", x = 66, y = 51, zone = "Dustwallow Marsh" },
			[6] = { str = "Just as you exit Theramore, go right and kill Mudrock turtles along the shore for 'Mudrock Soup and Bugs'." },
			[7] = { str = "Go to the house at #COORDS[55,26]# and accept 'Soothing Spices' then turn it right back in, accept 'Jarl Needs eyes'", x = 55, y = 26, zone = "Dustwallow Marsh" },
			...
			[25] = { str = "Go to the tower at #COORDS[35,53]# and attack Balos Jacken, at ¼ life he’ll become friendly and then turn in 'The Deserters pt.1' accept 'The Deserters pt.2'.", x = 35, y = 53, zone = "Dustwallow Marsh" },
			...
			[29] = { str = "Fly to Gadgetzan and run up to the Shimmering Flats to #COORDS[80,76]# turn in 'Razzeric's Tweaking' accept 'Safety First pt.1' turn it in in Gadget and accept 'Safety First pt.2' then run back to the flats and hand it in.", x = 80, y = 76, zone = "Dustwallow Marsh" },
...
-----------38-40 Stranglethorn Vale
	[3840] = {
		...
		items = {
			...
			[7] = { str = "Go to around #COORDS[33,39]# and kill raptors for 'Raptor Mastery pt.3'", x = 33, y = 39, zone = "Stranglethorn Vale" },
			...
			[37] = { str = "Run to #COORDS[65,65]# and accept 'Find Agmond'", x = 65, y = 65, zone = "Loch Modan" },
			[38] = { str = "Run down into Badlands at #COORDS[46,76]#", x = 46, y = 76, zone = "Loch Modan" },
		}
	},
}
