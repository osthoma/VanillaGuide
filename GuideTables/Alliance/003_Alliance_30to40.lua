...
-----------38-38 Dustwallow Marsh
	[3838] = {
		...
		items = {
			...
			[7] = { str = "Go to the house at #C_[55,26]# and accept 'Soothing Spices' then turn it right back in, accept 'Jarl Needs eyes'.", x = 55, y = 26, zone = "Dustwallow Marsh" },
			[8] = { str = "Touch the mound of dirt beside the house, accept 'The Orc Report'." },
			[9] = { str = "Run over to Darkmist Cavern at #C_[32,23]# and kill spiders inside and outside for 'Jarl Needs eyes' They drop 1-2 every kill.", x = 32, y = 23, zone = "Dustwallow Marsh" },
			...
			[21] = { str = "Run out to #C_[55,26]# and turn in 'Jarl Needs eyes' SKIP the next.", x = 55, y = 26, zone = "Dustwallow Marsh" },
...
-----------38-40 Stranglethorn Vale
	[3840] = {
		...
		items = {
			...
			[8] = { str = "Kill Snapjaw Crocolisks from the stream at #C_[38,30]# to the lake at #C_[41,19]# for 'Some assembly required'.", x = 38, y = 30, zone = "Stranglethorn Vale" },
			[9] = { str = "Go to the Island at #C_[20,23]# and kill elementals for 'Water Elementals' You should be close to 39 by now, either grind on the elementals or raptors and basalisks around #C_[33,39]#.", x = 20, y = 23, zone = "Stranglethorn Vale" },
			[10] = { str = "Once you’re 39, grind your way east to the road then to #C_[41,41]# and kill the goblins for 'Venture Company Mining'.", x = 41, y = 41, zone = "Stranglethorn Vale" },

			[11] = { str = "Run up to the camps around #C_[42,37]# and do 'Skullsplitter Tusks'.", x = 42, y = 37, zone = "Stranglethorn Vale" },
			...
			[20] = { str = "Go kill gorillas around #C_[32,65]# just NE of BB for 'Scaring Shaky'.", x = 32, y = 65, zone = "Stranglethorn Vale" },
			...
			[37] = { str = "Run to #C_[65,65]# and accept 'Find Agmond'.", x = 65, y = 65, zone = "Loch Modan" },
