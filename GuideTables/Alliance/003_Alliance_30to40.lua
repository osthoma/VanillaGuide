...
-----------30-31 Hillsbrad Foothills
	[3031] = {
		...
		items = {
			...
			[2] = { str = "Run into southshore at #C_[49,52]# and grab the FP.", x = 49, y = 52, zone = "Hillsbrad Foothills" },
...
-----------31-32 Arathi Highlands
	[3132] = {
		...
		items = {
			...
			[4] = { str = "Go to the hall of explorers at #C_[69,20]# in IF accept Reclaimers' Business in Desolace then go turn in Letter to Stormpike accept Further Mysteries.", x = 69, y = 20, zone = "Arathi Highlands" },
			...
			[6] = { str = "Make IF your home at #C_[18,51]# Buy some Bloodstone Ore for a quest later in STV. If there is none check the AH in Booty Bay.", x = 18, y = 51, zone = "Arathi Highlands" },
...
-----------32-32 Stranglethorn Vale
	[3232] = {
		...
		items = {
			...
			[7] = { str = "Do Panther Mastery pt.1 & Tiger Mastery pt.1 Tigers are just behind Nessingway’s, and the Panthers are to the east some but centralized around #C_[41,9]#.", x = 41, y = 9, zone = "Stranglethorn Vale" },
			...
			[10] = { str = "Go back to Nessingway’s at #C_[35,10]# and hand in Panther Mastery pt.1 & Tiger Mastery pt.1 accept Panther Mastery pt.2 & Tiger Mastery pt.2.", x = 35, y = 10, zone = "Stranglethorn Vale" },

			[11] = { str = "Kill Stranglethorn Tigers for around #C_[29,10]# for Tiger Mastery pt.2 and the Panthers around #C_[28,12]# for Panther Mastery pt.2.", x = 29, y = 10, zone = "Stranglethorn Vale" },
			[12] = { str = "Kill Stranglethorn Raptors for #C_[26,15]# Raptor Mastery pt.1.", x = 26, y = 15, zone = "Stranglethorn Vale" },
			[13] = { str = "Go back to Nessingway’s at #C_[35,10]# and turn in Tiger Mastery pt.2, Panther Mastery pt.2, and Raptor Mastery pt.1. Accept Tiger Mastery pt.3, Panther Mastery pt.3 and Raptor Mastery pt.2.", x = 35, y = 10, zone = "Stranglethorn Vale" },
...
-----------32-33 Thousand Needles (Shimmering Flats)
	[3233] = {
		...
		items = {
			...
			[2] = { str = "Now Get the FP on the west side of this zone at #C_[8,18]#, it’s just inside Feralas. This will save a lot of time later on.", x = 8, y = 18, zone = "Thousand Needles" },
...
-----------33-35 Desolace
	[3335] = {
		...
		items = {
			...
			[8] = { str = "Run west to #C_[56,17]# Vahlarriel's Search pt.1 accept Vahlarriel’s Search pt.2.", x = 56, y = 17, zone = "Desolace" },
			[9] = { str = "Run east to Sargeron around #C_[75,20]# and kill the demons for Reagents for Reclaimers Inc pt.1.", x = 75, y = 20, zone = "Desolace" },
			...
			[12] = { str = "Now start grinding on the scorps and other stuff for Reagents for Reclaimers Inc pt.2 as you head to #C_[62,38]# and accept Bone Collector since the scorps are a low drop rate just kill them as you’re running around.", x = 62, y = 38, zone = "Desolace" },
			...
			[14] = { str = "Grind down to #C_[60,61]# and accept Kodo Roundup This is a unique quest where you tame a kodo at the GY then bring it back until you have 5.", x = 60, y = 61, zone = "Desolace" },
			...
			[19] = { str = "Go south on the beach to #C_[36,30]# and finish The Karnitol Shipwreck pt.1 accept The Karnitol Shipwreck pt.2 then accept Claim Rackmore's Treasure! from Rackmore’s log. If your quest log is full drop centaur bounty.", x = 36, y = 30, zone = "Desolace" },
			...
			[21] = { str = "Run up to Thunder Axe Fortress at #C_[56,29]# and go in the main building in the center and turn in Vahlarriel’s Search pt.3 at #C_[54,26]# accept Search for Tyranis.", x = 54, y = 26, zone = "Desolace" },
			...
			[36] = { str = "Get on the Boat at #C_[43,42]# and grab the FP in Feathermoon. Fly to Theramore, then to Rachet.", x = 43, y = 42, zone = "Desolace" },
			[37] = { str = "Go to the engineer hut at #C_[62,36]# and hand in Goblin Sponsorship pt.1 accept Goblin Sponsorship pt.2 Then run out on the dock and hand in Wharfmaster Dizzywig accept Parts for Kravel.", x = 62, y = 36, zone = "Desolace" },
...
-----------35-36 Stranglethorn Vale
	[3536] = {
		...
		items = {
			...
			[7] = { str = "Go around #C_[48,21]# and Kill Shadowmaw Panthers for Panther Mastery pt.3.", x = 48, y = 21, zone = "Stranglethorn Vale" },
			[8] = { str = "Run west to the Venture Co. Base Camp at #C_[43,18]# and Kill the goblins here for Hostile Takeover while you climb the Operations Tower behind the base for Goblin Sponsorship pt.4 You’re going to climb it and kill Foreman Cozzle for his key.", x = 43, y = 18, zone = "Stranglethorn Vale" },
			[9] = { str = "If you still don’t have all the crystals kill the goblins until you do, then enter the tiny shack next to the base at #C_[43,20]# and open the chest to get the blueprints for Goblin Sponsorship pt.4.", x = 43, y = 20, zone = "Stranglethorn Vale" },
			[10] = { str = "Kill Lashtail Raptors around #C_[37,22]# for Raptor Mastery pt.2.", x = 37, y = 22, zone = "Stranglethorn Vale" },

			[11] = { str = "Kill Elter Tigers around #C_[33,18]# for Tiger Mastery pt.3.", x = 33, y = 18, zone = "Stranglethorn Vale" },
			...
			[14] = { str = "Run back south to the top of the hill at #C_[32,17]# and kill Sin’Dall for Tiger Mastery pt.4 then turn it back in at Nessingways.", x = 32, y = 17, zone = "Stranglethorn Vale" },
			...
			[34] = { str = "Fly to IF and talk to your #N_Class Trainer# to learn new spells and abilities. Then fly to Menethil Harbor, make it your home, and boat to Theramore." },
...
-----------37-38 Arathi Highlands
	[3738] = {
		...
		items = {
			...
			[20] = { str = "Go down south near the sunken ships, around #C_[24,84]# and do Sunken Treasure pt.2 (use goggles to find them easy), Drowned Sorrows (nagas), and Deep Sea Salvage (2 on each ship).", x = 24, y = 84, zone = "Arathi Highlands" },
			...
			[24] = { str = "Run back towards Go’Shek Farm, if you haven’t found the courier yet abandon quest and hearth to SS. If so go to #C_[60,53]# and hand in Hints of a New Plague? Pt.2 accept Hints of a New Plague? Pt.3 then turn it right back in accept Hints of a New Plague? Pt.4.", x = 60, y = 53, zone = "Arathi Highlands" },
...
-----------38-38 Dustwallow Marsh
	[3838] = {
		...
		items = {
			...
			[25] = { str = "Go to the tower at #C_[35,53]# and attack Balos Jacken, at ¼ life he’ll become friendly and then turn in 'The Deserters pt.1' accept 'The Deserters pt.2'.", x = 35, y = 53, zone = "Dustwallow Marsh" },
...
-----------38-40 Stranglethorn Vale
	[3840] = {
		...
		items = {
			...
			[7] = { str = "Go to around #C_[33,39]# and kill raptors for 'Raptor Mastery pt.3'.", x = 33, y = 39, zone = "Stranglethorn Vale" },
			...
			[19] = { str = "Go out of BB and turn left to the camp of pirates at #C_[27,69]# and touch the letter on the barrel, turn in 'The Bloodsail Buccaneers pt.1' accept 'The Bloodsail Buccaneers pt.2'.", x = 27, y = 69, zone = "Stranglethorn Vale" },
			[20] = { str = "Go kill gorillas around #C_[32,65]# just NE of BB for #Q_'Scaring Shaky'#.", x = 32, y = 65, zone = "Stranglethorn Vale" },
			...
			[29] = { str = "Run up to Nessingways at #C_[35,10]# and turn in 'Raptor Mastery pt.3' and 'Panther Mastery pt.4' accept 'Raptor Mastery pt.4'.", x = 35, y = 10, zone = "Stranglethorn Vale" },
			...
			[34] = { str = "Now fly to IF and accept Ironband Wants You from Prospector Stormpike at 74 11, and either to Darnassus and talk to your #N_Class Trainer# to learn new spells and abilities and your mount, or get skills in IF and prepare for a few badlands quests by buying a frost oil and a gyrochronatom (don’t by a gyro if you can’t find a frost oil) Then a healing potion and lesser invisibility potion. Again don’t get either of the potions if you can’t get a frost oil or gyro.", x = 74, y = 11, zone = "Iron Forge" },
