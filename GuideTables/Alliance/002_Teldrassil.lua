...
-----------1-6 Teldrassil
	...
	[0106] = {
		...
		items = {
			...
			[3] = { str = "Accept  The Balance of Nature pt.2 and  Etched Sigil  at #COORDS[58,44]#.  The Woodland Protector pt.1  at #COORDS[59,42]# and  A Good Friend  at #COORDS[60,41]#.", x = 59, y = 42, zone = "Teldrassil" },
			[4] = { str = "Hand in  The Woodland Protector pt.1  at #COORDS[57,45]# and accept  The Woodland Protector pt.2  Mobs are at #COORDS[56,46]#. Turn it in at #COORDS[57,45]#.", x = 56, y = 46, zone = "Teldrassil" },
			[5] = { str = "Accept  Webwood Venom  at #COORDS[57,41]#.", x = 57, y = 41, zone = "Teldrassil" },
			[6] = { str = "Run up the ramp to the top of the tree, turn in  Etched Sigil  at #COORDS[58,40]# (hunter trainer) and get beast tracking.", x = 58, y = 40, zone = "Teldrassil" },
			[7] = { str = "Jump down and go do the following The Balance of Nature pt.2  mobs are all around #COORDS[60,35]#", x = 60, y = 35, zone = "Teldrassil" },
			...
			[15] = { str = "Turn in  Webwood Egg  at #COORDS[57,41]# Accept  Tenaron's Summons  then Run up the ramp to the top of the tree and hand it in at #COORDS[59,39]#. Accept  Crown of the Earth pt.1 ", x = 57, y = 41, zone = "Teldrassil" },
...
-----------6-12 Teldrassil
	...
	[0612] = {
		...
		items = {
			...
			[3] = { str = "Accept  Zenn's Bidding  at #COORDS[60,56]#", x = 60, y = 56, zone = "Teldrassil" },
			[4] = { str = "Make Dolanaar your home." },
			[5] = { str = "Turn in  Dolanaar Delivery  at #COORDS[55,59]# in Dolanaar", x = 55, y = 59, zone = "Teldrassil" },
			[6] = { str = "Turn in  Crown of the Earth pt.2  at #COORDS[56,61]# accept  Crown of the Earth pt.3", x = 56, y = 61, zone = "Teldrassil" },
			...
			[15] = { str = "Do  Seek Redemption!  (cones under trees) while heading to #COORDS[60,68]# and turn in  Denalan's Earth", x = 60, y = 68, zone = "Teldrassil" },
			...
			[25] = { str = "Run to Fel Rock Cave at #COORDS[54,52]# and do  Twisted Hatred  you can also wait until you’re 10 to do this. Makes it easier.", x = 54, y = 52, zone = "Teldrassil" },
			[26] = { str = "Turn in  Ferocitas the Dream Eater  &  Twisted Hatred  at Dolanaar." },
			[27] = { str = "Do  The Road to Darnassus  at #COORDS[46,52]#", x = 46, y = 52, zone = "Teldrassil" },
			...
			[37] = { str = "Run to Darnassus Hand in  Rellian Greenspyre  at #COORDS[38,21]# accept  Tumors", x = 38, y = 21, zone = "Teldrassil" },
			...
			[46] = { str = "Run back to Darnassus, turn in  Tumors  at #COORDS[38,21]# accept  Return to Denalan.", x = 38, y = 21, zone = "Teldrassil" },
			[47] = { str = "Turn in  Teldrassil  atop the tower at #COORDS[36,12]# accept  Grove of the Ancients.", x = 36, y = 12, zone = "Teldrassil" },
