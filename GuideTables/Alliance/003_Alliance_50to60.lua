...
------------53-54 Felwood
	[5354] = {
		...
		items = {
			...
			[9] = { str = "Go up near the 2 lakes at #C_[40,69]# and kill the cursed oozes for the first part of A Little Slime Goes A Long Way .", x = 40, y = 69, zone = "Felwood" },
			...
			[11] = { str = "Go up to #C_[39,59]# and kill the tainted oozes for the second part of A Little Slime Goes A Long Way .", x = 39, y = 59, zone = "Felwood" },
			...
			[48] = { str = "Just outside the military ward there should be a wandering npc, one is near flight path too, grab the quest The New Frontier ." },
...
-----------54-54 Tanaris
	[5453] = {
		...
		items = {
			...
			[9] = { str = "Now all around the crater is slimes but you can find all the ones you need west of the volcano around #C_[37,37]# for A Little Slime Goes A Long Way (2) I think there are more on the west side of the volcano but you can look on both sides they’re scattered. If it says they’re cloning, finish them very fast or stun them. If they clone it’s a full health mob that you can’t scoop up.", x = 37, y = 37, zone = "Un’Goro" },
			[10] = { str = "Go to the cave at #C_[64,16]# and go to the right, when you see A-Me 01 accept Chasing A-Me 01 and turn it back in. Fall over the edge and to the right and up around until you see U’cha for The Mighty U'cha.", x = 64, y = 16, zone = "Un’Goro" },

			[11] = { str = "Run back to the front and go right again and accept Chasing A-Me 01 (2) now escort her out." },
			[12] = { str = "Escort A-Me to Marshal’s at #C_[46,13]# and turn in Chasing A-Me 01 (2).", x = 46, y = 13, zone = "Un’Goro" },
...
--------------54-55 Winterspring
	[5455] = {
		...
		items = {
			...
			[9] = { str = "Go to #C_[65,45]# and kill yeti’s for Are We There, Yeti? .", x = 65, y = 45, zone = "Winterspring" },
			[10] = { str = "Run back to Everlook and turn in Are We There, Yeti? accept Are We There, Yeti? (2)." },

			[11] = { str = "Go back to #C_[65,45]# and kill matriarch’s and patriarch’s for Are We There, Yeti? (2) there are a lot in the cave at #C_[67,42]#.", x = 67, y = 42, zone = "Winterspring" },
			[12] = { str = "Run back to Everlook and turn in Are We There, Yeti? (2) accept Are We There, Yeti? (3)." },
			[13] = { str = "Go just east of the Inn and scare Legacki for Are We There, Yeti? (3)." },
			...
			[17] = { str = "Turn in Enraged Wildkin SKIP part 2 for now also turn in The Ruins of Kel'Theril accept Troubled Spirits of Kel'Theril." },
...
-----------55-56 Burning Steppes
	[5556] = {
		...
		items = {
			...
			[6] = { str = "Go NW to around #C_[66,40]# and collect the ruins that look like tombstones for The Smoldering Ruins of Thaurissan (2).", x = 66, y = 40, zone = "Burning Steps" },
...
------------56-57 Western Plaguelands
	[5657] = {
		...
		items = {
			...
			[14] = { str = "Theres 2 houses on the NE side of the field at #C_[38,54]#, enter the northern house and go upstairs. Accept Better Late Than Never .", x = 38, y = 54, zone = "Western Plaguelands" },
			[15] = { str = "Go in the barn next door and grab the box on the floor and turn in Better Late Than Never accept Better Late Than Never (2)." },
			...
			[24] = { str = "Go to the building at #C_[48,30]# on the 2nd floor of the cathedral area and turn in Better Late Than Never (2) accept Good Natured Emma.", x = 48, y = 30, zone = "Stormwind" },
			...
			[33] = { str = "In the house at #C_[54,65]# accept The Wildlife Suffers Too now go north of the haunt and kill the diseased wolves. Don’t go any farther east to find these just go North, maybe NW some.", x = 54, y = 65, zone = "Western Plaguelands" },
			[34] = { str = "Go back to #C_[54,65]# and turn in The Wildlife Suffers Too accept The Wildlife Suffers Too (2).", x = 54, y = 65, zone = "Western Plaguelands" },
			...
			[36] = { str = "Go just north of the Writhing Haunt between the mountains on the map at, #C_[52,56]# and kill diseased grizzleys on your way down to #C_[62,58]# for The Wildlife Suffers Too (2).", x = 52, y = 56, zone = "Western Plaguelands" },
			...
			[38] = { str = "Go back to #C_[54,65]# and turn in The Wildlife Suffers Too (2) accept Glyphed Oaken Branch.", x = 54, y = 65, zone = "Western Plaguelands" },
...
-----------58-58 Eastern Plaguelands
	[5858] = {
		...
		items = {
			...
			[14] = { str = "Run West to #C_[45,34]# and loot the termite mounds here for A Plague Upon Thee until you get 100 termites, also kill ghouls to finish up Defenders of Darrowshire.", x = 45, y = 34, zone = "Eastern Plaguelands" },
			...
			[17] = { str = "Fly to WPL." },
			[18] = { str = "Next to the house turn in 'A Plague Upon Thee ' accept 'A Plague Upon Thee (2)'." },
		}
	},
...
------------58-59 Western Plaguelands
	[5859] = {
		...
		items = {
			...
			[2] = { str = "Run up to #C_[51,28]# and accept 'Unfinished Business '.", x = 52, y = 30, zone = "Western Plaguelands" },
			[3] = { str = "Start heading back SW around #C_[47,32]# and clear your way into the mill. Right click the box and place the termintes, then click the barrel and turn in 'A Plague Upon Thee (2)' accept 'A Plague Upon Thee (3)'.", x = 47, y = 32, zone = "Western Plaguelands" },
			[4] = { str = "Go just south of #C_[49,42]# and kill 2 knights and mages for 'Unfinished Business ' then #C_[51,43]# for the hunters and medics.", x = 49, y = 42, zone = "Western Plaguelands" },
			[5] = { str = "Go to #C_[51,28]# and turn in 'Unfinished Business ' accept 'Unfinished Business (2)'.", x = 51, y = 28, zone = "Western Plaguelands" },
			[6] = { str = "Go to #C_[57,36]# and kill Huntsman Radly for 'Unfinished Business (2)' then north to the tower at #C_[55,23]# and kill Cavalier Durgen at the top.", x = 57, y = 36, zone = "Western Plaguelands" },
			[7] = { str = "Go straight out of the tower over the mountains to #C_[51,28]# and turn in 'Unfinished Business (2)' doing the 3rd part 'Unfinished Business (3)' is optional. Some classes can do it easier than others. You have to run north to hearthglen and run up into the big tower in the center of town at #C_[45,18]# and look over the edge until it says complete.", x = 45, y = 18, zone = "Western Plaguelands" },
			[8] = { str = "Run back straight south over the mountains to #C_[51,28]# and turn in 'Unfinished Business (3)'.", x = 51, y = 28, zone = "Western Plaguelands" },
			[9] = { str = "Run into EPL and up to #C_[7,43]# and turn in #Q_'Of Lost Honor'# accept 'Of Love and Family '.", x = 7, y = 43, zone = "Eastern Plaguelands" },
			[10] = { str = "Go back to WPL and run/swim to the island Scholo is on at #C_[65,75]# and turn in 'Of Love and Family ' SKIP the rest until you do strat.", x = 65, y = 75, zone = "Western Plaguelands" },

			[11] = { str = "Go back to Chillwind Camp at #C_[43,84]# and turn in 'A Plague Upon Thee (3)'.", x = 43, y = 84, zone = "Western Plaguelands" },
...
------------59-60 Winterspring
	[5960] = {
		...
		items = {
			...
			[2] = { str = "On your left after entering turn in 'Are We There, Yeti? (3)'." },
			...
			[7] = { str = "Run to Starfall Village at #C_[52,30]# and accept 'Enraged Wildkin '.", x = 52, y = 30, zone = "Winterspring" },
			[8] = { str = "Turn in #Q_'Chillwind Horns'# SKIP the other unless you wanna go there." },
			[9] = { str = "Go south to #C_[59,59]# and touch the crate and turn in 'Enraged Wildkin ' accept 'Enraged Wildkin (2)'.", x = 59, y = 59, zone = "Winterspring" },
			[10] = { str = "Go back to the road at #C_[61,60]# and touch the wagon, turn in 'Enraged Wildkin (2)' accept 'Enraged Wildkin (3)' grab the box in the snow.", x = 61, y = 60, zone = "Winterspring" },
			...
			[12] = { str = "Now protect her while she does her thing. Make sure you get the feather off an owl for 'Enraged Wildkin (3)' When she stops in a cave, light the torch for her. If you don’t get the feather before you’re done keep killing until you got it." },
			...
			[18] = { str = "Go up to Starfall Village at #C_[52,30]# and turn in 'Enraged Wildkin (3)'.", x = 52, y = 30, zone = "Winterspring" },
