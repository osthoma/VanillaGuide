...
-----------50-51 Searing Gorge
	[5051] = {
		...
		items = {
			...
			[6] = { str = "Run down to #C_[71,72]# and kill Margol the Rager, and grab Margol's Horn off him which starts The Horn of the Beast This gives you the searing gorge key, useless now that there is a FP here but good XP.", x = 71, y = 72, zone = "Searing Gorge" },
...
-----------51-52 Un’Goro Crater
	[5152] = {
		...
		items = {
			...
			[52] = { str = "Run to #C_[29,22]# and follow the path into Slithus to #C_[50,34]# grab the FP and fly to gadget.", x = 29, y = 22, zone = "Un’Goro Crater" },
...
-----------52-53 Azshara
	[5253] = {
		...
		items = {
			[1] = { str = "52-53 Azshara" },
			[2] = { str = "Just as you enter, on the right at #C_[11,77]# grab the FP.", x = 11, y = 77, zone = "Azshara" },
...
------------53-54 Felwood
	[5354] = {
		...
		items = {
			...
			[20] = { str = "Go up to #C_[62,24]# and get the FP.", x = 62, y = 24, zone = "Felwood" },
			...
			[27] = { str = "Go to #C_[48,67]# and grab the FP.", x = 48, y = 67, zone = "Moodglade" },
			...
			[43] = { str = "Go to #C_[62,36]# and grab the FP.", x = 62, y = 36, zone = "Winterspring" },
...
-----------54-54 Tanaris
	[5453] = {
		...
		items = {
			...
			[3] = { str = "Go east to the GY at #C_[54,28]# and drink your videre elixir.", x = 54, y = 28, zone = "Tanaris" },
...
-----------54-54 Felwood
	[5454] = {
		...
		items = {
			...
			[12] = { str = "Run All the way back down to #C_[51,82]# (I know no one wants to run back here, why the quest hub is so far from the FP is beyond me).", x = 51, y = 82, zone = "Felwood" },
...
-----------55-56 Burning Steppes
	[5556] = {
		...
		items = {
			...
			[2] = { str = "Go to #C_[83,63]# and follow the path up and grab the FP.", x = 83, y = 63, zone = "Burning Steps" },
...
------------56-57 Western Plaguelands
	[5657] = {
		...
		items = {
			...
			[23] = { str = "Hearth to IF then fly to #A_Stormwind#." },
...
-----------57-58 Eastern Plaguelands
	[5758] = {
		...
		items = {
			...
			[18] = { str = "If you’re within 6600 XP to level then Hearth to IF and fly to #A_Stormwind#, if not then grind until you’re within range." },
...
------------58-59 Western Plaguelands
	[5859] = {
		...
		items = {
			...
			[9] = { str = "Run into EPL and up to #C_[7,43]# and turn in 'Of Lost Honor' accept 'Of Love and Family pt.1'.", x = 7, y = 43, zone = "Eastern Plaguelands" },
			...
			[15] = { str = "Hearth to IF." },
			[16] = { str = "Go to the throne room at #C_[43,52]# and accept 'An Earnest Proposition' (pick your class from the list) You have to have your classes tier 0 bracers in order to do this quest. You can buy it on AH.", x = 43, y = 52, zone = "Ironforge" },
			[17] = { str = "Fly to Menethil and boat to Auberdine, fly to Darnassus." },
			[18] = { str = "Go to #C_[35,8]# on the 2nd floor and turn in 'Glyphed Oaken Branch'.", x = 35, y = 8, zone = "Darnassus" },
...
------------59-60 Winterspring
	[5960] = {
		...
		items = {
			...
			[6] = { str = "Go just SE of here around #C_[55,18]# and kill the chimera’s for 'Chillwind Horns'.", x = 55, y = 18, zone = "Winterspring" },
			...
			[11] = { str = "Run east again to #C_[63,59]# and turn in 'Find Ranshalla' accept 'Guardians of the Altar'.", x = 63, y = 59, zone = "Winterspring" },
			...
			[13] = { str = "Go south to #C_[62,69]# and loot the gems for 'Luck Be With You' hunters and locks can use pet to distract mobs while u loot, other classes will have to group.", x = 62, y = 69, zone = "Winterspring" },
			...
			[19] = { str = "Run to #C_[31,45]# and turn in 'Mystery Goo' accept 'Toxic Horrors'.", x = 31, y = 45, zone = "Winterspring" },
			[20] = { str = "Run into Felwood and go to #C_[48,24]# and kill toxic horrors for 'Toxic Horrors' these also drop essence of waters.", x = 48, y = 24, zone = "Felwood" },

			[21] = { str = "Fly to Rut’theran Village and go to the house at #C_[55,92]# and turn in 'Guardians of the Altar' accept 'Wildkin of Elune'.", x = 55, y = 92, zone = "Teldrassil" },
			[22] = { str = "Go in Darnassus and up to the top of the tower at #C_[34,8]# and turn in 'Wildkin of Elune'.", x = 34, y = 8, zone = "Darnassus" },
			[23] = { str = "Fly back to Felwood." },
			[24] = { str = "Run back up into Winterspring and over to #C_[31,45]# turn in 'Toxic Horrors' accept 'Winterfall Runners'.", x = 31, y = 45, zone = "Winterspring" },
