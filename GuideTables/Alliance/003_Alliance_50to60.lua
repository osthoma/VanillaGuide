...
-----------50-51 Searing Gorge
	...
	[5051] = {
		...
		items = {
			...
			[4] = { str = "Clear all the mobs and at the bottom of the little pit, accept Suntara Stones pt.1 escort him to #COORDS[74,19]# and when he dies grab the note which starts Suntara Stones pt.2", x = 74, y = 19, zone = "Searing Gorge" },
			[5] = { str = "Run back down near the outhouse at #COORDS[65,62]# and get the last of your geologist kills if you need them and turn in Caught! at the outhouse, accept Ledger From Tanaris and grab the book he slips you under the door.", x = 65, y = 62, zone = "Searing Gorge" },
			[6] = { str = "Run down to #COORDS[71,72]# and kill Margol the Rager, and grab Margol's Horn off him which starts The Horn of the Beast This gives you the searing gorge key, useless now that there is a FP here but good XP", x = 71, y = 72, zone = "Searing Gorge" },
			[7] = { str = "Run over to #COORDS[39,38]# and accept Divine Retribution then talk to him until completed, accept The Flawless Flame", x = 39, y = 38, zone = "Searing Gorge" },
			...
			[15] = { str = "Run down to #COORDS[18,83]# and turn in The Horn of the Beast accept Proof of Deed", x = 18, y = 83, zone = "Searing Gorge" },
			[16] = { str = "Hearth to IF" },
			[17] = { str = "Go to #COORDS[69,11]# turn in, Proof of Deed, accept At Last!", x = 69, y = 11, zone = "Searing Gorge" },
			...
			[46] = { str = "Run over to the path up the mountain at #COORDS[24,32]#", x = 24, y = 32, zone = "Searing Gorge" },
			[47] = { str = "Kill the elites 1 by 1 on your way up to the lava pit at #COORDS[29,25]# and clear the mobs around it, the idolators don’t chain link and don’t attack when you touch the rock in the center. Jump on the rock either with mount or jump in lava then on it. Open it for Release Them", x = 29, y = 25, zone = "Searing Gorge" },
			...
			[56] = { str = "Go to #COORDS[81,91]# and look for a named murloc Jarquia for Ledger From Tanaris", x = 81, y = 91, zone = "Swamp of Sorrows" },
			...
			[65] = { str = "Go to the cave at #COORDS[31,66]# and touch the scroll in the back of the cave which turns in Cortello's Riddle pt.2 accept Cortello's Riddle pt.3", x = 31, y = 66, zone = "Duskwallow Marsh" },
...
-----------51-52 Un’Goro Crater
	...
	[5152] = {
		...
		items = {
			...
			[4] = { str = "Follow the path down to the waterfall at #COORDS[71,75]# and accept The Apes of Un'Goro and The Fare of Lar'Korwi", x = 71, y = 75, zone = "Un’Goro Crater" },
			[5] = { str = "Grind to #COORDS[62,68]# and click on the wrecked raft, accept It's A Secret to Everybody pt.1 then take 2 steps under the water, turn it in and accept It's A Secret to Everybody pt.2", x = 62, y = 68, zone = "Un’Goro Crater" },
			[6] = { str = "Grind to #COORDS[68,56]# and get the meat off the big dinosaur for The Fare of Lar'Korwi", x = 68, y = 56, zone = "Un’Goro Crater" },
			[7] = { str = "Go back to #COORDS[71,75]# and turn in The Fare of Lar'Korwi accept The Scent of Lar'Korwi", x = 71, y = 75, zone = "Un’Goro Crater" },
			...
			[25] = { str = "Go east along the mountains to #COORDS[54,13]# and take that path up examine the pylon for The Northern Pylon and go farther north, there should be sone pterrodaxes.", x = 54, y = 13, zone = "Un’Goro Crater" },
			[26] = { str = "Go east to #COORDS[63,16]# and kill gorillas for The Apes of Un'Goro then go in the cave and stay right to turn in Chasing A-Me 01 SKIP the next part for now", x = 63, y = 16, zone = "Un’Goro Crater" },
			[27] = { str = "You’re gonna see a bunch of black lakes near the north of the map around #COORDS[52,23]# Kill the tar monsters around the lakes for Super Sticky The 3 lakes south of the gorillas around #COORDS[61,27]# have lower level tar monsters and there is also bloodpetals around here for Muigin and Larion there is also diametradons and pterrodaxes for Shizzle's Flyer running around", x = 61, y = 27, zone = "Un’Goro Crater" },
			...
			[35] = { str = "Go west to #COORDS[50,77]# into the slithering scar, at the fork go left into the big room, stand in the middle, use the scraping vial for Alien Ecology", x = 50, y = 77, zone = "Un’Goro Crater" },
			...
			[37] = { str = "Run to the camp at #COORDS[38,65]# and grab the research equipment for Expedition Salvation", x = 38, y = 65, zone = "Un’Goro Crater" },
			...
			[60] = { str = "Fly to Astranaar, then ride all the way east on the road to #COORDS[91,46]# which goes into Azshara, it’s far", x = 91, y = 46, zone = "Ashenvale" },
		}
	},
...
-----------52-53 Azshara
	...
	[5253] = {
		...
		items = {
			...
			[4] = { str = "Go just north to around #COORDS[14,72]# and #COORDS[16,67]#and kill all the ghosts around here until you complete Spiritual Unrest", x = 14, y = 72, zone = "Azshara" },
			[5] = { str = "Go just north to #COORDS[19,61]# and kill all the satyr’s around here for A Land Filled With Hatred", x = 19, y = 61, zone = "Azshara" },
			[6] = { str = "Go back to #COORDS[11,77]# and turn in Spiritual Unrest and A Land Filled With Hatred", x = 11, y = 77, zone = "Azshara" },
			[7] = { str = "Go to #COORDS[39,55]# and get the Markri rubbing for Arcane Runes", x = 39, y = 55, zone = "Azshara" },
			[8] = { str = "Go to #COORDS[36,53]# and get the Beth’Amara Rubbing for Arcane Runes", x = 36, y = 53, zone = "Azshara" },
			[9] = { str = "Go to #COORDS[39,50]# and get the Jin’yael rubbing for Arcane Runes", x = 39, y = 50, zone = "Azshara" },
			[10] = { str = "Go to #COORDS[42,42]# and turn in The Hunter's Charm accept Courser Antlers this quest and the follow up are optional to do after you turn 53, I do them so if you don’t you’ll be behind a little on the guide. It takes about 1-2 hours unless you get lucky, to get all the pieces for this and the next quest but will put you about 20-25% into the level", x = 42, y = 42, zone = "Azshara" },
		}
	},
...
------------53-54 Felwood
	...
	[5354] = {
		...
		items = {
			...
			[3] = { str = "Run north a little bit to #COORDS[51,81]# and accept Forces of Jaedenar", x = 51, y = 81, zone = "Felwood" },
			...
			[7] = { str = "Go just SW of here around #COORDS[48,91]# and kill the Furlbogs until you finish Timbermaw Ally Just grind em all for rep until you’re done", x = 48, y = 91, zone = "Felwood" },
			...
			[15] = { str = "Go back up to Jaedenar to the green pool at #COORDS[35,59]# and fill the canteen for Collection of the Corrupt Water", x = 35, y = 59, zone = "Felwood" },
			[16] = { str = "Go back to #COORDS[51,82]# and turn in Collection of the Corrupt Water accept Seeking Spiritual Aid", x = 51, y = 82, zone = "Felwood" },
			[17] = { str = "Go up to #COORDS[42,20]# and kill Entropic beasts and horrors and explore the craters for Verifying the Corruption.", x = 42, y = 20, zone = "Felwood" },
			...
			[25] = { str = "Run south to #COORDS[31,45]# and turn in The New Springs accept Strange Sources also turn in It's A Secret to Everybody pt.3 accept The Videre Elixir and Threat of the Winterfall", x = 31, y = 45, zone = "Winterspring" },
			[26] = { str = "Run back throug the cave and go west at the fork into Moonglade." },
			[27] = { str = "Go to #COORDS[48,67]# and grab the FP", x = 48, y = 67, zone = "Moodglade" },
			...
			[36] = { str = "Run back up into Felwood to #COORDS[54,86]# and turn in Cleansing Felwood", x = 54, y = 86, zone = "Felwood" },
			...
			[46] = { str = "Run down to #COORDS[65,43]# and turn in Seeking Spiritual Aid accept Cleansed Water Returns to Felwood", x = 65, y = 43, zone = "The Barrens" },
...
-----------54-54 Tanaris
	...
	[5453] = {
		...
		items = {
			...
			[3] = { str = "Go east to the GY at #COORDS[54,28]# and drink your videre elixir", x = 54, y = 28, zone = "Tanaris" },
			[4] = { str = "Now you’re gonna die, don’t rez just release and run north to #COORDS[53,23]# and turn in Meet at the Grave accept A Grave Situation", x = 53, y = 23, zone = "Tanaris" },
			[5] = { str = "Go back and rez at #COORDS[54,28]# and touch the only tombstone there, turn in A Grave Situation accept Linken's Sword", x = 54, y = 28, zone = "Tanaris" },
			[6] = { str = "Run into Un’Goro, I’d say fly but we have to go way SE" },
			[7] = { str = "Run up to #COORDS[71,75]# and accept The Mighty U'cha", x = 71, y = 75, zone = "Un’Goro" },
			...
			[16] = { str = "Run down to #COORDS[71,75]# and turn in The Mighty U'cha", x = 71, y = 75, zone = "Un’Goro" },
			[17] = { str = "You should be over half way to 55 now" },
			[18] = { str = "Hearth back to Astranaar and fly to Darnassus" },
			[19] = { str = "Go in the Temple of the Moon at #COORDS[39,84]# and fill the vial for Felbound Ancients", x = 39, y = 84, zone = "Darnassus" },
...
-----------54-54 Felwood
	...
	[5454] = {
		...
		items = {
			...
			[6] = { str = "Go into the cave at #COORDS[35,58]#", x = 35, y = 58, zone = "Felwood" },
			[7] = { str = "At the first open area with the caged npc at #COORDS[36,56]# is brazier for Dousing the Flames of Protection the 2nd one is just up the ramp", x = 36, y = 56, zone = "Felwood" },
			...
			[15] = { str = "If you have skinning I’m sure you have at least 5 tainted hides, go down to #COORDS[54,86]# and turn them in for Salve via Skinning", x = 54, y = 86, zone = "Felwood" },
...
--------------54-55 Winterspring
	...
	[5455] = {
		...
		items = {
			...
			[7] = { str = "Run All the way south to #COORDS[60,73]# to complete Strange Sources", x = 60, y = 73, zone = "Winterspring" },
			...
			[16] = { str = "Run up to Starfall Village at #COORDS[51,30]# and turn in To Winterspring! accept The Ruins of Kel'Theril", x = 51, y = 30, zone = "Winterspring" },
			...
			[26] = { str = "In Rut’theran Village turn in Moontouched Wildkin #COORDS[55,92]# accept Find Ranshalla", x = 55, y = 92, zone = "Darnassus" },
			[27] = { str = "Go into Darnassus up to #COORDS[34,8]# in the big tower and turn in The New Frontier pt.1 accept The New Frontier pt.2 go down 1 floor and turn that in, accept Rabine Saturna", x = 34, y = 8, zone = "Darnassus" },
...
-----------55-56 Burning Steppes
	...
	[5556] = {
		...
		items = {
			...
			[5] = { str = "Start killing ogres all over the mountain at #COORDS[81,42]# for Extinguish the Firegut then run back to #COORDS[84,68]# and turn it in, accept Gor'tesh the Brute Lord", x = 81, y = 42, zone = "Burning Steps" },
			[6] = { str = "Go NW to around #COORDS[66,40]# and collect the ruins that look like tombstones for The Smoldering Ruins of Thaurissan pt.2", x = 66, y = 40, zone = "Burning Steps" },
			[7] = { str = "Run up to #COORDS[65,24]# and go in the cave, turn in Yuka Screwspigot SKIP the rest", x = 65, y = 24, zone = "Burning Steps" },
			...
			[15] = { str = "Ride back to #COORDS[84,68]# and next to the griffin turn in FIFTY! YEP! and Gor'tesh the Brute Lord accept Ogre Head On A Stick = Party", x = 84, y = 68, zone = "Burning Steps" },
			[16] = { str = "In front of the broken house, turn in Dragonkin Menace accept The True Masters pt.1" },
			[17] = { str = "Run up to the top of the mountin at #COORDS[80,45]# and click the soft dirt pile for Ogre Head On A Stick = Party then run back to #COORDS[84,68]# and turn it in", x = 80, y = 45, zone = "Burning Steps" },
...
-----------56-56 Tanaris
	...
	[5655] = {
		...
		items = {
			...
			[4] = { str = "To the south of lost rigger cove at #COORDS[70,49]# is a bunch of stones in a circle, Loot the stuff from the blue backpack and use the book to summon Aquementas He’s a level 54 water elemental pansy", x = 70, y = 49, zone = "Tanaris" },
...
-----------56-56 Silithus
	...
	[5656] = {
		...
		items = {
			...
			[16] = { str = "Go SE to #COORDS[62,53]# and kill the undead guys here for The Spirits of Southwind becareful when they die they spawn 1-2 bugs", x = 62, y = 53, zone = "Silithus" },
			[17] = { str = "Kill the pincers for Noggle's Last Hope and drudges for The Deserter south of here around #COORDS[56,58]#", x = 56, y = 58, zone = "Silithus" },
			...
			[25] = { str = "Go all the way down south to the little camp at #COORDS[42,90]# and go up the hill behind it, you’ll find Deathclasp, in the middle of the path on the wall is a pouch, grab it when deathclasp is in the back for Noggle's Lost Satchel", x = 42, y = 90, zone = "Silithus" },
			[26] = { str = "Head to the SW to #COORDS[16,87]# and kill Twilight Keeper Exeter for The Twilight Lexicon he’s at the SW corner of camp", x = 16, y = 87, zone = "Silithus" },
			[27] = { str = "Go back to the cave at #COORDS[67,69]# and turn in The Twilight Lexicon accept A Terrible Purpose He also offers another quest for 10 twilight texts, this is more for cen circle rep later on", x = 67, y = 69, zone = "Silithus" },
			...
			[36] = { str = "Go to #COORDS[44,35]# and turn in Umber, Archivist accept Uncovering Past Secrets", x = 44, y = 35, zone = "Moonglade" },
			[37] = { str = "Run over to #COORDS[51,44]# and turn in Uncovering Past Secrets", x = 44, y = 35, zone = "Moonglade" },
...
------------56-57 Western Plaguelands
	...
	[5657] = {
		...
		items = {
			...
			[7] = { str = "Go NE to around #COORDS[51,78]# and grind the ghouls here until you got enough for Clear The Way", x = 51, y = 78, zone = "Western Plaguelands" },
			...
			[16] = { str = "Run back to Chillwind Camp at #COORDS[42,84]# and turn in All Along the Watchtowers, accept Scholomance SKIP the other unless you get about 10-20 people.", x = 42, y = 84, zone = "Western Plaguelands" },
			...
			[26] = { str = "Go into the keep at #COORDS[78,17]# and accept The First and the Last", x = 78, y = 17, zone = "Stormwind" },
			[27] = { str = "Go to #COORDS[75,79]# and turn in The First and the Last accept Honor the Dead then turn it right back in, accept Flint Shadowmore", x = 75, y = 79, zone = "Stormwind" },
			...
			[35] = { str = "Go back to Chillwind Camp at #COORDS[42,84]# anc turn in Return to Chillwind Camp accept Target: Gahrron's Withering", x = 42, y = 84, zone = "Western Plaguelands" },
			[36] = { str = "Go just north of the Writhing Haunt between the mountains on the map at, #COORDS[52,56]# and kill diseased grizzleys on your way down to #COORDS[62,58]# for The Wildlife Suffers Too pt.2", x = 52, y = 56, zone = "Western Plaguelands" },
			[37] = { str = "Go NE to #COORDS[62,58]# to Gahrron’s Withering, kill Cauldron Lord Soulwrath for his cauldron key. Then go right click the cauldron and turn in Target: Gahrron's Withering accept Return to Chillwind Camp", x = 62, y = 58, zone = "Western Plaguelands" },
...
-----------57-58 Eastern Plaguelands
	...
	[5758] = {
		...
		items = {
			...
			[5] = { str = "Keep killing the dogs and bats and head over to the skeleton at #COORDS[28,74]# open it and grab the insignia for The Eastern Plagues then run up a bit further to the next skeleton at #COORDS[27,74]# and grab the insignia, it’s practically right in front of him and you will also get the blightcaller found complete message. Now go down near the road to #COORDS[28,79]# and loot the last insignia off the skeleton", x = 28, y = 74, zone = "Eastern Plaguelands" },
			[6] = { str = "Focus on the dogs and bats while you head to Darrowshire at #COORDS[36,90]# in the broken down house. Turn in Sister Pamela accept Pamela's Doll then head towards the houses here, in any of the houses can be any of the 3 doll parts. They are random. Ghosts spawn when you get near the parts so be aware. Once you have all 3 parts combine them and go back to #COORDS[36,90]# and turn in Pamela's Doll accept Auntie Marlene and Uncle Carlin", x = 36, y = 90, zone = "Eastern Plaguelands" },
			[7] = { str = "Look on your map at #COORDS[48,76]# This lines up with that middle ridge mountain. Don’t go past this spot east until you have your plaguehound runt kills for Demon Dogs and plaguebats for Blood Tinged Skies because there is none past that point.", x = 48, y = 76, zone = "Eastern Plaguelands" },
			...
			[15] = { str = "Run SW to #COORDS[79,63]# and accept Zaeldarr the Outcast", x = 79, y = 63, zone = "Eastern Plaguelands" },
			[16] = { str = "Fly back to EPL" },
			[17] = { str = "In front of the house turn in The Eastern Plagues accept The Blightcaller Cometh" },
			[18] = { str = "If you’re within #COORDS[6,60]#0 to level then Hearth to IF and fly to SW, if not then grind until you’re within range." },
...
-----------58-58 Western Plaguelands
	...
	[5857] = {
		...
		items = {
			...
			[3] = { str = "Just north of the house at #COORDS[49,76]# you’ll see an off color gravestone. Loot it and get the wedding ring for A Strange Historian", x = 49, y = 76, zone = "Western Plaguelands" },
			[4] = { str = "Go in the west entrance to Andorhal at #COORDS[39,71]#and you should see the only full building, looks like an Inn at #COORDS[39,68]#. Go upstairs and turn in A Strange Historian accept The Annals of Darrowshire also accept A Matter of Time", x = 39, y = 68, zone = "Western Plaguelands" },
			...
			[7] = { str = "Go back to the Inn at #COORDS[39,68]# and to the top floor, turn in A Matter of Time accept Counting Out Time also turn in The Annals of Darrowshire accept Brother Carlin", x = 39, y = 68, zone = "Western Plaguelands" },
			[8] = { str = "Go outside and look around the busted houses for little metal lunchboxes for Counting Out Time" },
			[9] = { str = "Go back to the Inn at #COORDS[39,68]# and turn in Counting Out Time you can now repeat this quest for a dampener. This is used vs the 61 elite", x = 39, y = 68, zone = "Western Plaguelands" },
		}
	},
...
-----------58-58 Eastern Plaguelands
	...
	[5858] = {
		...
		items = {
			...
			[3] = { str = "Go to the Undercroft at #COORDS[28,86]# and run behind it. Touch the dirt pile to summon Mercutio and 3 guards. Easiest way to do this is to kite him away from his buddies or get a group. Loot his body for the hammer for Of Forgotten Memories", x = 28, y = 86, zone = "Eastern Plaguelands" },
			...
			[5] = { str = "Go back to #COORDS[7,43]# and turn in Of Forgotten Memories accept Of Lost Honor", x = 7, y = 43, zone = "Eastern Plaguelands" },
...
------------58-59 Western Plaguelands
	...
	[5859] = {
		...
		items = {
			...
			[3] = { str = "Start heading back SW around #COORDS[47,32]# and clear your way into the mill. Right click the box and place the termintes, then click the barrel and turn in “A Plague Upon Thee pt.2” accept “A Plague Upon Thee pt.3”", x = 47, y = 32, zone = "Western Plaguelands" },
			[4] = { str = "Go just south of #COORDS[49,42]# and kill 2 knights and mages for “Unfinished Business pt.1” then #COORDS[51,43]# for the hunters and medics", x = 49, y = 42, zone = "Western Plaguelands" },
			[5] = { str = "Go to #COORDS[51,28]# and turn in “Unfinished Business pt.1” accept “Unfinished Business pt.2”", x = 51, y = 28, zone = "Western Plaguelands" },
			[6] = { str = "Go to #COORDS[57,36]# and kill Huntsman Radly for “Unfinished Business pt.2” then north to the tower at #COORDS[55,23]# and kill Cavalier Durgen at the top", x = 57, y = 36, zone = "Western Plaguelands" },
			[7] = { str = "Go straight out of the tower over the mountains to #COORDS[51,28]# and turn in “Unfinished Business pt.2” doing the 3rd part “Unfinished Business pt.3” is optional. Some classes can do it easier than others. You have to run north to hearthglen and run up into the big tower in the center of town at #COORDS[45,18]# and look over the edge until it says complete.", x = 45, y = 18, zone = "Western Plaguelands" },
			...
			[15] = { str = "Hearth to IF" },
			[16] = { str = "Go to the throne room at #COORDS[43,52]# and accept “An Earnest Proposition” (pick your class from the list) You have to have your classes tier 0 bracers in order to do this quest. You can buy it on AH", x = 43, y = 52, zone = "Ironforge" },
			[17] = { str = "Fly to Menethil and boat to Auberdine, fly to Darnassus" },
			[18] = { str = "Go to #COORDS[35,8]# on the 2nd floor and turn in “Glyphed Oaken Branch”", x = 35, y = 8, zone = "Darnassus" },
...
------------59-60 Winterspring
	...
	[5960] = {
		...
		items = {
			...
			[6] = { str = "Go just SE of here around #COORDS[55,18]# and kill the chimera’s for “Chillwind Horns”", x = 55, y = 18, zone = "Winterspring" },
			[7] = { str = "Run to Starfall Village at #COORDS[52,30]# and accept “Enraged Wildkin pt.1”", x = 52, y = 30, zone = "Winterspring" },
			...
			[25] = { str = "Now to find the runners. They travel anywhere from the Timbermaw Cave east to #COORDS[53,34]# then up around the mountains north of everlook over to Winterfall Village. If you didn’t see them from the cave to here, head east. You don’t have to kill all 3", x = 53, y = 34, zone = "Winterspring" },
			[26] = { str = "Once you get the crate run back to #COORDS[31,45]# Turn in Winterfall Runners an ambush will come from the lake, if u don’t move from the tent they won’t aggro you. SKIP the next part unless you get a group", x = 31, y = 45, zone = "Winterspring" },
