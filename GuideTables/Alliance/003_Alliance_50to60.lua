...
-----------50-51 Searing Gorge
	[5051] = {
		...
		items = {
			...
			[2] = { str = "Go down to #C_[65,62]# and touch the outhouse, accept 'Caught!'.", x = 65, y = 62, zone = "Searing Gorge" },
			[3] = { str = "Go just below the outhouse and kill the geologists for 'Caught!'." },
			[4] = { str = "Clear all the mobs and at the bottom of the little pit, accept 'Suntara Stones' escort him to #C_[74,19]# and when he dies grab the note which starts 'Suntara Stones'(2).", x = 74, y = 19, zone = "Searing Gorge" },
			[5] = { str = "Run back down near the outhouse at #C_[65,62]# and get the last of your geologist kills if you need them and turn in 'Caught!' at the outhouse, accept 'Ledger From Tanaris' and grab the book he slips you under the door.", x = 65, y = 62, zone = "Searing Gorge" },
			[6] = { str = "Run down to #C_[71,72]# and kill Margol the Rager, and grab Margol's Horn off him which starts 'The Horn of the Beast'. This gives you the searing gorge key, useless now that there is a flight path here but good XP.", x = 71, y = 72, zone = "Searing Gorge" },
			[7] = { str = "Run over to #C_[39,38]# and accept 'Divine Retribution' then talk to him until completed, accept 'The Flawless Flame'.", x = 39, y = 38, zone = "Searing Gorge" },
			...
			[17] = { str = "Go to #C_[69,11]# turn in, 'Proof of Deed', accept 'At Last!'", x = 69, y = 11, zone = "Searing Gorge" },
			[18] = { str = "Go to #C_[75,23]# and accept 'A Little Slime Goes A Long Way'.", x = 75, y = 23, zone = "Searing Gorge" },
			...
			[27] = { str = "Turn in 'The Flawless Flame' accept 'Forging the Shaft' when you’re near #A_Thorium Point# again." },
			[28] = { str = "Kill greater lava spiders (not searing) for 'Fiery Menace!' Mostly SW." },
			[29] = { str = "If the Grimesilt Outhouse Key dropped, use it to start 'The Key to Freedom' and turn it in at #C_[65,62]#.", x = 65, y = 62, zone = "Searing Gorge" },
			...
			[33] = { str = "Go in the cave to #C_[41,25]# and go through the jail bar door, turn in 'Dwarven Justice' accept 'Release Them'.", x = 41, y = 25, zone = "Searing Gorge" },
			...
			[49] = { str = "Make sure you talk to the caged npc next to the lava, he gives you 'Prayer to Elune' Listen to his short story and turn it in for 'Prayer to Elune'(2) Now you have to kill these for the Rag dropping and the 'Prayer of Elune', Easy drops." },
			[50] = { str = "Go down to #C_[38,38]# and turn in 'The Flame’s Casing' accept 'The Torch of Retribution' then turn it back in accept 'The Torch of Retribution'(2) then grab the torch in front of him and complete it and accept 'Squire Maltrake' and turn that back in and accept 'Set Them Ablaze!'", x = 38, y = 38, zone = "Searing Gorge" },
...
-----------51-52 Un’Goro Crater
	[5152] = {
		...
		items = {
			...
			[4] = { str = "Follow the path down to the waterfall at #C_[71,75]# and accept 'The Apes of Un'Goro' and The 'Fare of Lar'Korwi'.", x = 71, y = 75, zone = "Un’Goro Crater" },
			[5] = { str = "Grind to #C_[62,68]# and click on the wrecked raft, accept 'It's A Secret to Everybody' then take 2 steps under the water, turn it in and accept 'It's A Secret to Everybody'(2).", x = 62, y = 68, zone = "Un’Goro Crater" },
			[6] = { str = "Grind to #C_[68,56]# and get the meat off the big dinosaur for 'The Fare of Lar'Korwi'.", x = 68, y = 56, zone = "Un’Goro Crater" },
			[7] = { str = "Go back to #C_[71,75]# and turn in 'The Fare of Lar'Korwi' accept 'The Scent of Lar'Korwi'.", x = 71, y = 75, zone = "Un’Goro Crater" },
			[8] = { str = "Grind west to about #C_[67,63]# and there will be 2 spots with a bunch of eggs. Clear the raptors around it and stand on the eggs to get the mates to spawn for 'The Scent of Lar'Korwi'.", x = 67, y = 63, zone = "Un’Goro Crater" },
			[9] = { str = "Once you have this done, go back to #C_[71,75]# and turn in 'The Scent of Lar'Korwi' accept 'The Bait For Lar'Korwi' you should have found the jornal by now as well, if not keep grinding raptors while you’re questing in this spot. If you have start the quest 'Williden’s Journal'.", x = 71, y = 75, zone = "Un’Goro Crater" },
			...
			[11] = { str = "Go to #C_[46,13]# and accept 'Chasing A-Me 01' and run up the path behind her into Marshal’s Refuge.", x = 46, y = 13, zone = "Un’Goro Crater" },
			...
			[25] = { str = "Go east along the mountains to #C_[54,13]# and take that path up examine the pylon for 'The Northern Pylon' and go farther north, there should be sone pterrodaxes.", x = 54, y = 13, zone = "Un’Goro Crater" },
			[26] = { str = "Go east to #C_[63,16]# and kill gorillas for 'The Apes of Un'Goro' then go in the cave and stay right to turn in 'Chasing A-Me 01'. SKIP the next part for now.", x = 63, y = 16, zone = "Un’Goro Crater" },
			[27] = { str = "You’re gonna see a bunch of black lakes near the north of the map around #C_[52,23]# Kill the tar monsters around the lakes for 'Super Sticky' The 3 lakes south of the gorillas around #C_[61,27]# have lower level tar monsters and there is also bloodpetals around here for #Q_'Muigin and Larion'# there is also diametradons and pterrodaxes for #Q_'Shizzle's Flyer'# running around.", x = 61, y = 27, zone = "Un’Goro Crater" },
			...
			[30] = { str = "Go to #C_[76,51]# and follow the path up to the pylon for 'The Eastern Pylon' and there should be pterrodaxes further south at #C_[75,61]#.", x = 76, y = 51, zone = "Un’Goro Crater" },

			[31] = { str = "Go to #C_[71,75]# and turn in' The Bait For Lar'Korwi' and 'The Apes of Un'Goro' SKIP the next part for now.", x = 71, y = 75, zone = "Un’Goro Crater" },
			...
			[33] = { str = "Just east of the volcano (center of map) there are pterrodaxes all for 'Beware of Pterrordax' if you’re having trouble finding them there is a spawn of 6 of them all the way south at #C_[55,90]#.", x = 55, y = 90, zone = "Un’Goro Crater" },
			...
			[38] = { str = "Kill frenzied pterrodaxes all around #C_[35,38]# (they’re everywhere) in the NW part of the map for 'Beware of Pterrordax' plus there are many diametradons here for #Q_'Shizzle's Flyer'# or #Q_'Roll the Bones'#.", x = 35, y = 38, zone = "Un’Goro Crater" },
			[39] = { str = "Go down to #C_[23,59]# and touch the western pylon for 'The Western Pylon' and kill any pterrodaxes you need behind it.", x = 23, y = 59, zone = "Un’Goro Crater" },
			[40] = { str = "Go to #C_[30,50]# and accept 'Finding the Source'.", x = 30, y = 50, zone = "Un’Goro Crater" },

			[41] = { str = "Go over to Fire Plume Ridge at #C_[51,48]# and kill elementals, try to avoid anything 56+ for 'Volcanic Activity' Leave blazing invaders alone.", x = 51, y = 48, zone = "Un’Goro Crater" },
			...
			[43] = { str = "Unless you need ashes still run to #C_[30,50]# and turn in 'Finding the Source' accept 'The New Springs'.", x = 30, y = 50, zone = "Un’Goro Crater" },
			[44] = { str = "Go up into the cave (in the same manner) at #C_[51,49]# and turn in 'Lost!' then accept 'A Little Help From My Friends' he follows you, once you get him out of the ridge it’s easy. Just go straight out the cave over the edge, if done right you only have to fight 1 element. Once you go north past the river it’s pie.", x = 51, y = 49, zone = "Un’Goro Crater" },
...
-----------52-53 Azshara
	[5253] = {
		...
		items = {
			...
			[6] = { str = "Go back to #C_[11,77]# and turn in Spiritual Unrest and A Land Filled With Hatred.", x = 11, y = 77, zone = "Azshara" },
			[7] = { str = "Go to #C_[39,55]# and get the Markri rubbing for Arcane Runes.", x = 39, y = 55, zone = "Azshara" },
			[8] = { str = "Go to #C_[36,53]# and get the Beth’Amara Rubbing for Arcane Runes.", x = 36, y = 53, zone = "Azshara" },
			[9] = { str = "Go to #C_[39,50]# and get the Jin’yael rubbing for Arcane Runes.", x = 39, y = 50, zone = "Azshara" },
			[10] = { str = "Go to #C_[42,42]# and turn in The Hunter's Charm accept Courser Antlers this quest and the follow up are optional to do after you turn 53, I do them so if you don’t you’ll be behind a little on the guide. It takes about 1-2 hours unless you get lucky, to get all the pieces for this and the next quest but will put you about 20-25% into the level.", x = 42, y = 42, zone = "Azshara" },
		}
	},
...
------------53-54 Felwood
	[5354] = {
		...
		items = {
			[1] = { str = "53-54 Felwood" },
			[2] = { str = "Stop at #C_[54,86]# and accept Cleansing Felwood.", x = 54, y = 86, zone = "Felwood" },
			[3] = { str = "Run north a little bit to #C_[51,81]# and accept Forces of Jaedenar.", x = 51, y = 81, zone = "Felwood" },
			...
			[7] = { str = "Go just SW of here around #C_[48,91]# and kill the Furlbogs until you finish Timbermaw Ally Just grind em all for rep until you’re done.", x = 48, y = 91, zone = "Felwood" },
			[8] = { str = "Go back to #C_[50,85]# and turn in Timbermaw Ally accept Speak to Nefian the other is repeatable for rep.", x = 50, y = 85, zone = "Felwood" },
			[9] = { str = "Go up near the 2 lakes at #C_[40,69]# and kill the cursed oozes for the first part of A Little Slime Goes A Long Way pt.1.", x = 40, y = 69, zone = "Felwood" },
			[10] = { str = "Go to the west of here now to #C_[37,69]# and kill the jadefire demons for The Corruption of the Jadefire these are good to farm too.", x = 37, y = 69, zone = "Felwood" },

			[11] = { str = "Go up to #C_[39,59]# and kill the tainted oozes for the second part of A Little Slime Goes A Long Way pt.1.", x = 39, y = 59, zone = "Felwood" },
			[12] = { str = "Go just west of here around #C_[37,59]# and kill the Jaedenar for Forces of Jaedenar You don’t have to go in the caves.", x = 37, y = 59, zone = "Felwood" },
			[13] = { str = "Go back to #C_[51,82]# and turn in Forces of Jaedenar accept Collection of the Corrupt Water.", x = 51, y = 82, zone = "Felwood" },
			[14] = { str = "Inside the house turn in The Corruption of the Jadefire accept Further Corruption." },
			[15] = { str = "Go back up to Jaedenar to the green pool at #C_[35,59]# and fill the canteen for Collection of the Corrupt Water.", x = 35, y = 59, zone = "Felwood" },
			[16] = { str = "Go back to #C_[51,82]# and turn in Collection of the Corrupt Water accept Seeking Spiritual Aid.", x = 51, y = 82, zone = "Felwood" },
			...
			[23] = { str = "Go back to #C_[64,8]# and turn in Deadwood of the North and you should be unfriendly now and not aggro’d any longer. Accept Speak to Salfa and turn in any 5 sets of feathers for extra rep and 550 xp.", x = 64, y = 8, zone = "Felwood" },
			...
			[31] = { str = "Go up to #C_[45,25]# and buy a bait and read on how to get the videre elixir.", x = 45, y = 25, zone = "Feralas" },
			...
			[47] = { str = "Fly to Theramore and boat to Menethil then fly to #A_Ironforge#." },
			[48] = { str = "Just outside the military ward there should be a wandering npc, one is near flight path too, grab the quest The New Frontier pt.1." },
			[49] = { str = "Go to #C_[75,23]# and turn in A Little Slime Goes A Long Way pt.1 accept A Little Slime Goes A Long Way pt.2.", x = 75, y = 23, zone = "Ironforge" },
			[50] = { str = "Go to #C_[31,4]# and turn in Return to Tymor see it was worth the run.", x = 31, y = 4, zone = "Ironforge" },

			[51] = { str = "Fly to Menethil then boat to Theramore and fly to #A_Gadgetzan#." },
		}
	},
...
-----------54-54 Tanaris
	[5453] = {
		...
		items = {
			...
			[4] = { str = "Now you’re gonna die, don’t rez just release and run north to #C_[53,23]# and turn in Meet at the Grave accept A Grave Situation.", x = 53, y = 23, zone = "Tanaris" },
			[5] = { str = "Go back and rez at #C_[54,28]# and touch the only tombstone there, turn in A Grave Situation accept Linken's Sword.", x = 54, y = 28, zone = "Tanaris" },
			[6] = { str = "Run into Un’Goro, I’d say fly but we have to go way SE." },
			[7] = { str = "Run up to #C_[71,75]# and accept The Mighty U'cha.", x = 71, y = 75, zone = "Un’Goro" },
			[8] = { str = "Keep collecting dirt here if you need more morrowgrain." },
			[9] = { str = "Now all around the crater is slimes but you can find all the ones you need west of the volcano around #C_[37,37]# for A Little Slime Goes A Long Way pt.2 I think there are more on the west side of the volcano but you can look on both sides they’re scattered. If it says they’re cloning, finish them very fast or stun them. If they clone it’s a full health mob that you can’t scoop up.", x = 37, y = 37, zone = "Un’Goro" },
			[10] = { str = "Go to the cave at #C_[64,16]# and go to the right, when you see A-Me 01 accept Chasing A-Me 01 pt.1 and turn it back in. Fall over the edge and to the right and up around until you see U’cha for The Mighty U'cha.", x = 64, y = 16, zone = "Un’Goro" },

			[11] = { str = "Run back to the front and go right again and accept Chasing A-Me 01 pt.2 now escort her out." },
			[12] = { str = "Escort A-Me to Marshal’s at #C_[46,13]# and turn in Chasing A-Me 01 pt.2.", x = 46, y = 13, zone = "Un’Goro" },
...
-----------54-54 Felwood
	[5454] = {
		...
		items = {
			[1] = { str = "54-54 Felwood" },
			[2] = { str = "Go to #C_[51,82]# and turn in Cleansed Water Returns to Felwood accept Dousing the Flames of Protection.", x = 51, y = 82, zone = "Felwood" },
			...
			[7] = { str = "At the first open area with the caged npc at #C_[36,56]# is brazier for Dousing the Flames of Protection the 2nd one is just up the ramp.", x = 36, y = 56, zone = "Felwood" },
			[8] = { str = "Continue past the room with candles surrounding the hole to the next open room at #C_[36,53]# for the 3rd and 4th brazier for Dousing the Flames of Protection.", x = 36, y = 53, zone = "Felwood" },
			[9] = { str = "Don’t even bother trying to do the escort unless you get a group, I always skip it even if I find the key." },
			[10] = { str = "Run back outside and up to #C_[51,19]# and kill the tree elementals for Silver Heart.", x = 51, y = 19, zone = "Felwood" },
...
--------------54-55 Winterspring
	[5455] = {
		...
		items = {
			...
			[7] = { str = "Run All the way south to #C_[60,73]# to complete Strange Sources.", x = 60, y = 73, zone = "Winterspring" },
			[8] = { str = "Use your #I_[Hearthstone]# to return to back to Everlook, if it’s not up die on purpose." },
			[9] = { str = "Go to #C_[65,45]# and kill yeti’s for Are We There, Yeti? pt.1.", x = 65, y = 45, zone = "Winterspring" },
			[10] = { str = "Run back to Everlook and turn in Are We There, Yeti? pt.1 accept Are We There, Yeti? pt.2." },

			[11] = { str = "Go back to #C_[65,45]# and kill matriarch’s and patriarch’s for Are We There, Yeti? pt.2 there are a lot in the cave at #C_[67,42]#.", x = 67, y = 42, zone = "Winterspring" },
			...
			[14] = { str = "Go east of Winterspring to #C_[66,34]# and kill the furlbogs there for Winterfall Activity and part of Threat of the Winterfall.", x = 66, y = 34, zone = "Winterspring" },
			[15] = { str = "Hopefully you’ll find an Empty Firewater Flask on one of them which starts Winterfall Firewater." },
			[16] = { str = "Run up to Starfall Village at #C_[51,30]# and turn in To Winterspring! accept The Ruins of Kel'Theril.", x = 51, y = 30, zone = "Winterspring" },
			...
			[18] = { str = "Grab the relic at #C_[55,42]# for Troubled Spirits of Kel'Theril dismiss pet before you open them then run and FD. 2nd relic is at #C_[53,43]#. 3rd at #C_[52,41]# 4th at #C_[50,41]#." },
			[19] = { str = "Go west to #C_[39,43]# and kill furlbog here for Threat of the Winterfall also make sure you have your 10 feathers for Moontouched Wildkin.", x = 39, y = 43, zone = "Winterspring" },
			[20] = { str = "Go to #C_[31,45]# and turn in Strange Sources Threat of the Winterfall and Winterfall Firewater accept Falling to Corruption.", x = 31, y = 45, zone = "Winterspring" },

			[21] = { str = "Run to #C_[27,34]# and turn in Winterfall Activity.", x = 27, y = 34, zone = "Winterspring" },
			...
			[31] = { str = "Go to #C_[38,55]# in the throne room and accept The Smoldering Ruins of Thaurissan pt.1 then click on her and listen to the story and turn it back in, accept The Smoldering Ruins of Thaurissan pt.2.", x = 38, y = 55, zone = "Ironforge" },
...
-----------55-56 Burning Steppes
	[5556] = {
		...
		items = {
			...
			[6] = { str = "Go NW to around #C_[66,40]# and collect the ruins that look like tombstones for The Smoldering Ruins of Thaurissan pt.2.", x = 66, y = 40, zone = "Burning Steps" },
			[7] = { str = "Run up to #C_[65,24]# and go in the cave, turn in Yuka Screwspigot SKIP the rest.", x = 65, y = 24, zone = "Burning Steps" },
			[8] = { str = "Outside accept Tablet of the Seven and Broodling Essence." },
			[9] = { str = "Go to #C_[54,40]# and touch the dwarf statue for Tablet of the Seven.", x = 54, y = 40, zone = "Burning Steps" },
			[10] = { str = "Go west to #C_[43,46]# to blackrock stronghold or south to #C_[49,55]# the pillar of ash and kill the orcs for FIFTY! YEP! they drop in large amounts.", x = 43, y = 46, zone = "Burning Steps" },

			[11] = { str = "While in the pillar of ash at #C_[40,56]# you should kill Gor’tesh for Gor'tesh the Brute Lord.", x = 40, y = 56, zone = "Burning Steps" },
			...
			[13] = { str = "Go to the cave at #C_[94,31]# and accept A Taste of Flame then give him the molt and hand the quest back in. SKIP the next part.", x = 94, y = 31, zone = "Burning Steps" },
			[14] = { str = "Run back up to #C_[65,23]# and turn in Tablet of the Seven and Broodling Essence accept Felnok Steelspring.", x = 65, y = 23, zone = "Burning Steps" },
			...
			[18] = { str = "Fly to Lakeshire and run to the town hall at #C_[29,44]# and turn in The True Masters pt.1 accept The True Masters pt.2.", x = 29, y = 44, zone = "Redridge Mountains" },
			[19] = { str = "Fly to #A_Stormwind#." },
			[20] = { str = "Go to #C_[78,18]# into the #A_Stormwind# keep and turn in The True Masters pt.2 accept The True Masters pt.3 then talk to the lady and then turn it back in and accept The True Masters pt.4.", x = 78, y = 18, zone = "Stormwind City" },

			[21] = { str = "Fly back to Lakeshire and go to the townhall at #C_[29,44]# and turn in The True Masters pt.4 accept The True Masters pt.5.", x = 29, y = 44, zone = "Redridge Mountains" },
			[22] = { str = "Fly to the Burning Steppes and turn in The True Masters pt.5 when you land and accept The True Masters pt.6." },
			[23] = { str = "Run up to #C_[64,23]# and listen to ragged john then run back to #C_[84,68]# and turn in The True Masters pt.6 I SKIP the next part, do it later if you’re worried about speed leveling. That was an easy 30k xp for doing nothing and your ony key chain is started.", x = 64, y = 23, zone = "Burning Steps" },
			...
			[26] = { str = "Go to the thrown room at #C_[38,55]# and turn in The Smoldering Ruins of Thaurissan pt.2.", x = 38, y = 55, zone = "Ironforge" },
...
-----------56-56 Silithus
	[5656] = {
		...
		items = {
			...
			[8] = { str = "Go do Securing the Supply Lines and Deadly Desert Venom North and NE of town all around #C_[55,24]# the dredges, scorpids, and skitterers for these 2 quests are all over this area.", x = 55, y = 24, zone = "Silithus" },
			[9] = { str = "Run up to #C_[81,18]# and turn in Wasteland accept The Spirits of Southwind.", x = 81, y = 18, zone = "Silithus" },
			...
			[16] = { str = "Go SE to #C_[62,53]# and kill the undead guys here for The Spirits of Southwind becareful when they die they spawn 1-2 bugs.", x = 62, y = 53, zone = "Silithus" },
			[17] = { str = "Kill the pincers for Noggle's Last Hope and drudges for The Deserter south of here around #C_[56,58]#.", x = 56, y = 58, zone = "Silithus" },
			[18] = { str = "Go to the cave at #C_[67,69]# and turn in The Deserter accept The Twilight Lexicon.", x = 67, y = 69, zone = "Silithus" },
			[19] = { str = "You can find flayers and stalkers outside of the cave for Noggle's Last Hope they are also both around #C_[43,72]# on the other side of the hive.", x = 43, y = 72, zone = "Silithus" },
			...
			[23] = { str = "Go to #C_[29,35]# and kill Twilight Keeper Manya for The Twilight Lexicon she fears a bit. She’s at the SE corner of came.", x = 29, y = 35, zone = "Silithus" },
			[24] = { str = "Go to #C_[41,41]# and kill Twilight Keeper Havanuth for The Twilight Lexicon he’s on the east side of camp, he has a nasty aoe.", x = 41, y = 41, zone = "Silithus" },
			[25] = { str = "Go all the way down south to the little camp at #C_[42,90]# and go up the hill behind it, you’ll find Deathclasp, in the middle of the path on the wall is a pouch, grab it when deathclasp is in the back for Noggle's Lost Satchel.", x = 42, y = 90, zone = "Silithus" },
			[26] = { str = "Head to the SW to #C_[16,87]# and kill Twilight Keeper Exeter for The Twilight Lexicon he’s at the SW corner of camp.", x = 16, y = 87, zone = "Silithus" },
			[27] = { str = "Go back to the cave at #C_[67,69]# and turn in The Twilight Lexicon accept A Terrible Purpose He also offers another quest for 10 twilight texts, this is more for cen circle rep later on.", x = 67, y = 69, zone = "Silithus" },
			[28] = { str = "Run up to #C_[81,18]# and turn in The Spirits of Southwind accept Hive in the Tower.", x = 81, y = 18, zone = "Silithus" },
			[29] = { str = "Go to the top of the tower at #C_[61,52]# Be careful 3 bugs spawn when you enter. Shift right click the pod because as soon as you open it some amushers spawn. Kill at least 1 and loot it for Hive in the Tower.", x = 61, y = 52, zone = "Silithus" },
			[30] = { str = "Go up to #C_[81,18]# and turn in Hive in the Tower accept Umber, Archivist.", x = 81, y = 18, zone = "Silithus" },
			...
			[39] = { str = "Fly to Auberdine and boat to Menethil then fly to #A_Ironforge#." },
...
------------56-57 Western Plaguelands
	[5657] = {
		...
		items = {
			...
			[7] = { str = "Go NE to around #C_[51,78]# and grind the ghouls here until you got enough for Clear The Way.", x = 51, y = 78, zone = "Western Plaguelands" },
			[8] = { str = "Go back to Chillwind Camp at #C_[42,84]# and turn in Clear The Way accept All Along the Watchtowers and The Scourge Cauldrons.", x = 42, y = 84, zone = "Western Plaguelands" },
			...
			[12] = { str = "Just in the town on the left at #C_[47,71]# is the 4th tower for All Along the Watchtowers, there are elites inside but you can stand out of LOS on the edge and mark the doors easily. 1st tower West of here at #C_[40,71]#. 2nd tower NE of here at #C_[42,66]#. 3rd tower NE of here at #C_[44,63]#. Just behind this tower.", x = 47, y = 71, zone = "Western Plaguelands" },
			[13] = { str = "Go NW to #C_[37,56]# to Felstone field, kill Cauldron Lord Bilemaw for his cauldron key. Then go right click the cauldron and turn in Target: Felstone Field accept Return to Chillwind Camp.", x = 37, y = 56, zone = "Western Plaguelands" },
			[14] = { str = "Theres 2 houses on the NE side of the field at #C_[38,54]#, enter the northern house and go upstairs. Accept Better Late Than Never pt.1.", x = 38, y = 54, zone = "Western Plaguelands" },
			...
			[16] = { str = "Run back to Chillwind Camp at #C_[42,84]# and turn in All Along the Watchtowers, accept Scholomance SKIP the other unless you get about 10-20 people.", x = 42, y = 84, zone = "Western Plaguelands" },
			...
			[18] = { str = "Near the flight path turn in Return to Chillwind Camp accept Target: Dalson's Tears." },
			[19] = { str = "Go up to #C_[46,52]# to Dalson’Tears, kill Cauldron Lord Malvinious for his cauldron key. Then go right click the cauldron and turn in Target: Dalson's Tears accept Return to Chillwind Camp.", x = 46, y = 52, zone = "Western Plaguelands" },
			...
			[22] = { str = "Go back to Chillwind Camp at #C_[42,84]# and turn in Return to Chillwind Camp accept Target: Writhing Haunt.", x = 42, y = 84, zone = "Western Plaguelands" },
			[23] = { str = "Use your #I_[Hearthstone]# to return to #A_Ironforge# then fly to #A_Stormwind#." },
			[24] = { str = "Go to the building at #C_[48,30]# on the 2nd floor of the cathedral area and turn in Better Late Than Never pt.2 accept Good Natured Emma.", x = 48, y = 30, zone = "Stormwind" },
			...
			[26] = { str = "Go into the keep at #C_[78,17]# and accept The First and the Last.", x = 78, y = 17, zone = "Stormwind" },
			[27] = { str = "Go to #C_[75,79]# and turn in The First and the Last accept Honor the Dead then turn it right back in, accept Flint Shadowmore.", x = 75, y = 79, zone = "Stormwind" },
			[28] = { str = "Fly back to WPL." },
			[29] = { str = "In front of the house turn in Flint Shadowmore accept The Eastern Plagues." },
			[30] = { str = "Go back to Felstone field to the house upstairs at #C_[38,54]# and turn in Good Luck Charm accept Two Halves Become One Go outside and look for a jabbering ghoul. You can’t miss him he carry’s a pitchfork. Keep clearing in front of the house until you find him. This will give you a good time to get those skeletal fragments.", x = 38, y = 54, zone = "Western Plaguelands" },

			[31] = { str = "Combine the halves and go back upstairs and turn in Two Halves Become One." },
			[32] = { str = "Go SE to #C_[53,65]# to Writhing Haunt, kill Cauldron Lord Razarch for his cauldron key. Then go right click the cauldron and turn in Target: Writhing Haunt accept Return to Chillwind Camp.", x = 53, y = 65, zone = "Western Plaguelands" },
			[33] = { str = "In the house at #C_[54,65]# accept The Wildlife Suffers Too pt.1 now go north of the haunt and kill the diseased wolves. Don’t go any farther east to find these just go North, maybe NW some.", x = 54, y = 65, zone = "Western Plaguelands" },
			[34] = { str = "Go back to #C_[54,65]# and turn in The Wildlife Suffers Too pt.1 accept The Wildlife Suffers Too pt.2.", x = 54, y = 65, zone = "Western Plaguelands" },
			[35] = { str = "Go back to Chillwind Camp at #C_[42,84]# anc turn in Return to Chillwind Camp accept Target: Gahrron's Withering.", x = 42, y = 84, zone = "Western Plaguelands" },
			[36] = { str = "Go just north of the Writhing Haunt between the mountains on the map at, #C_[52,56]# and kill diseased grizzleys on your way down to #C_[62,58]# for The Wildlife Suffers Too pt.2.", x = 52, y = 56, zone = "Western Plaguelands" },
			[37] = { str = "Go NE to #C_[62,58]# to Gahrron’s Withering, kill Cauldron Lord Soulwrath for his cauldron key. Then go right click the cauldron and turn in Target: Gahrron's Withering accept Return to Chillwind Camp.", x = 62, y = 58, zone = "Western Plaguelands" },
			[38] = { str = "Go back to #C_[54,65]# and turn in The Wildlife Suffers Too pt.2 accept Glyphed Oaken Branch.", x = 54, y = 65, zone = "Western Plaguelands" },
			[39] = { str = "If you haven’t finished Skeletal Fragments yet go to the crypt at #C_[54,79]# and kill the skeletons until you have 15 fragments.", x = 54, y = 79, zone = "Western Plaguelands" },
			[40] = { str = "Go back to Chillwind Camp at #C_[42,84]# and turn in Return to Chillwind Camp.", x = 42, y = 84, zone = "Western Plaguelands" },
...
-----------57-58 Eastern Plaguelands
	[5758] = {
		...
		items = {
			...
			[2] = { str = "Run up the west coast to #C_[67,4]# and accept the 3 quests Demon Dogs Blood Tinged Skies and Carrion Grubbage.", x = 67, y = 4, zone = "Eastern Plaguelands" },
			...
			[5] = { str = "Keep killing the dogs and bats and head over to the skeleton at #C_[28,74]# open it and grab the insignia for The Eastern Plagues then run up a bit further to the next skeleton at #C_[27,74]# and grab the insignia, it’s practically right in front of him and you will also get the blightcaller found complete message. Now go down near the road to #C_[28,79]# and loot the last insignia off the skeleton.", x = 28, y = 74, zone = "Eastern Plaguelands" },
			[6] = { str = "Focus on the dogs and bats while you head to Darrowshire at #C_[36,90]# in the broken down house. Turn in Sister Pamela accept Pamela's Doll then head towards the houses here, in any of the houses can be any of the 3 doll parts. They are random. Ghosts spawn when you get near the parts so be aware. Once you have all 3 parts combine them and go back to #C_[36,90]# and turn in Pamela's Doll accept Auntie Marlene and Uncle Carlin.", x = 36, y = 90, zone = "Eastern Plaguelands" },
			[7] = { str = "Look on your map at #C_[48,76]# This lines up with that middle ridge mountain. Don’t go past this spot east until you have your plaguehound runt kills for Demon Dogs and plaguebats for Blood Tinged Skies because there is none past that point.", x = 48, y = 76, zone = "Eastern Plaguelands" },
			...
			[9] = { str = "Kill Plaguehounds for Demon Dogs all around #C_[56,57]# this is north of the scar and south of blackwood lake. Don’t forget the grubs.", x = 56, y = 57, zone = "Eastern Plaguelands" },
			...
			[19] = { str = "Go to #C_[78,18]# in the keep and turn in The Blightcaller Cometh now I SKIP the next part but it’s a good quest to do at 60.", x = 78, y = 18, zone = "Eastern Plaguelands" },
...
-----------58-58 Western Plaguelands
	[5857] = {
		...
		items = {
			...
			[2] = { str = "Go NE to the house at #C_[49,78]# and go upstairs. Turn in Pamela's Doll accept A Strange Historian.", x = 49, y = 78, zone = "Western Plaguelands" },
			[3] = { str = "Just north of the house at #C_[49,76]# you’ll see an off color gravestone. Loot it and get the wedding ring for A Strange Historian.", x = 49, y = 76, zone = "Western Plaguelands" },
			[4] = { str = "Go in the west entrance to Andorhal at #C_[39,71]# and you should see the only full building, looks like an Inn at #C_[39,68]#. Go upstairs and turn in A Strange Historian accept The Annals of Darrowshire also accept A Matter of Time.", x = 39, y = 68, zone = "Western Plaguelands" },
			...
			[7] = { str = "Go back to the Inn at #C_[39,68]# and to the top floor, turn in A Matter of Time accept Counting Out Time also turn in The Annals of Darrowshire accept Brother Carlin.", x = 39, y = 68, zone = "Western Plaguelands" },
			[8] = { str = "Go outside and look around the busted houses for little metal lunchboxes for Counting Out Time." },
			[9] = { str = "Go back to the Inn at #C_[39,68]# and turn in Counting Out Time you can now repeat this quest for a dampener. This is used vs the 61 elite.", x = 39, y = 68, zone = "Western Plaguelands" },
		}
	},
...
-----------58-58 Eastern Plaguelands
	[5858] = {
		...
		items = {
			...
			[2] = { str = "Run out of here and into EPL up to the NW at #C_[7,43]# and turn in the 3 quests Demon Dogs Blood Tinged Skies and Carrion Grubbage accept Redemption then listen to him and turn it back in. Then accept Of Forgotten Memories.", x = 7, y = 43, zone = "Eastern Plaguelands" },
			[3] = { str = "Go to the Undercroft at #C_[28,86]# and run behind it. Touch the dirt pile to summon Mercutio and 3 guards. Easiest way to do this is to kite him away from his buddies or get a group. Loot his body for the hammer for Of Forgotten Memories.", x = 28, y = 86, zone = "Eastern Plaguelands" },
			...
			[5] = { str = "Go back to #C_[7,43]# and turn in Of Forgotten Memories accept Of Lost Honor.", x = 7, y = 43, zone = "Eastern Plaguelands" },
			...
			[8] = { str = "Go down to #C_[79,63]# and turn in Zaeldarr the Outcast.", x = 79, y = 63, zone = "Eastern Plaguelands" },
			[9] = { str = "Go down just North of Corin’s Crossing to #C_[53,65]# and grab the sword for Villains of Darrowshire It’s down in the scar. Don’t forget to do some of Defenders of Darrowshire at Corin’s Just get what you can.", x = 53, y = 65, zone = "Eastern Plaguelands" },
			[10] = { str = "Go north to Blackwood Lake at #C_[51,49]# and grab the skull under the water for Villains of Darrowshire.", x = 51, y = 49, zone = "Eastern Plaguelands" },

			[11] = { str = "Go NE to around #C_[65,41]# and kill the zombies for part of Defenders of Darrowshire there are quite a lot here you could probably finish.", x = 65, y = 41, zone = "Eastern Plaguelands" },
			[12] = { str = "Go to the lake at #C_[71,33]# and grab the flag next to the cage, it’s hard to see and is laying flat for Of Lost Honor.", x = 71, y = 33, zone = "Eastern Plaguelands" },
			[13] = { str = "Go NW to the tower at #C_[56,24]# and turn in Troubled Spirits of Kel'Theril SKIP the next part.", x = 56, y = 24, zone = "Eastern Plaguelands" },
			[14] = { str = "Run West to #C_[45,34]# and loot the termite mounds here for A Plague Upon Thee pt.1 until you get 100 termites, also kill ghouls to finish up Defenders of Darrowshire.", x = 45, y = 34, zone = "Eastern Plaguelands" },
...
------------58-59 Western Plaguelands
	[5859] = {
		...
		items = {
			...
			[2] = { str = "Run up to #C_[51,28]# and accept 'Unfinished Business pt.1'.", x = 52, y = 30, zone = "Western Plaguelands" },
			[3] = { str = "Start heading back SW around #C_[47,32]# and clear your way into the mill. Right click the box and place the termintes, then click the barrel and turn in 'A Plague Upon Thee pt.2' accept 'A Plague Upon Thee pt.3'.", x = 47, y = 32, zone = "Western Plaguelands" },
			[4] = { str = "Go just south of #C_[49,42]# and kill 2 knights and mages for 'Unfinished Business pt.1' then #C_[51,43]# for the hunters and medics.", x = 49, y = 42, zone = "Western Plaguelands" },
			[5] = { str = "Go to #C_[51,28]# and turn in 'Unfinished Business pt.1' accept 'Unfinished Business pt.2'.", x = 51, y = 28, zone = "Western Plaguelands" },
			[6] = { str = "Go to #C_[57,36]# and kill Huntsman Radly for 'Unfinished Business pt.2' then north to the tower at #C_[55,23]# and kill Cavalier Durgen at the top.", x = 57, y = 36, zone = "Western Plaguelands" },
			[7] = { str = "Go straight out of the tower over the mountains to #C_[51,28]# and turn in 'Unfinished Business pt.2' doing the 3rd part 'Unfinished Business pt.3' is optional. Some classes can do it easier than others. You have to run north to hearthglen and run up into the big tower in the center of town at #C_[45,18]# and look over the edge until it says complete.", x = 45, y = 18, zone = "Western Plaguelands" },
			[8] = { str = "Run back straight south over the mountains to #C_[51,28]# and turn in 'Unfinished Business pt.3'.", x = 51, y = 28, zone = "Western Plaguelands" },
			[9] = { str = "Run into EPL and up to #C_[7,43]# and turn in #Q_'Of Lost Honor'# accept 'Of Love and Family pt.1'.", x = 7, y = 43, zone = "Eastern Plaguelands" },
			[10] = { str = "Go back to WPL and run/swim to the island Scholo is on at #C_[65,75]# and turn in 'Of Love and Family pt.1' SKIP the rest until you do strat.", x = 65, y = 75, zone = "Western Plaguelands" },

			[11] = { str = "Go back to Chillwind Camp at #C_[43,84]# and turn in 'A Plague Upon Thee pt.3'.", x = 43, y = 84, zone = "Western Plaguelands" },
...
------------59-60 Winterspring
	[5960] = {
		...
		items = {
			...
			[7] = { str = "Run to Starfall Village at #C_[52,30]# and accept 'Enraged Wildkin pt.1'.", x = 52, y = 30, zone = "Winterspring" },
			[8] = { str = "Turn in #Q_'Chillwind Horns'# SKIP the other unless you wanna go there." },
			[9] = { str = "Go south to #C_[59,59]# and touch the crate and turn in 'Enraged Wildkin pt.1' accept 'Enraged Wildkin pt.2'.", x = 59, y = 59, zone = "Winterspring" },
			[10] = { str = "Go back to the road at #C_[61,60]# and touch the wagon, turn in 'Enraged Wildkin pt.2' accept 'Enraged Wildkin pt.3' grab the box in the snow.", x = 61, y = 60, zone = "Winterspring" },
			...
			[18] = { str = "Go up to Starfall Village at #C_[52,30]# and turn in 'Enraged Wildkin pt.3'.", x = 52, y = 30, zone = "Winterspring" },
			...
			[30] = { str = "Once you’re 6600 to 60 go to #A_Ironforge# and turn in An Earnest Proposition." },
