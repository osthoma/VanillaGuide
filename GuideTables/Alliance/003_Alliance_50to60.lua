...
-----------50-51 Searing Gorge
	[5051] = {
		...
		items = {
			...
			[4] = { str = "Clear all the mobs and at the bottom of the little pit, accept Suntara Stones pt.1 escort him to #C_[74,19]# and when he dies grab the note which starts Suntara Stones pt.2.", x = 74, y = 19, zone = "Searing Gorge" },
			...
			[8] = { str = "Run up to Thorium Point at #C_[38,26]#.", x = 38, y = 26, zone = "Searing Gorge" },
			...
			[13] = { str = "Stop at #C_[71,16]# and turn in Suntara Stones pt.2 accept Dwarven Justice.", x = 71, y = 16, zone = "Searing Gorge" },
			...
			[19] = { str = "Fly to Thelsamar and run to #C_[18,83]#.", x = 18, y = 83, zone = "Searing Gorge" },
			...
			[27] = { str = "Turn in Turn in The Flawless Flame accept Forging the Shaft when you’re near #A_Thunder Bluff# again." },
			...
			[50] = { str = "Go down to #C_[38,38]# and turn in The Flame’s Casing accept The Torch of Retribution pt.1 then turn it back in accept The Torch of Retribution pt.2 then grab the torch in front of him and complete it and accept Squire Maltrake and turn that back in and accept Set Them Ablaze!", x = 38, y = 38, zone = "Searing Gorge" },
			...
			[53] = { str = "Die on purpose so you end up at TP and go down to #C_[29,38]# and turn in Set Them Ablaze! watch the cutscene as he turns into a dragon.", x = 29, y = 38, zone = "Searing Gorge" },
			...
			[57] = { str = "Once you kill him hearth to #A_Ironforge# then either get a portal to Darnassus or fly to Menethil then boat to Auberdine and fly to Darn." },
			[58] = { str = "Go to the top of the temple of the moon at #C_[38,80]# and turn in Prayer to Elune pt.2.", x = 38, y = 80, zone = "darnassus" },
			...
			[65] = { str = "Go to the cave at #C_[31,66]# and touch the scroll in the back of the cave which turns in Cortello's Riddle pt.2 accept Cortello's Riddle pt.3.", x = 31, y = 66, zone = "Duskwallow Marsh" },
...
-----------51-52 Un’Goro Crater
	[5152] = {
		...
		items = {
			...
			[5] = { str = "Grind to #C_[62,68]# and click on the wrecked raft, accept It's A Secret to Everybody pt.1 then take 2 steps under the water, turn it in and accept It's A Secret to Everybody pt.2.", x = 62, y = 68, zone = "Un’Goro Crater" },
			...
			[28] = { str = "Stop at #C_[68,36]# and grab the crate of foodstuff for Expedition Salvation.", x = 68, y = 36, zone = "Un’Goro Crater" },
			...
			[34] = { str = "Run west to #C_[55,73]# there is a diametradon camp of about 5-6 Kill these if you need scales still for Shizzle's Flyer or Roll the Bones.", x = 55, y = 73, zone = "Un’Goro Crater" },
			[35] = { str = "Go west to #C_[50,77]# into the slithering scar, at the fork go left into the big room, stand in the middle, use the scraping vial for Alien Ecology.", x = 50, y = 77, zone = "Un’Goro Crater" },
			...
			[37] = { str = "Run to the camp at #C_[38,65]# and grab the research equipment for Expedition Salvation.", x = 38, y = 65, zone = "Un’Goro Crater" },
			[38] = { str = "Kill frenzied pterrodaxes all around #C_[35,38]# (they’re everywhere) in the NW part of the map for Beware of Pterrordax plus there are many diametradons here for Shizzle's Flyer or Roll the Bones.", x = 35, y = 38, zone = "Un’Goro Crater" },
			...
			[52] = { str = "Run to #C_[29,22]# and follow the path into Slithus to #C_[50,34]# grab the flight path and fly to gadget.", x = 29, y = 22, zone = "Un’Goro Crater" },
			...
			[54] = { str = "Hearth to Darnassus and talk to your #N_Class Trainer# to learn new spells and abilities." },
...
------------56-57 Western Plaguelands
	[5657] = {
		...
		items = {
			...
			[23] = { str = "Hearth to #A_Ironforge# then fly to #A_Stormwind#." },
...
-----------57-58 Eastern Plaguelands
	[5758] = {
		...
		items = {
			...
			[18] = { str = "If you’re within 6600 XP to level then Hearth to #A_Ironforge# and fly to #A_Stormwind#, if not then grind until you’re within range." },
