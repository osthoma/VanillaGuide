...
-----------6-12 Dun Morogh
	[0612] = {
		...
		items = {
			...
			[45] = { str = "Reach #A_Goldshire# and enter the Inn at #C_[42,65]#.", x = 42, y = 65, zone = "Elwynn Forest" },
			...
			[57] = { str = "Go back to #A_Goldshire#, turn in #Q_'Gold Dust Exchange'#, accept #Q_'A Fishy Peril'# and turn it in. Turn in #Q_'The Fargodeep Mine'#, skip the followup. Turn in #Q_'Kobold Candles'# and #Q_'Note to William'#, accept #Q_'Shipment to Stormwind'#. Run to #A_Stormwind# and turn it in." },
