...
-----------6-12 Dun Morogh
    ...
    [0612] = {
        ...
        items = {
            ...
            [34] = { str = "33) Go to 24,50 and enter the cave kill 5 headhunters", x = 24, y = 50, zone = "Dun Morogh" },
            ...
            [63] = { str = "62) Go east to 86,49 and turn in “Shimmer Stout”, accept the followup, then follow the path into Loch Modan ", x = 86, y = 49, zone = "Dun Morogh" },
            ...
            [69] = { str = "68) Kill mobs from 26,43 and north for Rat Catching, then turn it in at Thelsamar at Mountaineer Kadrell, accept “Mountaineer Stormpike's Task” ", x = 26, y = 43, zone = "Loch Modan" },
            [70] = { str = "69) Go back to 22,73 and turn in In Defense of the King's Lands and The Trogg Threat ", x = 22, y = 73, zone = "Loch Modan" },
            [71] = { str = "70) Go north to the tower at 24,18 and turn in “Stormpike's Delivery” and “Mountaineer Stormpike's Task” ", x = 24, y = 18, zone = "Loch Modan" },
