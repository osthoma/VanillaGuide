...
-----------6-12 Dun Morogh
	[0612] = {
		...
		items = {
			...
			[52] = { str = "Go east to the Maclure Vinyard at #COORDS[43,85]# and turn in 'Lost Necklace' accept 'Pie For Billy' then turn around and kill boars until it’s finished.", x = 43, y = 85, zone = "Elwynn Forest" },
			...
			[62] = { str = "Go in the pit below and kill the troggs here and in the cave for both quests then turn them back in at #COORDS[68,55]#." },
