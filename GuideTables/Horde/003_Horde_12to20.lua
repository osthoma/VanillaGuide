...
-----------12-15 Barrens
	[1215] = {
		...
		items = {
			...
			[4] = { str = "Run to #A_Crossroads# at #C_[52,30]# #HUNTER (If you're a hunter do step 4)#.", x = 52, y = 30, zone = "The Barrens" },
			[5] = { str = "#HUNTER04) While on my way to #A_Crossroads#, I  abandon my crab and tame a Savannah Huntress cat, for my new pet.#." },
			[6] = { str = "Once at #A_Crossroads# at #C_[52,30]# turn in #Q_'Crossroads Conscription'# Then accept all quests in #A_Crossroads# (which includes: #Q_'Meats to Orgrimmar'# #Q_'Plainstrider Menace'#  #Q_'The Forgotten Pools'# #Q_'Raptor Thieves'# #Q_'Wharfmaster Dizzywig'# #Q_'Fungal Spores'# #Q_'Disrupt the Attacks'# #Q_'Supplies for the Crossroads'# and #Q_'Harpy Raiders'# on top of the watch tower). Turn in #Q_'Meats to Orgrimmar'# i SKIP '#N_Ride to Orgrimmar'#.", x = 52, y = 30, zone = "The Barrens" },
			[7] = { str = "Make #A_Crossroads# your home." },
			...
			[14] = { str = "Go to #A_Ratchet#, get the Flight Path there #C_[63,37]# and accept #Q_'Raptor Horns'# #Q_'Samophlange'# #Q_'Southsea Freebooters'#  #Q_'The Guns of Northwatch'#. Turn in #Q_'Chen's Empty Keg'# if you have it. accept the next part to it, and focus on doing this quest while throughout the Barrens.", x = 63, y = 37, zone = "The Barrens" },
			...
			[26] = { str = "Run west from #A_Crossroads#, go to the guy in the hut. at #C_[45,28]#.", x = 45, y = 28, zone = "The Barrens" },
...
-----------15-16 Stonetalon Mountains
	[1516] = {
		...
		items = {
			...
			[2] = { str = "Accept #Q_'Goblin Invaders'# (you should first accept #Q_'Spirits of Stonetalon'# from Zor Lonetree in #A_Orgrimmar#, but this is a lvl13 quest. Grab it if you're in #A_Orgrimmar# at that level) and #Q_'Avenge My Village'# (at 35.27 in the Barrens).", x = 35, y = 27, zone = "The Barrens" },
...
-----------16-20 Barrens PART1
	[1618] = {
		...
		items = {
			...
			[24] = { str = "Then grind your way south to #A_Ratchet# #C_[63,37]#.", x = 63, y = 37, zone = "The Barrens" },
			...
			[28] = { str = "Then run to #A_Crossroads# #C_[52,30]#.", x = 52, y = 30, zone = "The Barrens" },
			...
			[30] = { str = "Go west of #A_Crossroads# #C_[45,28]#, to turn in: #Q_'Centaur Bracers'# and #Q_'Verog the Dervish'#. I SKIP '#N_Hezrul Bloodmark'#.", x = 45, y = 28, zone = "The Barrens" },
...
-----------16-20 Barrens PART2
	[1820] = {
		...
		items = {
			...
			[16] = { str = "Once you are at least 5 bars away from 20, run to #A_Crossroads#." },
			...
			[27] = { str = "Turn in both quests at #A_Ratchet#, then." },
