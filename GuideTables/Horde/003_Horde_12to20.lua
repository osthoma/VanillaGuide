...
-----------12-15 Barrens
	[1215] = {
		...
		items = {
			...
			[14] = { str = "Go to #A_Ratchet# (#A_The Barrens#), get the Flight Path there #C_[63,37]# and accept #Q_'Raptor Horns'# #Q_'Samophlange'# #Q_'Southsea Freebooters'#  #Q_'The Guns of Northwatch'#. Turn in #Q_'Chen's Empty Keg'# if you have it. accept the next part to it, and focus on doing this quest while throughout the Barrens.", x = 63, y = 37, zone = "The Barrens" },
...
-----------16-20 Barrens PART1
	[1618] = {
		...
		items = {
			...
			[15] = { str = "Go up to the tower in middle of town to get flight path, but DON'T fly back to #A_Crossroads# (#A_The Barrens#)." },
