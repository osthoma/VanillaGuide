...
-----------12-15 Barrens
	...
	[1215] = {
		...
		items = {
			[1] = { str = "12-15 Barrens" },
			[2] = { str = "01) Turn in #TURNIN\"Conscript of the Horde\"# (#COORDS[62,19]# in the Barrens) accept #ACCEPT\"Crossroads Conscription\"# ", x = 62, y = 19, zone = "The Barrens" },
			[3] = { str = "02) Then turn in #TURNIN\"Ak'Zeloth\"# #COORDS[62,20]# I SKIP \"#NPCThe Demon Seed\"# ", x = 62, y = 20, zone = "The Barrens" },
			[4] = { str = "03) Run to XRs (Crossroads) at #COORDS[52,30]# #HUNTER (If you're a hunter do step 4)#", x = 52, y = 30, zone = "The Barrens" },
			[5] = { str = "#HUNTER04) While on my way to XRs, I  abandon my crab and tame a Savannah Huntress cat, for my new pet.#" },
			[6] = { str = "05) Once at XRs at #COORDS[52,30]# turn in #TURNIN\"Crossroads Conscription\"# Then accept all quests in XRs (which includes: #ACCEPT\"Meats to Orgrimmar\"# #ACCEPT\"Plainstrider Menace\"#   #ACCEPT\"The Forgotten Pools\"# #ACCEPT\"Raptor Thieves\"# #ACCEPT\"Wharfmaster Dizzywig\"# #ACCEPT\"Fungal Spores\"# #ACCEPT\"Disrupt the Attacks\"# #ACCEPT\"Supplies for the Crossroads\"# and #ACCEPT\"Harpy Raiders\"# on top of the watch tower).  Turn in #TURNIN\"Meats to Orgrimmar\"# i SKIP \"#NPCRide to Orgrimmar\"# ", x = 52, y = 30, zone = "The Barrens" },
			[7] = { str = "06) Make XRs your home." },
			[8] = { str = "07) Get FP (Flight Path)" },
			[9] = { str = "08) Then go do:  #DOQUEST\"Disrupt the Attacks\"# along with #DOQUEST\"Plainstrider Menace\"# and #DOQUEST\"Raptor Thieves\"# (all around #COORDS[54,26]#).  NOTE: If you find #ACCEPT\"Chen's Empty Keg\"# accept it.", x = 54, y = 26, zone = "The Barrens" },
			[10] = { str = "09) Once #DOQUEST\"Disrupt the Attacks\"# is completed go turn it in at #COORDS[52,30]# and accept #ACCEPT\"Supplies for the Crossroads\" ", x = 52, y = 30, zone = "The Barrens" },
			[11] = { str = "10) Go do #DOQUEST\"Supplies for the Crossroads\"# at #COORDS[56,26]#, then run back to Thork and #ACCEPT\"The Disruption Ends\"#, you'll be going back up to the razormanes one more time.", x = 56, y = 26, zone = "The Barrens" },
			...
			[14] = { str = "13) Go to Ratchet, get the Flight Path there #COORDS[63,37]# and accept #ACCEPT\"Raptor Horns\"# #ACCEPT\"Samophlange\"# #ACCEPT\"Southsea Freebooters\"#  #ACCEPT\"The Guns of Northwatch\"# .  Turn in #TURNIN\"Chen's Empty Keg\"# if you have it ... accept the next part to it, and focus on doing this quest while throughout the Barrens.", x = 63, y = 37, zone = "The Barrens" },
			...
			[18] = { str = "17) Once those are done, turn them in at #COORDS[63,36]#, accept new ones, then go do:", x = 63, y = 36, zone = "The Barrens" },
			...
			[20] = { str = "19) Run back, to Gazlowe #COORDS[63,36]#, turn in #TURNIN\"The Missing Shipment\"# part2 accept #ACCEPT\"Stolen Booty\"# ", x = 63, y = 36, zone = "The Barrens" },
			[21] = { str = "20) Then go do #DOQUEST\"Stolen Booty\"# (south of Ratchet again) (Telescopic Lens=64.49, and Shipment of Boots=#COORDS[63,50]#)", x = 63, y = 50, zone = "The Barrens" },
			...
			[26] = { str = "25) Run west from XRs, go to the guy in the hut... at #COORDS[45,28]#", x = 45, y = 28, zone = "The Barrens" },
			...
			[30] = { str = "29) Once #DOQUEST\"Kolkar Leaders\"# is done.. (Barak is at #COORDS[43,24]#) ", x = 43, y = 24, zone = "The Barrens" },
			[31] = { str = "30) Go do: #DOQUEST\"Harpy Raiders\"# at #COORDS[38,17]#", x = 38, y = 17, zone = "The Barrens" },
...
-----------15-16 Stonetalon Mountains
	...
	[1516] = {
		...
		items = {
			...
			[4] = { str = "03) Then do: #DOQUEST\"Kill Grundig Darkcloud\"# (he is at #COORDS[73,86]#)", x = 73, y = 86, zone = "Stonetalon Mountains" },
...
-----------16-20 Barrens PART1
	...
	[1618] = {
		...
		items = {
			...
			[2] = { str = "01) Grind your way back to the guy in the hut at #COORDS[45,28]#", x = 45, y = 28, zone = "The Barrens" },
			...
			[5] = { str = "04) Run to XRs (Cross Roads at #COORDS[52,30]#)", x = 52, y = 30, zone = "The Barrens" },
			...
			[8] = { str = "07) Grind your way down south (to #COORDS[49,50]#) and do #DOQUEST\"Lost in Battle\"# (Manrik's Wife)  She's laying dead by the hut, west of the bridge.", x = 49, y = 50, zone = "The Barrens" },
			[9] = { str = "08) Go down to Camp Taurajo (CT) accept #ACCEPT\"Tribes at War\"# (gnoll in the cage at #COORDS[44,59]#), and get FP there. ", x = 44, y = 59, zone = "The Barrens" },
			[10] = { str = "09) Then do #DOQUEST\"Apothecary Zamah\"# Which has you run all the way to Thunder Bluff (TB) (in Mulgore at #COORDS[39,27]#).", x = 39, y = 27, zone = "Mulgore" },
			[11] = { str = "10) Once at TB, go to #NPCweapon master# #COORDS[40,62]#, #HUNTERget Guns and Staff skills. (I do this as a Hunter),# get what weapon skills you need for your class)" },
			[12] = { str = "11) Get new spells/abilities." },
			[13] = { str = "12) Turn in #TURNIN\"Apothecary Zamah\"# the cave below the spirit rise at #COORDS[29,29]#.", x = 29, y = 29, zone = "The Barrens" },
			...
			[18] = { str = "17) Then go north west of XRs and do #DOQUEST\"Prowlers of the Barrens\"# #COORDS[37,20]#", x = 37, y = 20, zone = "The Barrens" },
			[19] = { str = "18) Then #DOQUEST\"Harpy Lieutenants\"# #COORDS[38,14]#", x = 38, y = 14, zone = "The Barrens" },
			[20] = { str = "19) Then grind your way east and do #DOQUEST\"Samophlange\"# #COORDS[52,11]# complete the whole chain, which in the end has you kill the goblin for the key. " },
			[21] = { str = "20) Then go east to Sludge Fen and do #DOQUEST\"Ignition\"# #COORDS[56,8]#", x = 56, y = 8, zone = "The Barrens" },
			[22] = { str = "21) Then do #DOQUEST\"The Escape\"# (#VIDEOSee video on how I do Ignition and Escape#)" },
			[23] = { str = "22) Then go north-east and do #DOQUEST\"Miner's Fortune\"# #COORDS[61,5]#", x = 61, y = 5, zone = "The Barrens" },
			[24] = { str = "23) Then grind your way south to Ratchet #COORDS[63,37]#...", x = 63, y = 37, zone = "The Barrens" },
			...
			[27] = { str = "26) Then go west of ratchet and do #DOQUEST\"The Stagnant Oasis\"# and #DOQUEST\"Verog the Dervish\"# at #COORDS[54,43]#", x = 54, y = 43, zone = "The Barrens" },
			[28] = { str = "27) Then run to XRs #COORDS[52,30]#..", x = 52, y = 30, zone = "The Barrens" },
			...
			[30] = { str = "29) Go west of XRs #COORDS[45,28]#, to turn in: #TURNIN\"Centaur Bracers\"# and #TURNIN\"Verog the Dervish\"# ... I SKIP \"#NPCHezrul Bloodmark\"# ", x = 45, y = 28, zone = "The Barrens" },
			[31] = { str = "30) Then grind your way north and do: #DOQUEST\"Serena Bloodfeather\"# at #COORDS[38,11]#", x = 38, y = 11, zone = "The Barrens" },
			[32] = { str = "31) Then go east (grind mobs along the way) and do #DOQUEST\"Echeyakee\"# (coords are at #COORDS[55,17]#) ", x = 55, y = 17, zone = "The Barrens" },
...
-----------16-20 Barrens PART2
	...
	[1820] = {
		...
		items = {
			...
			[3] = { str = "02) #DOQUEST\"Altered Beings\"#   #COORDS[55,42]#", x = 55, y = 42, zone = "The Barrens" },
			[4] = { str = "03) #DOQUEST\"Raptor Horns\"# along with #DOQUEST\"Stolen Silver\"#   at #COORDS[57,54]#  ", x = 57, y = 54, zone = "The Barrens" },
			[5] = { str = "04) #DOQUEST\"The Angry Scytheclaws\"#   #COORDS[51,46]#", x = 51, y = 46, zone = "The Barrens" },
			[6] = { str = "05) #DOQUEST\"Tribes at War\"# along with #DOQUEST\"Consumed by Hatred\"#   at #COORDS[51,54]#", x = 51, y = 54, zone = "The Barrens" },
			[7] = { str = "06) Then grind your way to Camp Taurajo #COORDS[45,58]#", x = 45, y = 58, zone = "The Barrens" },
			...
			[14] = { str = "13) Now comes the fun part:  #NPCWailing Caverns# Instance! at #COORDS[46,36]#.  You will need a full group to do this.  OPTIONAL: GRIND all the way to level 20! (which is what I do, but it's not recommended).  I grind away at beasts and brisstlebacks just north of CT.  " },
			[15] = { str = "14) Keep an eye out for the mobs named #NPCLakota'mani# (a big grey kodo around #COORDS[45,53]#) and #NPCOwatanka#. They drops #NPCHoof of Lakota'mani# which starts #DOQUEST\"Lakota'mani\"# and #NPCOwatanka's Tailspike# which starts #DOQUEST\"Owatanka\"#.  Turn these in at CT when you get the chance." },
			...
			[24] = { str = "23) Then go do: #DOQUEST\"The Guns of Northwatch\"# at #COORDS[60,55]#  (#VIDEOSee complete video on this quest along with the escort quest#)", x = 60, y = 55, zone = "The Barrens" },
