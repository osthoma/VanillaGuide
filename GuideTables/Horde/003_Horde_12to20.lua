...
-----------16-20 Barrens PART1
	[1618] = {
		...
		items = {
			...
			[9] = { str = "Go down to Camp Taurajo (CT) accept #Q_'Tribes at War'# (gnoll in the cage at #C_[44,59]#), and get flight path there.", x = 44, y = 59, zone = "The Barrens" },
			...
			[15] = { str = "Go up to the tower in middle of town to get flight path, but DON'T fly back to XRs." },
