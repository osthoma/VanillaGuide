...
-----------12-15 Barrens
	[1215] = {
		...
		items = {
			[1] = { str = "12-15 Barrens" },
			[2] = { str = "Turn in #Q_'Conscript of the Horde'# (#C_[62,19]# in the Barrens) accept #Q_'Crossroads Conscription'#.", x = 62, y = 19, zone = "The Barrens" },
			[3] = { str = "Then turn in #Q_'Ak'Zeloth'# #C_[62,20]# I SKIP '#N_The Demon Seed'#.", x = 62, y = 20, zone = "The Barrens" },
			[4] = { str = "Run to XRs (Crossroads) at #C_[52,30]# #HUNTER (If you're a hunter do step 4)#.", x = 52, y = 30, zone = "The Barrens" },
			[5] = { str = "#HUNTER04) While on my way to XRs, I  abandon my crab and tame a Savannah Huntress cat, for my new pet.#." },
			[6] = { str = "Once at XRs at #C_[52,30]# turn in #Q_'Crossroads Conscription'# Then accept all quests in XRs (which includes: #Q_'Meats to Orgrimmar'# #Q_'Plainstrider Menace'#  #Q_'The Forgotten Pools'# #Q_'Raptor Thieves'# #Q_'Wharfmaster Dizzywig'# #Q_'Fungal Spores'# #Q_'Disrupt the Attacks'# #Q_'Supplies for the Crossroads'# and #Q_'Harpy Raiders'# on top of the watch tower). Turn in #Q_'Meats to Orgrimmar'# i SKIP '#N_Ride to Orgrimmar'#.", x = 52, y = 30, zone = "The Barrens" },
			...
			[11] = { str = "Go do #Q_'Supplies for the Crossroads'# at #C_[56,26]#, then run back to Thork and #Q_'The Disruption Ends'#, you'll be going back up to the razormanes one more time.", x = 56, y = 26, zone = "The Barrens" },
			[12] = { str = "If you find #Q_'Chen's Empty Keg'# accept it." },
			[13] = { str = "Once #Q_'Plainstrider Menace'# & #Q_'The Disruption Ends'# and are complete." },
			[14] = { str = "Go to Ratchet, get the Flight Path there #C_[63,37]# and accept #Q_'Raptor Horns'# #Q_'Samophlange'# #Q_'Southsea Freebooters'#  #Q_'The Guns of Northwatch'#. Turn in #Q_'Chen's Empty Keg'# if you have it. accept the next part to it, and focus on doing this quest while throughout the Barrens.", x = 63, y = 37, zone = "The Barrens" },
			[15] = { str = "Grab the quest #Q_'WANTED: Baron Longshore'# (the wanted sign by the bank)." },
			[16] = { str = "Turn in #Q_'Wharfmaster Dizzywig'# (goblin on the docks) accept #Q_'Miner's Fortune'#." },
			[17] = { str = "Then go do #Q_'Southsea Freebooters'# along with #Q_'WANTED: Baron Longshore'# (along the shore just south of Ratchet)." },
			...
			[22] = { str = "Once #Q_'Stolen Booty'#  is completed hearth to XRs. (don't turn it in yet)." },
			...
			[26] = { str = "Run west from XRs, go to the guy in the hut. at #C_[45,28]#.", x = 45, y = 28, zone = "The Barrens" },
			[27] = { str = "Accept: #Q_'Kolkar Leaders'# and #Q_'Centaur Bracers'#." },
			[28] = { str = "Then go start doing:" },
			[29] = { str = "#Q_'Kolkar Leaders'# #Q_'Centaur Bracers'# #Q_'Raptor Thieves'# #Q_'The Zhevra'# #Q_'Fungal Spores'#  and #Q_'The Forgotten Pools'# (all of these are done just slightly north of where you are)." },
			[30] = { str = "Once #Q_'Kolkar Leaders'# is done. (Barak is at #C_[43,24]#).", x = 43, y = 24, zone = "The Barrens" },

			[31] = { str = "Go do: #Q_'Harpy Raiders'# at #C_[38,17]#.", x = 38, y = 17, zone = "The Barrens" },
			[32] = { str = "Once #Q_'Harpy Raiders'# is done, grind your way down into Stonetalon Mountains (at 35.27 in the Barrens).", x = 35, y = 27, zone = "The Barrens" },
		}
	},
...
-----------15-16 Stonetalon Mountains
	[1516] = {
		...
		items = {
			...
			[2] = { str = "Accept #Q_'Goblin Invaders'# (you should first accept #Q_'Spirits of Stonetalon'# from Zor Lonetree in Orgrimmar, but this is a lvl13 quest. Grab it if you're in Orgrimmar at that level) and #Q_'Avenge My Village'# (at 35.27 in the Barrens).", x = 35, y = 27, zone = "The Barrens" },
			[3] = { str = "Go do: #Q_'Avenge My Village'# then turn it in." },
			[4] = { str = "Then do: #Q_'Kill Grundig Darkcloud'# (he is at #C_[73,86]#).", x = 73, y = 86, zone = "Stonetalon Mountains" },
			[5] = { str = "NOTE: I usually skip the escort quest there (#Q_'Protect Kaya'# 73.85 in the hut), This quest can be a little tough, kill the Sorcerer first that pops out during the one battle you have to fight. If it's too hard for you, you can skip it.", x = 73, y = 85, zone = "Stonetalon Mountains" },
			[6] = { str = "Turn in #Q_'Kill Grundig Darkcloud'# and #Q_'Protect Kaya'# if you did it (at 35.28 in the Barrens). accept #Q_'Kaya's Alive'#.", x = 35, y = 28, zone = "The Barrens" },
...
-----------16-20 Barrens PART1
	[1618] = {
		...
		items = {
			...
			[4] = { str = "Make sure you finish up #Q_'Raptor Thieves'# #Q_'The Zhevra'# #Q_'Fungal Spores'# and #Q_'The Forgotten Pools'# before returning to the XRs." },
			[5] = { str = "Run to XRs (Cross Roads at #C_[52,30]#).", x = 52, y = 30, zone = "The Barrens" },
			[6] = { str = "Turn in ALL quests, grab ALL new ones." },
			[7] = { str = "then do #Q_'Apothecary Zamah'# Which has you run all the way to Thunder Bluff (TB) at the spirt rise cave. Do these along the way:" },
			...
			[9] = { str = "Go down to Camp Taurajo (CT) accept #Q_'Tribes at War'# (gnoll in the cage at #C_[44,59]#), and get FP there.", x = 44, y = 59, zone = "The Barrens" },
			[10] = { str = "Then do #Q_'Apothecary Zamah'# Which has you run all the way to Thunder Bluff (TB) (in Mulgore at #C_[39,27]#).", x = 39, y = 27, zone = "Mulgore" },

			[11] = { str = "Once at TB, go to #N_weapon master# #C_[40,62]#, #HUNTERget Guns and Staff skills. (I do this as a Hunter),# get what weapon skills you need for your class)." },
			...
			[18] = { str = "Then go north west of XRs and do #Q_'Prowlers of the Barrens'# #C_[37,20]#.", x = 37, y = 20, zone = "The Barrens" },
			[19] = { str = "Then #Q_'Harpy Lieutenants'# #C_[38,14]#.", x = 38, y = 14, zone = "The Barrens" },
			[20] = { str = "Then grind your way east and do #Q_'Samophlange'# #C_[52,11]# complete the whole chain, which in the end has you kill the goblin for the key." },

			[21] = { str = "Then go east to Sludge Fen and do #Q_'Ignition'# #C_[56,8]#.", x = 56, y = 8, zone = "The Barrens" },
			[22] = { str = "Then do #Q_'The Escape'# (#VIDEOSee video on how I do Ignition and Escape#)." },
			[23] = { str = "Then go north-east and do #Q_'Miner's Fortune'# #C_[61,5]#.", x = 61, y = 5, zone = "The Barrens" },
			[24] = { str = "Then grind your way south to Ratchet #C_[63,37]#.", x = 63, y = 37, zone = "The Barrens" },
			...
			[28] = { str = "Then run to XRs #C_[52,30]#.", x = 52, y = 30, zone = "The Barrens" },
			...
			[30] = { str = "Go west of XRs #C_[45,28]#, to turn in: #Q_'Centaur Bracers'# and #Q_'Verog the Dervish'#. I SKIP '#N_Hezrul Bloodmark'#.", x = 45, y = 28, zone = "The Barrens" },
...
-----------16-20 Barrens PART2
	[1820] = {
		...
		items = {
			...
			[3] = { str = "#Q_'Altered Beings'#  #C_[55,42]#.", x = 55, y = 42, zone = "The Barrens" },
			...
			[7] = { str = "Then grind your way to Camp Taurajo #C_[45,58]#.", x = 45, y = 58, zone = "The Barrens" },
			...
			[14] = { str = "Now comes the fun part: #N_Wailing Caverns# Instance! at #C_[46,36]#. You will need a full group to do this. OPTIONAL: GRIND all the way to level 20! (which is what I do, but it's not recommended). I grind away at beasts and brisstlebacks just north of CT." },
			[15] = { str = "Keep an eye out for the mobs named #N_Lakota'mani# (a big grey kodo around #C_[45,53]#) and #N_Owatanka#. They drops #N_Hoof of Lakota'mani# which starts #Q_'Lakota'mani'# and #N_Owatanka's Tailspike# which starts #Q_'Owatanka'#. Turn these in at CT when you get the chance." },
