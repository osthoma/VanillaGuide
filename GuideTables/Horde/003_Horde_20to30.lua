...
-----------20-21 Stonetalon Mountains
	[2021] = {
		...
		items = {
			...
			[16] = { str = "Turn in #Q_'Goblin Invaders'# (at 35.27 in the Barrens). accept #Q_'Shredding Machines'#  (I SKIP '#N_The Elder Crone'# ).", x = 35, y = 27, zone = "The Barrens" },
			[17] = { str = "Use your #I_[Hearthstone]# to return to #A_Crossroads#." },
			[18] = { str = "Run north to Ashenvale (stopping along the way to turn in #Q_'Report to Kadrak'# at #C_[48,5]# but SKIP '#N_The Warsong Reports'#.", x = 48, y = 5, zone = "The Barrens" },
		}
	},
...
-----------21-21 Ashenvale
	[2121] = {
		...
		items = {
			...
			[9] = { str = "Use your #I_[Hearthstone]# to return to back to #A_Crossroads#, if hearth stone is still on a cooldown, fly there." },
		}
	},
...
-----------23-25 Stonetalon Mountains
	[2325] = {
		...
		items = {
			...
			[2] = { str = "Accept all quests at Sun Rock Retreat (which include: #Q_'Cenarius' Legacy'# #Q_'Cycle of Rebirth'# and #Q_'Harpies Threaten'# )." },
			...
			[8] = { str = "#Q_'Jin'Zil's Forest Magic'# (the mobs are around the path at 45.27, and the area at #C_[34,14]#).", x = 45, y = 27, zone = "Stonetalon Mountains" },
			[9] = { str = "Go back to Sun Rock Retreat and turn in #Q_'Cycle of Rebirth'#. accept #Q_'New Life'#." },
			...
			[17] = { str = "Use your #I_[Hearthstone]# to return to back to Sun Rock Retreat and turn in #Q_'Arachnophobia'# if you just did it." },
...
-----------25-25 Southern Barrens2
	[2525] = {
		...
		items = {
			...
			[10] = { str = "Head south down the path to the Great Lift (at 44.91 in the barrens) and turn in #Q_'Calling in the Reserves'#.", x = 44, y = 91, zone = "The Barrens" },

			[11] = { str = "Accept #Q_'Message to Freewind Post'#." },
			[12] = { str = "Run to Freewind Post. (#C_[45,50]# in Thousand Needles).", x = 45, y = 50, zone = "Thousand Needles" },
		}
	},
...
-----------25-26 Thousand Needles
	[2526] = {
		...
		items = {
			...
			[9] = { str = "#Q_'Alien Egg'# (this egg has 4 possible spawn points, either at around: 52.56 / 45.63 / 41.60 / 50.56, and there might be more, just check around those areas.).", x = 52, y = 56, zone = "Thousand Needles" },
			...
			[18] = { str = "Fly to Thunder Bluff and talk to your #N_Class Trainer# to learn new spells and abilities." },
...
-----------26-27 Ashenvale
	[2627] = {
		...
		items = {
			...
			[6] = { str = "#Q_'Sharptalon's Claw'# (Kill #N_Sharptalon# (patrols around #C_[74,70]#), then he drops the item that starts this quest) (hint: easy way to kill it (he's lvl 31 mob), is to bring his health to a 3rd left, then drag him into the guards at Splintertree Post, they will finish em).", x = 74, y = 70, zone = "Ashenvale" },
			...
			[12] = { str = "#Q_'The sacred Flame'# (first find a phial killing the dryads at 61.52, then fill it at the moonwell at #C_[60,72]#).", x = 60, y = 72, zone = "Ashenvale" },
			[13] = { str = "Use your #I_[Hearthstone]# to return to Splintertree Post to turn in #Q_'Stonetalon Standstill'# #Q_'The Befouled Element'# (accept #Q_'Je'neu of the Earthen Ring'# ) #Q_'Torek's Assault'# and all three of the 'Ashenvale Hunt' quests, then accept and complete #Q_'The Hunt Completed'#." },
			...
			[17] = { str = "Once they are both completed, go turn in #Q_'Between a Rock and a Thistlefur'# and #Q_'Troll Charm'# (back at the Zoram Strand), then Use your #I_[Hearthstone]# to return to back to Splintertree Post. Turn in #Q_'Freedom to Ruul'# (if you did it)." },
			...
			[21] = { str = "Run back to Splintertree Post (don't hearth). Turn in #Q_'Satyr Horns'#." },
...
-----------27-29 Thousand Needles
	[2729] = {
		...
		items = {
			...
			[10] = { str = "Use your #I_[Hearthstone]# to return to Thunder Bluff." },
			...
			[17] = { str = "Go to the Darkcloud Pinnacle (the entrance ramp is at #C_[31,36]#) and do the following quests: #Q_'Grimtotem Spying'# (the notes are up in the rises at 31.32, 33.39, and #C_[39,41]#).", x = 31, y = 36, zone = "Thousand Needles" },
			...
			[23] = { str = "Then do #Q_'Hypercapacitor Gizmo'# (Elite) (kill mobs around the cage, at 22.24, free him, #HUNTERuse immolation trap/fear# to kill it).", x = 22, y = 24, zone = "Thousand Needles" },
