...
-----------20-21 Stonetalon Mountains
	...
	[2021] = {
		...
		items = {
			...
			[2] = { str = "01) Run to Malaka'Jin at #COORDS[71,94]#", x = 71, y = 94, zone = "Stonetalon Mountains" },
			[3] = { str = "02) Accept #ACCEPT\"Blood Feeders\"# " },
			[4] = { str = "03) Turn in #TURNIN\"Letter to Jin'Zil\"# (#COORDS[74,97]# in the cave) ... accept #ACCEPT\"Jin'Zil's Forest Magic\"# ", x = 74, y = 97, zone = "Stonetalon Mountains" },
			[5] = { str = "04) Then go accept #ACCEPT\"Arachnophobia\"# (wanted poster is at #COORDS[59,75]#)", x = 59, y = 75, zone = "Stonetalon Mountains" },
			[6] = { str = "05) Go do: #DOQUEST\"Blood Feeders\"# along with #DOQUEST\"Deepmoss Spider Eggs\"# and #DOQUEST\"Arachnophobia\"# (around #COORDS[54,76]#) NOTE: you can skip Arachnophobia for now, you'll return here later...", x = 54, y = 76, zone = "Stonetalon Mountains" },
			[7] = { str = "06) Then turn in #TURNIN\"Ziz Fizziks\"# (the goblin in the hut at Windshear Crag, #COORDS[58,62]#) ... accept #ACCEPT\"Super Reaper 6000\"# ", x = 58, y = 62, zone = "Stonetalon Mountains" },
			[8] = { str = "07) Then do: #DOQUEST\"Goblin Invaders\"# and #DOQUEST\"Super Reaper 6000\"# (the mobs are just north in Windshear Crag)" },
			[9] = { str = "08) Then turn in #TURNIN\"Super Reaper 6000\"# #COORDS[58,62]# ... accept #ACCEPT\"Further Instructions\"# ", x = 58, y = 62, zone = "Stonetalon Mountains" },
			...
			[13] = { str = "12) Run up the little #VIDEOpathway# and accept #ACCEPT\"Boulderslide Ravine\"# and #ACCEPT\"Trouble in the Deeps\"# at #COORDS[47,64]#", x = 47, y = 64, zone = "Stonetalon Mountains" },
			[14] = { str = "13) Then go do #DOQUEST\"Boulderslide Ravine\"# at #COORDS[61,92]#", x = 61, y = 92, zone = "Stonetalon Mountains" },
			[15] = { str = "14) Then turn in #TURNIN\"Blood Feeders\"# #COORDS[71,95]#", x = 71, y = 95, zone = "Stonetalon Mountains" },
			...
			[18] = { str = "17) Run north to Ashenvale (stopping along the way to turn in #TURNIN\"Report to Kadrak\"# at #COORDS[48,5]# but SKIP \"#NPCThe Warsong Reports\"# ", x = 48, y = 5, zone = "The Barrens" },
			--[19] = { str = "." },
			--[20] = { str = "." },
		}
	},
...
-----------21-21 Ashenvale
	...
	[2121] = {
		...
		items = {
			...
			[2] = { str = "01) Run to Splintertree Post at #COORDS[73,65]#", x = 73, y = 65, zone = "Ashenvale" },
			...
			[5] = { str = "04) Run all the way to Zoram Strand at #COORDS[13,31]#, grind mobs along the way.", x = 13, y = 31, zone = "Ashenvale" },
			[6] = { str = "05) Get FP there. #COORDS[12,33]#.  Turn in #TURNIN\"Trouble in the Deeps\"# .. i SKIP \"#NPCThe Essence of Aku'Mai\"# ", x = 12, y = 33, zone = "Ashenvale" },
...
-----------22-23 Southern Barrens
	...
	[2223] = {
		...
		items = {
			...
			[6] = { str = "05) Run south and keep an eye out for the mob named #NPCOwatanka# (around #COORDS[45,62]#), he drops 'Owatanka's Tailspike' which starts #ACCEPT\"Owatanka\"# ", x = 45, y = 62, zone = "The Barrens" },
			[7] = { str = "06) #DOQUEST\"Egg Hunt\"# #COORDS[44,71]#", x = 44, y = 71, zone = "The Barrens" },
			[8] = { str = "07) #DOQUEST\"Chen's Empty Keg\"# (if you have it)" },
			[9] = { str = "08) #DOQUEST\"Betrayal from Within\"# and #DOQUEST\"Weapons of Choice\"# #COORDS[43,79]#", x = 43, y = 79, zone = "The Barrens" },
			[10] = { str = "09) Accept #ACCEPT\"Gann's Reclamation\"# from #NPCGann Stonespire#.  Then go do it at #COORDS[46,86]#. Then turn it in, accept #ACCEPT\"Revenge of Gann\"# ", x = 46, y = 86, zone = "The Barrens" },
			...
			[14] = { str = "13) Do #DOQUEST\"Ishamuhale\"# at #COORDS[60,32]#", x = 60, y = 32, zone = "The Barrens" },
			[15] = { str = "14) Turn in #TURNIN\"Further Instructions\"# (at Ratchet #COORDS[63,37]#) ... accept #ACCEPT\"Further Instructions\"# part2", x = 63, y = 37, zone = "The Barrens" },
...
-----------23-25 Stonetalon Mountains
	...
	[2325] = {
		...
		items = {
			...
			[5] = { str = "04) Do:" },
			[6] = { str = "05) #DOQUEST\"Cycle of Rebirth\"#   (pick up the seeds around #COORDS[48,41]#)", x = 48, y = 41, zone = "Stonetalon Mountains" },
			[7] = { str = "06) #DOQUEST\"Cenarius' Legacy\"#   (done at around #COORDS[35,14]#)", x = 35, y = 14, zone = "Stonetalon Mountains" },
			[8] = { str = "07) #DOQUEST\"Jin'Zil's Forest Magic\"# (the mobs are around the path at 45.27, and the area at #COORDS[34,14]#)", x = 45, y = 27, zone = "Stonetalon Mountains" },
			...
			[12] = { str = "11) Go turn in #TURNIN\"Further Instructions\"# part2 #COORDS[58,62]#... accept #ACCEPT\"Gerenzo Wrenchwhistle\"# ", x = 58, y = 62, zone = "Stonetalon Mountains" },
			[13] = { str = "12) Go do #DOQUEST\"Gerenzo Wrenchwhistle\"# at #COORDS[64,41]#  and #DOQUEST\"Shredding Machines\"#   (kill #NPCXT:4# and #NPCXT:9#)", x = 64, y = 41, zone = "Stonetalon Mountains" },
			[14] = { str = "13) Then turn in #TURNIN\"Gerenzo Wrenchwhistle\"# . #COORDS[58,62]#. If you couldn't do Arachnophobia, do it now!", x = 58, y = 62, zone = "Stonetalon Mountains" },
			[15] = { str = "14) Run down south and turn in #TURNIN\"Jin'Zil's Forest Magic\"# #COORDS[74,97]#", x = 74, y = 97, zone = "Stonetalon Mountains" },
			[16] = { str = "15) Turn in #TURNIN\"Shredding Machines\"# (in the Barrens at #COORDS[35,27]#)", x = 35, y = 27, zone = "The Barrens" },
			...
			[19] = { str = "18) Go do #DOQUEST\"Harpies Threaten\"# along with #DOQUEST\"Elemental War\"# and #DOQUEST\"New Life\"# (all at the Charred Vale, #COORDS[32,67]#)", x = 32, y = 67, zone = "Stonetalon Mountains" },
...
-----------25-25 Southern Barrens2
	...
	[2525] = {
		...
		items = {
			...
			[8] = { str = "07) #DOQUEST\"Revenge of Gann\"# at #COORDS[47,85]# Once done, Turn it in, accept the next part...", x = 47, y = 85, zone = "The Barrens" },
			[9] = { str = "08) Do #DOQUEST\"Revenge of Gann\"# Part 3 at #COORDS[46,85]#, then turn it in.", x = 46, y = 85, zone = "The Barrens" },
			...
			[12] = { str = "11) Run to Freewind Post... (#COORDS[45,50]# in Thousand Needles)", x = 45, y = 50, zone = "Thousand Needles" },
			--[13] = { str = "." },
			--[14] = { str = "." },
		}
	},
...
-----------25-26 Thousand Needles
	...
	[2526] = {
		...
		items = {
			...
			[7] = { str = "06) #DOQUEST\"Test of Faith\"# (the cave at #COORDS[52,43]#)", x = 52, y = 43, zone = "Thousand Needles" },
			...
			[11] = { str = "10) Go up to Freewind Post #COORDS[45,50]#..", x = 45, y = 50, zone = "Thousand Needles" },
			...
			[19] = { str = "18) Turn in #TURNIN\"Melor Sends Word\"# (#COORDS[61,80]# on the Hunter Rise)... accept #ACCEPT\"Steelsnap\"# ", x = 61, y = 80, zone = "Thunder Bluff" },
			[20] = { str = "19) Accept #ACCEPT\"The sacred Flame\"# #COORDS[55,51]#", x = 55, y = 51, zone = "Thunder Bluff" },
...
-----------26-27 Ashenvale
	...
	[2627] = {
		...
		items = {
			...
			[4] = { str = "03) Accept all the quests, which include: #ACCEPT\"Stonetalon Standstill\"# #ACCEPT\"Satyr Horns\"# #ACCEPT\"Ashenvale Outrunners\"# (accept this at #COORDS[71,68]#).  Make sure #ACCEPT\"The Ashenvale Hunt\"# is turned in at #NPCSenani Thunderheart# (you can accept this quest right at the NPC itself). Note: I SKIP \"#NPCWarsong Supplies\"# and \"#NPCThe Lost Pages\"# ", x = 71, y = 68, zone = "Ashenvale" },
			[5] = { str = "04) Kill the first of the three mobs related to the Ashenvale hunt:" },
			[6] = { str = "05) #DOQUEST\"Sharptalon's Claw\"# (Kill #NPCSharptalon# (patrols around #COORDS[74,70]#), then he drops the item that starts this quest) (hint: easy way to kill it (he's lvl 31 mob), is to bring his health to a 3rd left, then drag him into the guards at Splintertree Post, they will finish em). ", x = 74, y = 70, zone = "Ashenvale" },
			[7] = { str = "06) Do: #DOQUEST\"Ashenvale Outrunners\"# (around #COORDS[71,72]#)#HUNTER  (use track hidden, to find them better). # Once the quest is completed, turn it in when you get the chance.", x = 71, y = 72, zone = "Ashenvale" },
			[8] = { str = "07) Then go slightly west and do #DOQUEST\"Torek's Assault\"# (starts at #COORDS[68,75]#)", x = 68, y = 75, zone = "Ashenvale" },
			[9] = { str = "08) Then go do #DOQUEST\"Stonetalon Standstill\"# (the lake at #COORDS[53,70]#) *find and kill #NPCTideress# he drops an item which starts: #ACCEPT\"The Befouled Element\"# ", x = 53, y = 70, zone = "Ashenvale" },
			[10] = { str = "09) Kill #NPCUrsangous#, (around #COORDS[42,67]#) #DOQUEST\"Ursangous's Paw\"# (Ashenvale hunt)", x = 42, y = 67, zone = "Ashenvale" },
			[11] = { str = "10) Kill #NPCShadumbra# (around #COORDS[56,54]#) #DOQUEST\"Shadumbra's Head\"# (Ashenvale hunt)", x = 56, y = 54, zone = "Ashenvale" },
			[12] = { str = "11) #DOQUEST\"The sacred Flame\"# (first find a phial killing the dryads at 61.52, then fill it at the moonwell at #COORDS[60,72]#)", x = 60, y = 72, zone = "Ashenvale" },
			...
			[19] = { str = "18) Go do #DOQUEST\"Ordanus\"# #COORDS[61,52]# (#VIDEOfight your way to him, just kill the guy, grab his head and jump out of there!#)", x = 61, y = 52, zone = "Ashenvale" },
			[20] = { str = "19) Go do: #DOQUEST\"Satyr Horns\"# (done at the Night Run, #COORDS[67,53]#)  (entrance to the area is around #COORDS[64,42]#).", x = 67, y = 53, zone = "Ashenvale" },
...
-----------27-27 Stonetalon Mountains
	...
	[2727] = {
		...
		items = {
			...
			[3] = { str = "02) Make Sun Rock Retreat your home." },
			[4] = { str = "03) Accept and do #DOQUEST\"Bloodfury Bloodline\"# , go kill Bloodfury Ripper at #COORDS[30,63]# (grinding mobs along the way) , then hearth back.." },
			[5] = { str = "04) Turn #TURNIN\"Bloodfury Bloodline\"# in." },
			[6] = { str = "05) Fly to Thunder Bluff." },
			[7] = { str = "06) Make Thunder Bluff your home." },
			[8] = { str = "07) Turn in #TURNIN\"The sacred Flame\"# (#COORDS[54,51]# in TB)... accept #ACCEPT\"The sacred Flame\"# part2", x = 54, y = 51, zone = "Thunder Bluff" },
...
-----------27-29 Thousand Needles
	...
	[2729] = {
		...
		items = {
			...
			[4] = { str = "03) #DOQUEST\"The sacred Flame\"# (charge the brazier in the cave at #COORDS[44,37]#)  ", x = 44, y = 37, zone = "Thousand Needles" },
			[5] = { str = "04) Go to Whitereach Post #COORDS[21,32]#, accept #ACCEPT\"Hypercapacitor Gizmo\"# , Turn in #TURNIN\"Serpent Wild\"# ...accept #ACCEPT\"Sacred Fire\"# ", x = 21, y = 32, zone = "Thousand Needles" },
			[6] = { str = "05) Go do: #DOQUEST\"Sacred Fire\"# #COORDS[35,36]#", x = 35, y = 36, zone = "Thousand Needles" },
			[7] = { str = "06) #DOQUEST\"Wind Rider\"# #COORDS[11,36]#", x = 11, y = 36, zone = "Thousand Needles" },
			[8] = { str = "07) #DOQUEST\"Homeward Bound\"# (escort starts at #COORDS[17,40]#)  (if the Elite gets in the way, skip it)", x = 17, y = 40, zone = "Thousand Needles" },
			[9] = { str = "08) #DOQUEST\"Steelsnap\"# (Steelsnap patrols around #COORDS[16,25]#)  ", x = 16, y = 25, zone = "Thousand Needles" },
			...
			[17] = { str = "16) Go to the Darkcloud Pinnacle (the entrance ramp is at #COORDS[31,36]#) and do the following quests: #DOQUEST\"Grimtotem Spying\"# (the notes are up in the rises at 31.32, 33.39, and #COORDS[39,41]#)", x = 31, y = 36, zone = "Thousand Needles" },
			[18] = { str = "17) #DOQUEST\"Arikara\"# (done up at #COORDS[37,35]#) ", x = 37, y = 35, zone = "Thousand Needles" },
			[19] = { str = "18) #DOQUEST\"Wanted - Arnak Grimtotem\"# (he is up at #COORDS[38,27]#)", x = 38, y = 27, zone = "Thousand Needles" },
			[20] = { str = "19) #DOQUEST\"Free at Last\"# (escort quest starts up at #COORDS[38,27]#)", x = 38, y = 27, zone = "Thousand Needles" },
			[21] = { str = "20) Go to Whitereach Post #COORDS[21,32]#, turn in #TURNIN\"Arikara\"# and #TURNIN\"Homeward Bound\"#", x = 21, y = 32, zone = "Thousand Needles" },
			[22] = { str = "21) You should be level 29 by now, if not grind to level 29, I grind away at centuars around Camp E'Thok #COORDS[18,23]#", x = 18, y = 23, zone = "Thousand Needles" },
