...
-----------23-25 Stonetalon Mountains
	[2325] = {
		...
		items = {
			...
			[17] = { str = "Hearth back to Sun Rock Retreat and turn in #Q_'Arachnophobia'# if you just did it." },
...
-----------26-27 Ashenvale
	[2627] = {
		...
		items = {
			...
			[13] = { str = "Hearth to Splintertree Post to turn in #Q_'Stonetalon Standstill'# #Q_'The Befouled Element'# (accept #Q_'Je'neu of the Earthen Ring'# ) #Q_'Torek's Assault'# and all three of the 'Ashenvale Hunt' quests, then accept and complete #Q_'The Hunt Completed'#." },
			...
			[17] = { str = "Once they are both completed, go turn in #Q_'Between a Rock and a Thistlefur'# and #Q_'Troll Charm'# (back at the Zoram Strand), then hearth back to Splintertree Post. Turn in #Q_'Freedom to Ruul'# (if you did it)." },
...
-----------27-27 Stonetalon Mountains
	[2727] = {
		...
		items = {
			...
			[3] = { str = "Make Sun Rock Retreat your home." },
			[4] = { str = "Accept and do #Q_'Bloodfury Bloodline'#, go kill Bloodfury Ripper at #C_[30,63]# (grinding mobs along the way), then hearth back." },
...
-----------29-30 Hillsbrad Foothills
	[2930] = {
		...
		items = {
			...
			[11] = { str = "As soon as you hit 30, hearth to Orgrimmar and talk to your #N_Class Trainer# to learn new spells and abilities." },
