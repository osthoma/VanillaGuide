Table_003_Horde_20to30 = {
	...
	[2021] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 21 to 21 in #A_Stonetalon Mountains#." },
	...
	[2121] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through level 21 in #A_Ashenvale#." },
	...
	[2223] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 22 to 23 in #A_The Barrens#." },
			...
			[6] = { str = "Run south and keep an eye out for the mob named #N_Owatanka# (around #C_[45,62]#), he drops #I_[Owatanka’s Tailspike] which starts #Q_'Owatanka'#.", x = 45, y = 62, zone = "The Barrens" },
	...
	[2325] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 23 to 25 in #A_Stonetalon Mountains#." },
	...
	[2525] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through level 25 in #A_The Barrens#." },
			...
			[7] = { str = "You should find the mob #N_Washte Pawne#, he drops #I_[Washte Pawne Feather]# which starts #Q_'Washte Pawne'#." },
	...
	[2526] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 25 to 26 in #A_Thousand Needles#." },
	...
	[2627] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 26 to 27 in #A_Ashenvale#." },
			...
			[13] = { str = "Use your #I_[Hearthstone]# to return to #A_Splintertree Post# (#A_Ashenvale#) to turn in #Q_'Stonetalon Standstill'# #Q_'The Befouled Element'# (accept #Q_'Je’neu of the Earthen Ring'# ) #Q_'Torek’s Assault'# and all three of the #Q_'Ashenvale Hunt'# quests, then accept and complete #Q_'The Hunt Completed'#." },
	...
	[2727] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through level 27 in #A_Stonetalon Mountains#." },
	...
	[2729] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 27 to 29 in #A_Thousand Needles#." },
			...
			[24] = { str = "Kill the #N_Galak Messenger#, he drops #I_[Assassination Note]# which starts #Q_'Assassination Plot'# Turn in for Easy XP. Also turn in #Q_'Hypercapacitor Gizmo'#." },
	...
	[2930] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 29 to 30 in #A_Hillsbrad Foothills#." },
