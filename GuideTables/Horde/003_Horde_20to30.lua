...
-----------21-21 Ashenvale
	[2121] = {
		...
		items = {
			...
			[4] = { str = "Get flight path in #A_Splintertree Post#." },
...
-----------27-29 Thousand Needles
	[2729] = {
		...
		items = {
			...
			[26] = { str = "If you are not at least 4 bars from level 30, grind until you are. Then Use your #I_[Hearthstone]# to return to back to #A_Freewind Post#." },
