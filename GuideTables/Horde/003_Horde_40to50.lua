...
-----------40-41 Badlands
	[4041] = {
		...
		items = {
			...
			[21] = { str = "Hearth to #A_Booty Bay# and check if you have #Q_'Dream Dust in the Swamp'# in your questlog. If not, go accept it from Krazek at #C_[27,77]#.", x = 27, y = 77, zone = "Stranglethorn Vale" },
...
-----------44-46 Feralas
	[4446] = {
		...
		items = {
			...
			[15] = { str = "Hearth back to Camp Mojache, turn in #Q_'The Battle Plans'# and #Q_'A Grim Discovery'#, accept ALL new quests." },
...
-----------46-46 Azshara
	[4646] = {
		...
		items = {
			...
			[6] = { str = "Then get flight path there and fly to Orgrimmar." },
...
-----------47-47 Stranglethorn Vale
	[4747] = {
		...
		items = {
			...
			[14] = { str = "Then hearth back to #A_Booty Bay#, if hearth stone still is on a cooldown, die on purpose." },
...
--------48-49 Feralas
	[4849] = {
		...
		items = {
			...
			[7] = { str = "turn in #Q_'Hippogryph Muisek'#. accept #Q_'Faerie Dragon Muisek'#." },
