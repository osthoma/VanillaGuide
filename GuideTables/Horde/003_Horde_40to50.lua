...
-----------40-41 Badlands
	[4041] = {
		...
		items = {
			...
			[21] = { str = "Hearth to BB and check if you have #Q_'Dream Dust in the Swamp'# in your questlog. If not, go accept it from Krazek at #C_[27,77]#.", x = 27, y = 77, zone = "Stranglethorn Vale" },
...
-----------42-43 Stranglethorn Vale
	[4243] = {
		...
		items = {
			...
			[3] = { str = "fly to BB." },
			[4] = { str = "accept ALL quests in BB: #Q_'The Bloodsail Buccaneers'# #Q_'Up to Snuff'# #Q_'Zanzil's Secret'# #Q_'Akiris by the Bundle'# #Q_'Voodoo Dues'# #Q_'Stoley's Debt'# #Q_'Stranglethorn Fever'# and #Q_'Keep An Eye Out'#." },
...
-----------47-47 Stranglethorn Vale
	[4747] = {
		...
		items = {
			...
			[11] = { str = "Find a small bottle laying around the shore east of BB, until this item: #N_Carefully Folded Note# shows up. which starts #Q_'Message in a Bottle'#." },
...
-----------47-48 Searing Gorge
	[4748] = {
		...
		items = {
			...
			[4] = { str = "Then go up north-west, Talk to #N_Kalaran Windblade# at #C_[39,38]# on way to Thorium Point #C_[35,25]#. Do first his listen to me quest #Q_'Divine Retribution'#. In order to get #Q_'The Flawless Flame'# Once at Thorium Point collect ALL quests there and get the FP there too.", x = 35, y = 25, zone = "Searing Gorge" },
			...
			[24] = { str = "I discover some areas, then get FP there at #C_[65,25]#, and fly directly to Stonard (swamp of sorrows).", x = 65, y = 25, zone = "Searing Gorge" },
		}
	},
