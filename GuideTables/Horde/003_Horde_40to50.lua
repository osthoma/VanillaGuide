...
-----------40-41 Badlands
	...
	[4041] = {
		...
		items = {
			...
			[2] = { str = "01) The goal here is not to leave till your level 41, so grind mobs every where you go to...As you enter Badlands, run southwest to #COORDS[42,52]#...", x = 42, y = 52, zone = "Badlands" },
			[3] = { str = "02) Turn in #TURNIN\"Martek the Exiled\"# at #COORDS[42,52]# ... accept #ACCEPT\"Indurium\"# and #ACCEPT\"Barbecued Buzzard Wings\"# ", x = 42, y = 52, zone = "Badlands" },
			[4] = { str = "03) Go down south a little and do #DOQUEST\"Indurium\"# #COORDS[51,67]#", x = 51, y = 67, zone = "Badlands" },
			...
			[7] = { str = "06) Grind your way west to Kargath #COORDS[4,46]#...", x = 4, y = 46, zone = "Badlands" },
			...
			[21] = { str = "21) Hearth to BB and check if you have #DOQUEST\"Dream Dust in the Swamp\"# in your questlog. If not, go accept it from Krazek at #COORDS[27,77]#", x = 27, y = 77, zone = "Stranglethorn Vale" },
			[22] = { str = "22) Fly to Grom'gol." },
			[23] = { str = "23) Go turn in all the #NPCThe Green Hills of Stranglethorn Chapters/Quests# at Nesingwary's Expedition #COORDS[35,10]# if you have all the pages for it, if not you have another chance to turn this in again later.  You can also look in the AH for your missing pages.", x = 35, y = 10, zone = "Badlands" },
			[24] = { str = "24) Then run all the way to Swamp of Sorrows, stopping along the way to accept this quest: #ACCEPT\"Nothing But the Truth\"# (in Duskwood at #COORDS[87,35]#)", x = 87, y = 35, zone = "Duskwood" },
...
-----------41-42 Swamp of Sorrows
	...
	[4142] = {
		...
		items = {
			...
			[2] = { str = "01) Start off doing: #DOQUEST\"Dream Dust in the Swamp\"# #COORDS[14,59]# It may take several trips to that area to complete it..", x = 14, y = 59, zone = "Swamp of Sorrows" },
			[3] = { str = "02) #DOQUEST\"Nothing But the Truth\"#  kill the Mire Lord for the Mire Lord Fungus at #COORDS[6,32]#", x = 6, y = 32, zone = "Swamp of Sorrows" },
			[4] = { str = "03) Find and kill #NPCCudgel#, he drops Noboru's Cudgel, which starts #ACCEPT\"Noboru the Cudgel\"# " },
			[5] = { str = "04) Go turn in #TURNIN\"Noboru the Cudgel\"# #COORDS[25,31]# ... accept #ACCEPT\"Draenethyst Crystals\"# ", x = 25, y = 31, zone = "Swamp of Sorrows" },
			[6] = { str = "05) Grind to Stonard #COORDS[45,54]#", x = 45, y = 54, zone = "Swamp of Sorrows" },
			...
			[13] = { str = "12) #DOQUEST\"Lack of Surplus\"# then turn it in at #COORDS[81,80]# ... accept #ACCEPT\"Lack of Surplus\"# part2 and go do it", x = 81, y = 80, zone = "Swamp of Sorrows" },
			[14] = { str = "13) Go do #DOQUEST\"Fresh Meat\"# and #DOQUEST\"Nothing But the Truth\"# (#NPCShadow Panthers#' hearts) " },
			[15] = { str = "14) #DOQUEST\"Draenethyst Crystals\"# then turn it in at #COORDS[25,31]#", x = 25, y = 31, zone = "Swamp of Sorrows" },
...
-----------42-43 Stranglethorn Vale
	...
	[4243] = {
		...
		items = {
			...
			[8] = { str = "07) #DOQUEST\"The Bloodsail Buccaneers\"# along with #DOQUEST\"Up to Snuff\"# and #DOQUEST\"Keep An Eye Out\"# (these are done at the shore around #COORDS[31,80]#, and some more mobs can be found at #COORDS[27,70]#).  Also do #DOQUEST\"Stranglethorn Fever\"# (for #DOQUEST\"Stranglethorn Fever\"# you will need one gorilla fang, and the witch doctor is in the cave at #COORDS[34,60]#)", x = 31, y = 80, zone = "Stranglethorn Vale" },
			[9] = { str = "08) #DOQUEST\"Mok'thardin's Enchantment\"# part4 along with #DOQUEST\"Akiris by the Bundle\"# #COORDS[25,63]#", x = 25, y = 63, zone = "Stranglethorn Vale" },
			[10] = { str = "09) #DOQUEST\"Zanzil's Secret\"# along with #DOQUEST\"Voodoo Dues\"# (#COORDS[34,52]# and #COORDS[39,58]#)", x = 34, y = 52, zone = "Stranglethorn Vale" },
			...
			[19] = { str = "18) Once there go to Belgrom Rockmaul at #COORDS[75,34]# and accept #ACCEPT\"A Threath in Ferelas\"#", x = 75, y = 34, zone = "Orgrimmar" },
...
-----------43-43 Desolace
	...
	[4342] = {
		...
		items = {
			...
			[5] = { str = "04) go turn in #TURNIN\"Ongeku\"# at #COORDS[36,79]# ... SKIP #NPC\"Khan Jehn\"# ", x = 36, y = 79, zone = "Desolace" },
			...
			[8] = { str = "07) then go to Mannoroc Coven at #COORDS[50,76]# and do:", x = 50, y = 76, zone = "Desolace" },
			[9] = { str = "08) #DOQUEST\"Portals of the Legion\"# " },
			[10] = { str = "09) #DOQUEST\"The Corrupter\"# (Elite) (Slay #NPCLord Azrethoc# and #NPCJugkar Grim'rod#)" },
			[11] = { str = "10) turn in #TURNIN\"The Corrupter\"# (Elite) at #COORDS[53,54]#", x = 53, y = 54, zone = "Desolace" },
...
-----------43-43 Dustwallow Marsh
	...
	[4343] = {
		...
		items = {
			...
			[3] = { str = "02) Go down to #COORDS[40,36]# and accept #DOQUEST\"Questioning Reethe\"# then do it.", x = 40, y = 36, zone = "Dustwallow Marsh" },
			[4] = { str = "03) Go down and do:" },
			[5] = { str = "04) #DOQUEST\"Deadmire\"# " },
			[6] = { str = "05) #DOQUEST\"Marg Speaks\"# Kill the mobs at around #COORDS[58,63]#", x = 58, y = 63, zone = "Dustwallow Marsh" },
...
-----------43-44 Tanaris
	...
	[4344] = {
		...
		items = {
			...
			[7] = { str = "06) Go to the Shimmering Flats (in Thousand Needles at #COORDS[78,77]#) and turn in #TURNIN\"Rumors for Kravel\"# #TURNIN\"News for Fizzle\"# and #TURNIN\"Razzeric's Tweaking\"# ... accept #ACCEPT\"Safety First\"# ", x = 53, y = 76, zone = "Tanaris" },
			[8] = { str = "07) Accept #ACCEPT\"Keeping Pace\"# " },
			[9] = { str = "08) Turn #TURNIN\"Keeping Pace\"# in at Zamek, then go pick up Rizzle's Plans at #COORDS[77,77]# ... accept #ACCEPT\"Rizzle's Schematics\"# " },
			...
			[14] = { str = "13) Then grind your way east to Steamwheedle Port. #COORDS[67,23]#", x = 67, y = 23, zone = "Tanaris" },
			...
			[18] = { str = "17) #DOQUEST\"Wastewander Justice\"# along with #DOQUEST\"Water Pouch Bounty\"# (at #COORDS[64,29]#", x = 64, y = 29, zone = "Tanaris" },
			[19] = { str = "18) Then go do all of the following (steps 19 - 23) at Lost Rigger Cove #COORDS[72,47]#:", x = 72, y = 47, zone = "Tanaris" },
			...
			[27] = { str = "26) Go do #DOQUEST\"Gadgetzan Water Survey\"# (grinding mobs along the way, coords are at #COORDS[38,29]#), then go back and turn it in.", x = 38, y = 29, zone = "Tanaris" },
			[28] = { str = "27) Go to Steamwheedle Port." },
			[29] = { str = "28) Turn in ALL quests there ... accept #ACCEPT\"Deliver to MacKinley\"# " },
			[30] = { str = "29) Then go do: #DOQUEST\"More Wastewander Justice\"# along with #DOQUEST\"WANTED: Caliph Scorpidsting\"# #COORDS[59,37]#", x = 59, y = 37, zone = "Tanaris" },
...
-----------44-46 Feralas
	...
	[4446] = {
		...
		items = {
			[1] = { str = "44-46 Feralas" },
			[2] = { str = "01) Run into Camp Mojache. #COORDS[75,44]#", x = 75, y = 44, zone = "Feralas" },
			...
			[7] = { str = "06) #DOQUEST\"War on the Woodpaw\"# go just north of Camp Mojache to do this. #COORDS[71,37]#", x = 71, y = 37, zone = "Feralas" },
			[8] = { str = "07) #DOQUEST\"The Ogres of Feralas\"# along with #DOQUEST\"Gordunni Cobalt\"# #COORDS[75,31]#", x = 75, y = 31, zone = "Feralas" },
			[9] = { str = "08) Make sure you click on one of the scrolls laying on the ground which starts: #ACCEPT\"The Gordunni Scroll\"# " },
			[10] = { str = "09) Then go do: #DOQUEST\"A New Cloak's Sheen\"# #COORDS[67,48]#", x = 67, y = 48, zone = "Feralas" },
			[11] = { str = "10) Go back to Camp Mojache, turn in ALL those quests, accept all new quests." },
			[12] = { str = "11) Go do #DOQUEST\"Alpha Strike\"# at #COORDS[72,56]# then turn it in. ... accept #ACCEPT\"Woodpaw Investigation\"# ", x = 72, y = 56, zone = "Feralas" },
			[13] = { str = "12) Go do #DOQUEST\"Woodpaw Investigation\"# at #COORDS[71,55]# complete it ... accept #ACCEPT\"The Battle Plans\"# ", x = 71, y = 55, zone = "Feralas" },
			[14] = { str = "13) Then go do #DOQUEST\"A Grim Discovery\"# #COORDS[66,46]#", x = 66, y = 46, zone = "Feralas" },
			[15] = { str = "14) Hearth back to Camp Mojache, turn in #TURNIN\"The Battle Plans\"# and #TURNIN\"A Grim Discovery\"# , accept ALL new quests." },
			[16] = { str = "15) PLEASE NOTE:  If the 'OOX-22/FE Distress Beacon' item drops, accept the quest #ACCEPT\"Find OOX-22/FE!\"# .  Turn in #TURNIN\"Find OOX-22/FE!\"# at #COORDS[53,55]#.  Then go do:", x = 53, y = 55, zone = "Feralas" },
			[17] = { str = "16) #DOQUEST\"Stinglasher\"# along with #DOQUEST\"Zukk'ash Infestation\"# #COORDS[74,62]#", x = 74, y = 62, zone = "Feralas" },
			[18] = { str = "17) #DOQUEST\"Screecher Spirits\"# #COORDS[55,56]#", x = 55, y = 56, zone = "Feralas" },
			[19] = { str = "18) #DOQUEST\"The Ogres of Feralas\"# part2 #COORDS[59,68]#", x = 59, y = 68, zone = "Feralas" },
			...
			[21] = { str = "19) #DOQUEST\"Dark Ceremony\"# #COORDS[59,68]#", x = 59, y = 68, zone = "Feralas" },
			[22] = { str = "20) #DOQUEST\"The Mark of Quality\"# #COORDS[53,55]#", x = 53, y = 55, zone = "Feralas" },
			...
			[27] = { str = "25) Then go turn in: #TURNIN\"Zukk'ash Report\"# #COORDS[56,46]#", x = 56, y = 46, zone = "Orgrimmar" },
			[28] = { str = "26) Go complete #DOQUEST\"A Donation of Silk\"# and #DOQUEST\"A Donation of Mageweave\"# at #COORDS[63,51]#", x = 63, y = 51, zone = "Orgrimmar" },
			[29] = { str = "27) Accept #ACCEPT\"Ripple Recovery\"# (from Dran Droffers) #COORDS[59,36]#", x = 59, y = 36, zone = "Orgrimmar" },
			[30] = { str = "28) Then turn in #TURNIN\"Ripple Recovery\"# (the guy right next to Dran) ... accept #ACCEPT\"Ripple Recovery\"# again." },
			[31] = { str = "29) Turn in #TURNIN\"Parts of the Swarm\"# and #TURNIN\"A Grim Discovery\"# at #NPCBelgrom Rockmaul#... accept #ACCEPT\"Betrayed\"# #COORDS[75,34]#.  Also get new spells/abilities while you are in Orgrimmar.", x = 75, y = 34, zone = "Orgrimmar" },
			[32] = { str = "30) Go turn in #TURNIN\"A Strange Request\"# ... Accept #ACCEPT\"Retrun to Witch Doctor Uzer'i\"# (cleft of shadow, #COORDS[49,50]#)", x = 49, y = 50, zone = "Orgrimmar" },
			[33] = { str = "31) Go turn in #ACCEPT\"Report to Zor\"# ... accept/complete #DOQUEST\"Service to the Horde\"# (valley of wisdom, #COORDS[38,38]#)", x = 38, y = 38, zone = "Orgrimmar" },
			[34] = { str = "32) Go turn in #TURNIN\"The Gordunni Orb\"# (valley of spirits, #COORDS[39,86]#)", x = 39, y = 86, zone = "Orgrimmar" },
			[35] = { str = "33) Turn in #TURNIN\"A Donation of Silk\"# and #TURNIN\"A Donation of Mageweave\"# (for the troll faction, at #COORDS[37,87]#)", x = 37, y = 87, zone = "Orgrimmar" },
			...
			[41] = { str = "39) turn in #TURNIN\"Find OOX-22/FE!\"# at #COORDS[51,57]#", x = 51, y = 57, zone = Ferelas },
...
-----------46-46 Azshara
	...
	[4646] = {
		...
		items = {
			[1] = { str = "46-46 Azshara" },
			[2] = { str = "01) Go accept #DOQUEST\"Spiritual Unrest\"# and #DOQUEST\"A Land Filled with Hatred\"# at #COORDS[10,78]#", x = 10, y = 78, zone = "Azshara" },
			[3] = { str = "02) Then go do them (at #COORDS[17,66]# and #COORDS[20,62]#), and turn them in.", x = 17, y = 66, zone = "Azshara" },
			[4] = { str = "03) Then go to Valormok at #COORDS[21,52]#", x = 21, y = 52, zone = "Azshara" },
			...
			[14] = { str = "13) Head to the Hinterlands. There a passage at around #COORDS[83,33]#", x = 83, y = 33, zone = "Hillsbard Foothills" },
			--[15] = { str = "." },
		}
	},
...
-----------46-47 Hinterlands
	...
	[4647] = {
		...
		items = {
			...
			[2] = { str = "01) go turn in #TURNIN\"Ripple Recovery\"# at #COORDS[27,49]# ... accept #ACCEPT\"A Sticky Situation\"# ", x = 27, y = 49, zone = "Hinterlands" },
			[3] = { str = "02) Ride all the way to Revantusk Village at #COORDS[77,80]#", x = 77, y = 80, zone = "Hinterlands" },
			...
			[16] = { str = "15) #DOQUEST\"Rin'ji is Trapped!\"# (the escort quest, starts at #COORDS[31,48]#)", x = 31, y = 48, zone = "Hinterlands" },
			...
			[20] = { str = "19) Turn in #TURNIN\"Find OOX-09/HL!\"# at #COORDS[49,38]#", x = 49, y = 38, zone = "Hinterlands" },
			[21] = { str = "20) Turn in #TURNIN\"Rin'ji is Trapped!\"# at #COORDS[86,59]# ... accept #ACCEPT\"Rin'ji's Secret\"# ", x = 86, y = 59, zone = "Hinterlands" },
...
-----------47-47 Stranglethorn Vale
	...
	[4747] = {
		...
		items = {
			...
			[2] = { str = "01) Go do #DOQUEST\"Raptor Mastery\"# (#NPCTethis#) #COORDS[28,44]# and go turn it in", x = 28, y = 44, zone = "Stranglethorn Vale" },
			...
			[8] = { str = "07) Accept #ACCEPT\"The Captain's Chest\"# (Elite) then go do it at #COORDS[36,65]#  NOTE:  This quest is tough to solo, it can be soloed, but you should find a group to help you kill Gorlash, I personally skip it while racing to 60.", x = 36, y = 65, zone = "Stranglethorn Vale" },
			[9] = { str = "08) Turn in #TURNIN\"Back to Booty Bay\"# and #TURNIN\"Deliver to MacKinley\"# " },
			[10] = { str = "09) Make sure that #DOQUEST\"The Captain's Chest\"# is accepted, then go do it at #COORDS[36,65]#  .  If your class has troubles, either find a group to help, or you can simply skip it.", x = 36, y = 65, zone = "Stranglethorn Vale" },
			...
			[12] = { str = "11) Go turn #TURNIN\"Message in a Bottle\"# in at #COORDS[38,80]#", x = 38, y = 80, zone = "Stranglethorn Vale" },
...
-----------47-48 Searing Gorge
	...
	[4748] = {
		...
		items = {
			...
			[14] = { str = "13) #DOQUEST\"The Key to Freedom\"# starts from an item drop #NPCGrimsite Outhouse Key#, turn in at the outhouse (south-east, #COORDS[65,62]#)", x = 65, y = 62, zone = "Searing Gorge" },
			[15] = { str = "14) Turn in #TURNIN\"Forging the Shaft\"# ... accept #ACCEPT\"The Flame's Casing\"# " },
			[16] = { str = "15) Do #DOQUEST\"The Flame's Casing\"# (around #COORDS[24,36]#).  Just keep killing the mobs there until the item drops.", x = 24, y = 36, zone = "Searing Gorge" },
			...
			[19] = { str = "18) Do #DOQUEST\"Set Them Ablaze!\"# (north=#COORDS[33,54]#, south=#COORDS[44,61]#, east=#COORDS[50,54]#, west=#COORDS[35,60]#).  Once that is done, go back and turn it in.", x = 33, y = 54, zone = "Searing Gorge" },
			[20] = { str = "19) Click on the little chest on the ground at #COORDS[38,38]# and accept #ACCEPT\"Trinkets...\"# , then click on the chest again to turn it in.", x = 38, y = 38, zone = "Searing Gorge" },
			...
			[24] = { str = "23) I discover some areas, then get FP there at #COORDS[65,25]#, and fly directly to Stonard (swamp of sorrows)...", x = 65, y = 25, zone = "Searing Gorge" },
			--[25] = { str = "." },
			--[26] = { str = "." },
		}
	},
...
-----------48-48 Swamp of Sorrows
	...
	[4848] = {
		...
		items = {
			...
			[3] = { str = "02) Go to the #NPCFallen Hero of the Horde# #COORDS[34,66]# ... keep talking to him till you get this quest: #ACCEPT\"The Disgraced One\"# ", x = 34, y = 66, zone = "Searing Gorge" },
			[4] = { str = "03) Then go do #DOQUEST\"Cortello's Riddle\"# (#COORDS[22,48]# under the bridge)", x = 22, y = 48, zone = "Searing Gorge" },
			...
			[10] = { str = "09) Go do #DOQUEST\"The Swamp Talker\"# (in the cave at #COORDS[65,78]#)", x = 65, y = 78, zone = "Searing Gorge" },
			[11] = { str = "10) Then head north east and.." },
			[12] = { str = "11) Go kill the mob #NPCJarquia# (at around #COORDS[94,50]# or #COORDS[92,65]#), he drops #NPCGoodsteel's Balanced Flameberge#... for the quest #DOQUEST\"Ledger from Tanaris\"# ", x = 94, y = 50, zone = "Searing Gorge" },
			[13] = { str = "12) Then die on purpose, so you end up at Stonard." },
			[14] = { str = "13) Go to the #NPCFallen Hero of the Horde# #COORDS[34,66]# and turn in #TURNIN\"The Swamp Talker\"# ", x = 34, y = 66, zone = "Searing Gorge" },
			...
			[19] = { str = "18) Then head south and get the #NPCOverdue Package# for the quest #DOQUEST\"Ledger from Tanaris\"# at #COORDS[54,55]#", x = 54, y = 55, zone = "Dustwallow Marsh" },
			[20] = { str = "19) Go down a bit and do #DOQUEST\"The Brood of Onyxia\"#   (the eggs can be found at #COORDS[53,72]# and #COORDS[48,75]#)", x = 53, y = 72, zone = "Dustwallow Marsh" },
			[21] = { str = "20) Then head west to Bloodfen Burrow cave #COORDS[32,67]#, and do #DOQUEST\"Cortello's Riddle\"# ... accept the next part to it.", x = 32, y = 67, zone = "Dustwallow Marsh" },
...
--------48-49 Feralas
	...
	[4849] = {
		...
		items = {
			...
			[11] = { str = "10) go accept #ACCEPT\"Zapped Giants\"# at #COORDS[44,44]#" },
...
-----------49-50 Tanaris
	...
	[4950] = {
		...
		items = {
			...
			[5] = { str = "04) Go turn in #TURNIN\"The Sunken Temple\"# at #COORDS[52,45]# ... accept #ACCEPT\"The Stone Circle\"# and #ACCEPT\"Gahz'ridian\"# ", x = 52, y = 45, zone = "Tanaris" },
			[6] = { str = "05) Go do in the following order:" },
			[7] = { str = "06) #DOQUEST\"The Dunemaul Compound\"# along with #DOQUEST\"Gahz'ridian\"# (done at #COORDS[46,66]# and #COORDS[40,73]#, Gor'marok is in the cave at #COORDS[40,58]#)", x = 40, y = 58, zone = "Tanaris" },
			[8] = { str = "07) #DOQUEST\"Noxious Lair Investigation\"# #COORDS[34,47]#", x = 34, y = 47, zone = "Tanaris" },
			[9] = { str = "08) #DOQUEST\"Thistleshrub Valley\"# along with #DOQUEST\"The Thirsty Goblin\"# #COORDS[28,65]#", x = 28, y = 65, zone = "Tanaris" },
			[10] = { str = "09) #DOQUEST\"Tooga's Quest\"# (escort turtle quest starts in the Thistleshrub Valley, lead Tooga to Torta at #COORDS[66,25]#).", x = 66, y = 25, zone = "Tanaris" },
			...
			[17] = { str = "16) #DOQUEST\"Tanaris Field Sampling\"# and turn in #TURNIN\"Gahz'ridian\"# at #COORDS[52,45]#.", x = 52, y = 45, zone = "Tanaris" },
			[18] = { str = "17) #DOQUEST\"The Scrimshank Redemption\"#   (in the cave at #COORDS[53,70]#)  The secret for finding the item for this quest is keep making right turns in the cave and it will lead you to it.  ", x = 53, y = 70, zone = "Tanaris" },
			[19] = { str = "18) If the \"OOX-17/TN Distress Beacon\" item drops, accept the quest #ACCEPT\"Find OOX-17/TN!\"# " },
			[20] = { str = "19) Turn in #TURNIN\"Find OOX-17/TN!\"# at #COORDS[60,64]#", x = 60, y = 64, zone = "Tanaris" },
