...
-----------41-42 Swamp of Sorrows
	[4142] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 41 to 42 in #A_Swamp of Sorrows#." },
			...
			[6] = { str = "Grind to #A_Stonard# (#A_Swamp of Sorrows#) #C_[45,54]#.", x = 45, y = 54, zone = "Swamp of Sorrows" },
			[7] = { str = "Talk to the #N_Innkeeper# to make #A_Stonard# (#A_Swamp of Sorrows#) your home." },
			...
			[13] = { str = "#Q_'Lack of Surplus'# then turn it in at #C_[81,80]#. Accept #Q_'Lack of Surplus'#(2) and go do it.", x = 81, y = 80, zone = "Swamp of Sorrows" },
			...
			[16] = { str = "#Q_'Ongeku'#." },
			[17] = { str = "Turn in #Q_'Lack of Surplus'#(2). Accept #Q_'Threat From the Sea'#." },
...
-----------43-43 Desolace
	[4342] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through level 43 in #A_Desolace#." },
			...
			[3] = { str = "Talk to the #N_Innkeeper# to make #A_Shadowprey Village# (#A_Desolace#) your home." },
...
-----------43-43 Dustwallow Marsh
	[4343] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through level 43 Dustwallow Marsh." },
...
-----------43-44 Tanaris
	[4344] = {
		title = "43-44 Tanaris",
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 43 to 44 in #A_Tanaris#." },
			...
			[6] = { str = "Talk to the #N_Innkeeper# to make #A_Gadgetzan# (#A_Tanaris#) your home." },
...
-----------44-46 Feralas
	[4446] = {
		title = "44-46 Feralas",
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 44 to 46 in #A_Feralas#." },
			...
			[16] = { str = "PLEASE NOTE: If the #I_[OOX-22/FE Distress Beacon]# item drops, accept the quest #Q_'Find OOX-22/FE!'#. Turn in #Q_'Find OOX-22/FE!'# at #C_[53,55]#. Then go do:", x = 53, y = 55, zone = "Feralas" },
...
-----------46-46 Azshara
	[4646] = {
		title = "46-46 Azshara",
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through level 46 in #A_Azshara#." },
			...
			[12] = { str = "You can put the #I_[Field Testing Kit]# and the #I_[Box of Empty Vials]# in the Bank for now." },
...
-----------47-48 Searing Gorge
	[4748] = {
		...
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 47 to 48 in #A_Searing Gorge#." },
			...
			[24] = { str = "Unlock the flight path by talking to the #N_Flight Master# at #C_[65,25]#, and fly directly to #A_Stonard# (#A_Swamp of Sorrows#).", x = 65, y = 25, zone = "Searing Gorge" },
		}
	},
...
-----------48-48 Swamp of Sorrows
	[4848] = {
		...
		items = {
			...
			[6] = { str = "Go back to #A_Stonard# (#A_Swamp of Sorrows#)." },
...
--------48-49 Feralas
	[4849] = {
		title = "48-49 Feralas",
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 48 to 49 in #A_Feralas#." },
			...
			[4] = { str = "Talk to the #N_Innkeeper# to make #A_Camp Mojache# (#A_Feralas#) your home." },
			[5] = { str = "Go do #Q_'Hippogryph Muisek'#." },
			[6] = { str = "Ghen Use your #I_[Hearthstone]# to return to back to #A_Camp Mojache# (#A_Feralas#)." },
...
-----------49-50 Tanaris
	[4950] = {
		title = "49-50 Tanaris",
		items = {
			[1] = { str = "Welcome to Azeroth, friend! \nThis section of the VanillaGuide will guide you through levels 49 to 50 in #A_Tanaris#." },
			...
			[19] = { str = "If the #I_[OOX-17/TN Distress Beacon]# item drops, accept the quest #Q_'Find OOX-17/TN!'#." },
