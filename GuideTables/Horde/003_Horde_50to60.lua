...
-----------50-50 Azshara
	...
	[5049] = {
		...
		items = {
			...
			[3] = { str = "02) Go do:" },
			[4] = { str = "03) #DOQUEST\"Stealing Knowledge\"# (Done at the Ruins of Eldarath, #COORDS[36,54]#)", x = 36, y = 54, zone = "Azshara" },
			[5] = { str = "04) #DOQUEST\"Seeping Corruption\"# (Tide Pools are at: 1=#COORDS[47,61]#, 2=#COORDS[47,51]#, 3=#COORDS[48,48]#, 4=#COORDS[47,46]#)", x = 47, y = 61, zone = "Azshara" },
			[6] = { str = "05) Once their done, turn in #TURNIN\"Stealing Knowledge\"# ..accept ALL 4 delivery quests." },
			[7] = { str = "06) Turn in #TURNIN\"Delivery to Archmage Xylem\"# (there is a teleporter at #COORDS[28,50]#,#VIDEOSee Video#) ... accept #ACCEPT\"Xylem's Payment to Jediga\"# ", x = 28, y = 50, zone = "Azshara" },
			...
			[11] = { str = "10) Go turn in #TURNIN\"Rise of the Silithid\"# ... accept #ACCEPT\"March of the Silithid\"# at #COORDS[56,46]#", x = 56, y = 46, zone = "Azshara" },
			[12] = { str = "11) Turn in #TURNIN\"Delivery to Jes'rimon\"# at #COORDS[55,34]# ... accept #ACCEPT\"Jes'rimon's Payment to Jediga\"# and #ACCEPT\"Bone-Bladed Weapons\"# ", x = 55, y = 34, zone = "Azshara" },
			[13] = { str = "12) Then turn in #TURNIN\"Ripple Delivery\"# at #COORDS[59,36]#  (If you did the Hinterlands section)", x = 59, y = 36, zone = "Azshara" },
...
-----------50-50 Hinterlands
	...
	[5050] = {
		...
		items = {
			...
			[5] = { str = "08) #DOQUEST\"Cortello's Riddle\"# (at #COORDS[80,46]#, little chest in the water, 14 slot bag along with 8800 XP)", x = 80, y = 46, zone = "The Hinterlands" },
			[6] = { str = "09) #DOQUEST\"Lard Lost His Lunch\"# at #COORDS[84,42]#", x = 84, y = 42, zone = "The Hinterlands" },
			[7] = { str = "10) Then go turn in #TURNIN\"Snapjaws, Mon!\"# #TURNIN\"Gammerita, Mon!\"# and #TURNIN\"Lard Lost His Lunch\"# " },
			[8] = { str = "09) then go do #DOQUEST\"Sprinkle's Secret Ingredient\"# at #COORDS[41,60]#", x = 41, y = 60, zone = "The Hinterlands" },
...
------------50-51 Blasted Lands
	...
	[5051] = {
		...
		items = {
			...
			[24] = { str = "23) go turn in #TURNIN\"The Stone Circle\"# (at #COORDS[52,46]# in Tanaris)", x = 52, y = 46, zone = "Tanaris" },
...
-----------51-52 Un'Goro Crater
	...
	[5152] = {
		...
		items = {
			...
			[2] = { str = "01) Go accept: #ACCEPT\"The Apes of Un'Goro\"# and #ACCEPT\"The Fare of Lar'korwi\"# at #COORDS[71,75]#", x = 71, y = 75, zone = "Un'Goro Crater" },
			[3] = { str = "02) Go do #DOQUEST\"The Fare of Lar'korwi\"# at #COORDS[68,56]#", x = 68, y = 56, zone = "Un'Goro Crater" },
			[4] = { str = "03) Then go start doing: #DOQUEST\"Super Sticky\"# (up north in the middle) until this item drops #NPCA Mangled Journal#" },
			[5] = { str = "04) Then go into Marshal's Refuge at #COORDS[43,10]#, accept ALL quests there:  #ACCEPT\"Chasing A-Me 01\"# #ACCEPT\"Shizzle's Flyer\"# #ACCEPT\"Lost!\"# #ACCEPT\"Beware of Pterrordax\"# #ACCEPT\"Roll the Bones\"# #ACCEPT\"Alien Ecology\"# #ACCEPT\"Expedition Salvation\"# #ACCEPT\"Larion and Muigin\"# ", x = 43, y = 10, zone = "Un'Goro Crater" },
			...
			[11] = { str = "10) #DOQUEST\"The Apes of Un'Goro\"# along with #DOQUEST\"Chasing A-Me 01\"# (if you have a #NPCmithril casing# do the escort) at #COORDS[63,17]#", x = 63, y = 17, zone = "Un'Goro Crater" },
			...
			[15] = { str = "14) #DOQUEST\"Expedition Salvation\"# (#COORDS[68,36]# and #COORDS[38,65]#)", x = 68, y = 36, zone = "Un'Goro Crater" },
			...
			[21] = { str = "20) #ACCEPT\"It's a Secret to Everybody\"# ... click on boat and then bag under water at #COORDS[63,68]#", x = 63, y = 68, zone = "Un'Goro Crater" },
			[22] = { str = "21) Then turn in #TURNIN\"The Scent of Lar'korwi\"# ... accept #ACCEPT\"The Bait for Lar'korwi\"# at #COORDS[71,75]#", x = 71, y = 75, zone = "Un'Goro Crater" },
			[23] = { str = "22) Then go do #DOQUEST\"Alien Ecology\"# along with #DOQUEST\"Bungle in the Jungle\"# at #COORDS[50,80]#", x = 50, y = 80, zone = "Un'Goro Crater" },
			[24] = { str = "23) Go accept #ACCEPT\"Finding the Source\"# at #COORDS[30,50]#, then do it along with #DOQUEST\"Volcanic Activity\"# ", x = 30, y = 50, zone = "Un'Goro Crater" },
			...
			[29] = { str = "28) #DOQUEST\"The Northern Pylon\"# at #COORDS[56,13]#", x = 56, y = 13, zone = "Un'Goro Crater" },
			[30] = { str = "29) #DOQUEST\"The Mighty U'cha\"# (cave at #COORDS[63,13]#)", x = 63, y = 13, zone = "Un'Goro Crater" },
			[31] = { str = "30) #DOQUEST\"The Eastern Pylon\"# at #COORDS[77,50]#", x = 77, y = 50, zone = "Un'Goro Crater" },
			[32] = { str = "31) #DOQUEST\"The Bait for Lar'korwi\"# at #COORDS[80,50]#.  Then turn it in along with #TURNIN\"The Mighty U'cha\"# at #COORDS[71,75]#", x = 71, y = 75, zone = "Un'Goro Crater" },
			[33] = { str = "32) Go west killing oozes along the way.." },
			[34] = { str = "33) Turn in #TURNIN\"Finding the Source\"# ... accept #ACCEPT\"The New Springs\"# at #COORDS[30,50]#", x = 30, y = 50, zone = "Un'Goro Crater" },
			[35] = { str = "34) #DOQUEST\"The Western Pylon\"# at #COORDS[23,58]#", x = 23, y = 58, zone = "Un'Goro Crater" },
...
-----------52-53 Burning Steppes
	...
	[5253] = {
		...
		items = {
			...
			[5] = { str = "04) #DOQUEST\"Dreadmaul Rock\"# at #COORDS[79,45]#... then #DOQUEST\"Krom'Grul\"# (Krom'Grul has 2 different spawn points, in either cave)", x = 79, y = 45, zone = "Burning Steppes" },
			[6] = { str = "05) #DOQUEST\"The Rise of the Machines\"# " },
			[7] = { str = "06) #DOQUEST\"Tablet of the Seven\"# (it's at #COORDS[54,40]#)", x = 54, y = 40, zone = "Burning Steppes" },
			...
			[12] = { str = "11) Go turn in #TURNIN\"The Rise of the Machines\"# part2 (at #COORDS[25,46]# in Badlands)", x = 25, y = 46, zone = "Badlands" },
			[13] = { str = "12) Then hearth to XRs." },
			[14] = { str = "13) Then fly to Orgrimmar and make it your home." },
			[15] = { str = "14) Go turn in #TURNIN\"Bone-Bladed Weapons\"# at #COORDS[55,34]#", x = 55, y = 34, zone = "Orgrimmar" },
...
--------------53-54 Azshara
	...
	[5354] = {
		...
		items = {
			...
			[3] = { str = "02) go turn in #TURNIN\"The Hunter's Charm\"# (this is a hunter only quest, at #COORDS[41,42]#) ... accept #ACCEPT\"Courser Antlers\"# " },
			[4] = { str = "03) go accept #ACCEPT\"Kim'jael Indeed!\"# (at #COORDS[52,22]# on top of the hill)", x = 52, y = 22, zone = "Azshara" },
			[5] = { str = "04) then go do:" },
...
-----------54-54 Felwood
	...
	[5454] = {
		...
		items = {
			[1] = { str = "54-54 Felwood" },
			[2] = { str = "01) Accept #ACCEPT\"Timbermaw Ally\"# at #COORDS[50,85]# (??? TBC Quest?) Just talk to the NPC there he will give it to you.", x = 50, y = 85, zone = "Felwood" },
			[3] = { str = "02) Go accept #ACCEPT\"Forces of Jaedenar\"# and #ACCEPT\"Verifying the Corruption\"# (at the Emerald Sanctuary #COORDS[51,82]#).", x = 51, y = 82, zone = "Felwood" },
			[4] = { str = "03) Go accept #ACCEPT\"Cleansing Felwood\"# at #COORDS[46,84]#", x = 46, y = 84, zone = "Felwood" },
			[5] = { str = "04) I start killing oozes, I make sure I kill about 30/40 oozes here total for the quest #DOQUEST\"A Sample of Slime...\"# at #COORDS[40,68]#", x = 40, y = 68, zone = "Felwood" },
			[6] = { str = "05) Then go complete #DOQUEST\"Forces of Jaedenar\"# at #COORDS[38,60]#", x = 38, y = 60, zone = "Felwood" },
			[7] = { str = "06) Then go to BloodVenom Post. at #COORDS[34,52]#", x = 34, y = 52, zone = "Felwood" },
			...
			[11] = { str = "10) #DOQUEST\"Verifying the Corruption\"# (Elite) at #COORDS[41,41]#", x = 41, y = 41, zone = "Felwood" },
			[12] = { str = "11) #DOQUEST\"Cleansing Felwood\"# at #COORDS[54,16]#", x = 54, y = 16, zone = "Felwood" },
			[13] = { str = "12) Go accept #ACCEPT\"Deadwood of the North\"# at #COORDS[64,8]# but DON'T do it now.", x = 64, y = 8, zone = "Felwood" },
...
-----------54-55 Winterspring
	...
	[5455] = {
		...
		items = {
			...
			[3] = { str = "02) Go to Donova Snowden at #COORDS[31,45]#", x = 31, y = 45, zone = "Winterspring" },
			...
			[6] = { str = "05) Go to Everlook.. at #COORDS[61,38]#", x = 61, y = 38, zone = "Winterspring" },
			...
			[12] = { str = "11) Go do #DOQUEST\"Brumeran of the Chillwind\"# (he patrols around #COORDS[60,60]#, see map for complete patrol path)", x = 60, y = 60, zone = "Winterspring" },
			[13] = { str = "12) Then go Discover Darkwhisper Gorge at #COORDS[59,73]# for the quest #DOQUEST\"Strange Sources\"# ", x = 59, y = 73, zone = "Winterspring" },
			...
			[20] = { str = "19) #DOQUEST\"Chillwind Horns\"# (you can find a larger concentration of chimaera around #COORDS[66,29]#)", x = 66, y = 29, zone = "Winterspring" },
			[21] = { str = "20) Once #DOQUEST\"Threat of the Winterfall\"# and #DOQUEST\"Winterfall Firewater\"# is completed go turn them in along with #TURNIN\"Strange Sources\"# at #COORDS[31,45]#... accept #ACCEPT\"Falling to Corruption\"# ", x = 31, y = 45, zone = "Winterspring" },
			...
			[24] = { str = "23) #DOQUEST\"Winterfall Activity\"# at #COORDS[67,37]#", x = 67, y = 37, zone = "Winterspring" },
			[25] = { str = "24) #DOQUEST\"Are We There, Yeti?\"# (find 2 Pristine Yeti Horns) at #COORDS[66,43]#", x = 66, y = 43, zone = "Winterspring" },
...
-----------55-55 Felwood
	...
	[5554] = {
		...
		items = {
			...
			[3] = { str = "02) Go turn in #TURNIN\"Cleansing Felwood\"# ... then get a cenarion beacon for the quest #DOQUEST\"Salve Via Hunting\"# (just talk to the NPC to get it) at #COORDS[46,83]#", x = 46, y = 83, zone = "Felwood" },
			[4] = { str = "03) Go turn in #TURNIN\"Verifying the Corruption\"# and #TURNIN\"Forces of Jaedenar\"# ... accept #ACCEPT\"Collection of the Corrupt Water\"# at #COORDS[51,82]#", x = 51, y = 82, zone = "Felwood" },
			[5] = { str = "04) Go do in the following order:" },
			[6] = { str = "05) Go do #DOQUEST\"A Husband's Last Battle\"# along with #DOQUEST\"Timbermaw Ally\"# at #COORDS[48,94]#", x = 48, y = 94, zone = "Felwood" },
			[7] = { str = "06) Once they are done go turn in #TURNIN\"Timbermaw Ally\"# at #COORDS[50,85]# ... accept #ACCEPT\"Speak to Nafien\"#", x = 50, y = 85, zone = "Winterspring" },
			[8] = { str = "07) Go do #DOQUEST\"Well of Corruption\"# at #COORDS[32,66]#.  Also make sure you collect 6 #NPCCorrupted Soul Shards# for the quest #DOQUEST\"Salve Via Hunting\"# ", x = 32, y = 66, zone = "Felwood" },
			[9] = { str = "08) #DOQUEST\"Collection of the Corrupt Water\"# at #COORDS[35,59]#", x = 35, y = 59, zone = "Felwood" },
			...
			[12] = { str = "11) Go turn in #TURNIN\"Salve Via Hunting\"# (the 6 Corrupted Soul Shards) at #COORDS[46,83]#", x = 46, y = 83, zone = "Felwood" },
			[13] = { str = "12) Go turn in #TURNIN\"Collection of the Corrupt Water\"# ... I SKIP \"#NPCSeeking Spiritual Aid\"# at #COORDS[51,82]# ", x = 51, y = 82, zone = "Felwood" },
			[14] = { str = "13) Go do #DOQUEST\"Corrupted Sabers\"# at #COORDS[32,66]# then go turn it in.  (NOTE: when you turn it in, you have to talk to the cat first once you get to the NPC)", x = 32, y = 66, zone = "Felwood" },
			[15] = { str = "14) Then go up north and do:" },
			[16] = { str = "15) #DOQUEST\"Deadwood of the North\"# at #COORDS[61,9]#  When the \"Deadwood Ritual Totem\" item drops, save it and put it in your bank when you get a chance, you will need it later.", x = 61, y = 9, zone = "Felwood" },
			[17] = { str = "16) #DOQUEST\"Falling to Corruption\"# (the cauldron at #COORDS[60,5]#) (hint: I have my pet distract the mobs, while doing this quest)   ... then accept #ACCEPT\"Mystery Goo\"# ", x = 60, y = 5, zone = "Felwood" },
			[18] = { str = "17) Go turn in #TURNIN\"Deadwood of the North\"# at #COORDS[64,8]# ... accept #ACCEPT\"Speak to Salfa\"# .  And turn in #TURNIN\"Speak to Nafien\"# ", x = 64, y = 8, zone = "Felwood" },
			...
			[21] = { str = "20) Then go turn in #TURNIN\"Mystery Goo\"# (at #COORDS[31,45]# in Winterspring) ... SKIP \"#NPCToxic Horrors\"# ", x = 31, y = 45, zone = "Winterspring" },
...
------------55-55 Silithus
	...
	[5555] = {
		...
		items = {
			...
			[10] = { str = "09) go do:" },
			[11] = { str = "10) #DOQUEST\"Noggle's Lost Satchel\"# (it's at around #COORDS[40,90]#)", x = 40, y = 90, zone = "Silithus" },
			...
			[13] = { str = "12) #DOQUEST\"The Deserter\"# (he's in the cave at #COORDS[67,71]#) ... i SKIP #NPC\"The Twilight Lexicon\"# ", x = 67, y = 71, zone = "Silithus" },
...
-----------55-56 Western Plaguelands
	...
	[5556] = {
		...
		items = {
			...
			[7] = { str = "06) Go into the Western Plaguelands (Felstone field at #COORDS[37,56]#) and...", x = 37, y = 56, zone = "Western Plaguelands" },
			...
			[11] = { str = "10) Go do #DOQUEST\"Scarlet Diversions\"# (burn the tent down, and plant the banner, #COORDS[40,51]#)  ", x = 40, y = 51, zone = "Western Plaguelands" },
...
-----------56-57 Eastern Plaguelands
	...
	[5657] = {
		...
		items = {
			...
			[2] = { str = "01) Go accept: #ACCEPT\"Demon Dogs\"# #ACCEPT\"Blood Tinged Skies\"# and #ACCEPT\"Carrion Grubbage\"# at #COORDS[7,43]#", x = 7, y = 43, zone = "Eastern Plaguelands" },
			[3] = { str = "02) Grind your way to at #COORDS[26,74]# and accept: #ACCEPT\"To Kill With Purpose\"# and #ACCEPT\"Un-Life's Little Annoyances\"# .  NOTE: I SKIP \"#NPCThe Ranger Lord's Behest\"# ", x = 26, y = 74, zone = "Eastern Plaguelands" },
			[4] = { str = "03) Go down in the crypt at The Undercroft at #COORDS[27,85]# and accept #ACCEPT\"Hameya's Plea\"# (the scroll on the ground). (??? TBC Quest?)", x = 27, y = 85, zone = "Eastern Plaguelands" },
			[5] = { str = "04) Grind your way to Darrowshire at #COORDS[36,90]# while doing these quests:", x = 36, y = 90, zone = "Eastern Plaguelands" },
			...
			[13] = { str = "12) Then go to Light's Hope Chapel at #COORDS[81,60]#", x = 81, y = 60, zone = "Eastern Plaguelands" },
			...
			[19] = { str = "18) #DOQUEST\"Hameya's Plea\"# at #COORDS[72,14]# (??? TBC Quest?)", x = 72, y = 14, zone = "Eastern Plaguelands" },
			...
			[24] = { str = "23) #DOQUEST\"Augustus' Receipt Book\"# (get this quest in the hut at #COORDS[13,34]#, the book is upstairs in the inn at #COORDS[15,33]#)", x = 15, y = 33, zone = "Eastern Plaguelands" },
			[25] = { str = "24) #DOQUEST\"The Restless Souls\"# (#NPCEgan# is in the hut at #COORDS[13,34]#) (The next part refers to Stratholme, which I skip)", x = 13, y = 34, zone = "Eastern Plaguelands" },
			[26] = { str = "25) Then go turn in: #TURNIN\"Augustus' Receipt Book\"# " },
			[27] = { str = "26) Grind your way through the cave at #COORDS[15,29]# (watch out it is not easy) ", x = 15, y = 29, zone = "Eastern Plaguelands" },
			...
			[29] = { str = "27) Then go turn in: #TURNIN\"To Kill With Purpose\"# and #TURNIN\"Un-Life's Little Annoyances\"# at #COORDS[26,74]#", x = 26, y = 74, zone = "Eastern Plaguelands" },
			[30] = { str = "28) Then go do #DOQUEST\"Zaeldarr the Outcast\"# at #COORDS[27,85]#", x = 27, y = 85, zone = "Eastern Plaguelands" },
...
-----------57-58 Western Plaguelands
	...
	[5758] = {
		...
		items = {
			...
			[3] = { str = "02) Go turn in #TURNIN\"Good Luck Charm\"# ...accept #ACCEPT\"Two Halves Become One\"# (the lady in the house at #COORDS[37,56]#)", x = 37, y = 56, zone = "Western Plaguelands" },
			...
			[5] = { str = "04) Then do #DOQUEST\"A Plague Upon Thee\"# part2 ... accept #ACCEPT\"A Plague Upon Thee\"# part3 (this is all done at #COORDS[48,31]#)  " },
			[6] = { str = "05) Then go accept #ACCEPT\"Unfinished Business\"# part1 at #COORDS[51,28]#, then do it. (the mobs for this quest are at #COORDS[50,42]# and #COORDS[53,44]#)", x = 51, y = 28, zone = "Western Plaguelands" },
			[7] = { str = "06) Turn in #TURNIN\"Unfinished Business\"# part1 (back at #COORDS[51,28]#) ... accept #ACCEPT\"Unfinished Business\"# part2, then go do it. The 2 mobs for this quest are at (#COORDS[57,37]# and #COORDS[54,24]#).", x = 55, y = 30, zone = "Western Plaguelands" },
			[8] = { str = "07) Turn in #TURNIN\"Unfinished Business\"# part2 (back at #COORDS[51,28]#) ... accept #ACCEPT\"Unfinished Business\"# part3, then go do it. Need to go up in the tower at #COORDS[45,19]# in a certain spot, watch out for Elites.", x = 51, y = 28, zone = "Western Plaguelands" },
			[9] = { str = "08) Then turn in #TURNIN\"Unfinished Business\"# part3" },
			[10] = { str = "09) Then go complete and turn in #TURNIN\"The Wildlife Suffers Too\"# ... accept  #ACCEPT\"The Wildlife Suffers Too\"# part2 at #COORDS[53,64]#", x = 53, y = 64, zone = "Western Plaguelands" },
			[11] = { str = "10) Do #DOQUEST\"The Wildlife Suffers Too\"# part2, then turn it in ... accept #ACCEPT\"Glyphed Oaken Branch\"# " },
			[12] = { str = "11) Go turn in #TURNIN\"Auntie Marlene\"# (in the house at #COORDS[49,78]#)  ...accept #ACCEPT\"A Strange Historian\"# ", x = 49, y = 78, zone = "Western Plaguelands" },
			[13] = { str = "12) Go get the ring for #DOQUEST\"A Strange Historian\"# (the ring is out in the graveyard)" },
			[14] = { str = "13) Go into Andorhal.." },
			[15] = { str = "14) Do #DOQUEST\"All Along the Watchtowers\"# while working your way to the inn at #COORDS[39,66]#", x = 39, y = 66, zone = "Western Plaguelands" },
			[16] = { str = "15) Turn in #TURNIN\"A Strange Historian\"# (at #NPCChromie# up stairs in the inn at #COORDS[39,68]#) ... accept #ACCEPT\"The Annals of Darrowshire\"# and #ACCEPT\"A Matter of Time\"# ", x = 39, y = 68, zone = "Western Plaguelands" },
			[17] = { str = "16) Then go do (while grinding away at mobs):" },
			[18] = { str = "17) #DOQUEST\"All Along the Watchtowers\"# (Elite) " },
			[19] = { str = "18) #DOQUEST\"A Matter of Time\"# at #COORDS[47,62]#", x = 47, y = 62, zone = "Western Plaguelands" },
			[20] = { str = "19) #DOQUEST\"The Annals of Darrowshire\"# the book for this is in the building at #COORDS[42,67]#, the actual Annals of Darrowshire book looks different from the others, it has a lighter tint on the top portion of the pages in the book, unlike the rest which has a darker tint on the top portion of the pages.", x = 42, y = 67, zone = "Western Plaguelands" },
