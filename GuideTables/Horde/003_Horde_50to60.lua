...
-----------50-50 Azshara
	[5049] = {
		...
		items = {
			...
			[3] = { str = "Go do:" },
			[4] = { str = "#DOQUEST\"Stealing Knowledge\"# (Done at the Ruins of Eldarath, #COORDS[36,54]#)", x = 36, y = 54, zone = "Azshara" },
			[5] = { str = "#DOQUEST\"Seeping Corruption\"# (Tide Pools are at: 1=#COORDS[47,61]#, 2=#COORDS[47,51]#, 3=#COORDS[48,48]#, 4=#COORDS[47,46]#)", x = 47, y = 61, zone = "Azshara" },
			[6] = { str = "Once their done, turn in #TURNIN\"Stealing Knowledge\"# ..accept ALL 4 delivery quests." },
			[7] = { str = "Turn in #TURNIN\"Delivery to Archmage Xylem\"# (there is a teleporter at #COORDS[28,50]#,#VIDEOSee Video#) ... accept #ACCEPT\"Xylem's Payment to Jediga\"# ", x = 28, y = 50, zone = "Azshara" },
...
-----------50-50 Hinterlands
	[5050] = {
		...
		items = {
			...
			[4] = { str = "#DOQUEST\"Snapjaws, Mon!\"# along with #DOQUEST\"Gammerita, Mon!\"# and #DOQUEST\"Whiskey Slim's Lost Grog\"# " },
			[5] = { str = "#DOQUEST\"Cortello's Riddle\"# (at #COORDS[80,46]#, little chest in the water, 14 slot bag along with 8800 XP)", x = 80, y = 46, zone = "The Hinterlands" },
			[6] = { str = "#DOQUEST\"Lard Lost His Lunch\"# at #COORDS[84,42]#", x = 84, y = 42, zone = "The Hinterlands" },
			[7] = { str = "Then go turn in #TURNIN\"Snapjaws, Mon!\"# #TURNIN\"Gammerita, Mon!\"# and #TURNIN\"Lard Lost His Lunch\"# " },
			...
			[15] = { str = "pick up the \"#NPCStone Circle#\" at Liv Rizzlefix shop ... also accept #ACCEPT\"Volcanic Activity\"# while your there." },
...
------------50-51 Blasted Lands
	[5051] = {
		...
		items = {
			...
			[3] = { str = "#DOQUEST\"A Boar's Vitality\"# " },
			[4] = { str = "#DOQUEST\"Snickerfang Jowls\"# " },
			[5] = { str = "#DOQUEST\"The Basilisk's Bite\"# " },
			[6] = { str = "#DOQUEST\"The Decisive Striker\"# " },
			[7] = { str = "#DOQUEST\"Vulture's Vigor\"# " },
			...
			[15] = { str = "If an \"#NPCImperfect Draenethyst Fragment\" drops turn in for this quest: #TURNIN\"Everything Counts In Large Amounts\"# " },
			[16] = { str = "NOTE: I have NEVER found a \"#NPCFlawless Draenethyst Sphere#\" for the quest #TURNIN\"To Serve Kum'isha\"# ..good luck on that." },
			...
			[24] = { str = "go turn in #TURNIN\"The Stone Circle\"# (at #COORDS[52,46]# in Tanaris)", x = 52, y = 46, zone = "Tanaris" },
...
-----------51-52 Un'Goro Crater
	[5152] = {
		...
		items = {
			...
			[14] = { str = "#DOQUEST\"Roll the Bones\"# " },
			[15] = { str = "#DOQUEST\"Expedition Salvation\"# (#COORDS[68,36]# and #COORDS[38,65]#)", x = 68, y = 36, zone = "Un'Goro Crater" },
			[16] = { str = "#DOQUEST\"... and a Batch of Ooze\"# (I make sure I get at least 30 ooze samples)" },
			[17] = { str = "Go turn in #TURNIN\"The Apes of Un'Goro\"# ... accept #ACCEPT\"The Mighty U'cha\"# " },
			...
			[37] = { str = "Turn in quests. make sure you complete #DOQUEST\"Making Sense of It\"# (just talk to the gnome in the cave)" },
...
-----------52-53 Burning Steppes
	[5253] = {
		...
		items = {
			...
			[3] = { str = "Then go do:" },
			[4] = { str = "#DOQUEST\"Broodling Essence\"# (to the east) (also kill as many dragon whelps you see, their \"squishy\" mobs that die real fast)" },
			[5] = { str = "#DOQUEST\"Dreadmaul Rock\"# at #COORDS[79,45]#... then #DOQUEST\"Krom'Grul\"# (Krom'Grul has 2 different spawn points, in either cave)", x = 79, y = 45, zone = "Burning Steppes" },
			[6] = { str = "#DOQUEST\"The Rise of the Machines\"# " },
			[7] = { str = "#DOQUEST\"Tablet of the Seven\"# (it's at #COORDS[54,40]#)", x = 54, y = 40, zone = "Burning Steppes" },
			...
			[15] = { str = "Go turn in #TURNIN\"Bone-Bladed Weapons\"# at #COORDS[55,34]#", x = 55, y = 34, zone = "Orgrimmar" },
			[16] = { str = "Fly Azshara..." },
		}
	},
...
--------------53-54 Azshara
	[5354] = {
		...
		items = {
			...
			[3] = { str = "go turn in #TURNIN\"The Hunter's Charm\"# (this is a hunter only quest, at #COORDS[41,42]#) ... accept #ACCEPT\"Courser Antlers\"# " },
			[4] = { str = "go accept #ACCEPT\"Kim'jael Indeed!\"# (at #COORDS[52,22]# on top of the hill)", x = 52, y = 22, zone = "Azshara" },
			[5] = { str = "then go do:" },
			[6] = { str = "#DOQUEST\"Courser Antlers\"# " },
			[7] = { str = "#DOQUEST\"Betrayed\"# " },
			...
			[14] = { str = "#DOQUEST\"Wavethrashing\"# " },
			[15] = { str = "Once both are done, Hearth to Orgrimmar." },
			[16] = { str = "then Fly to Azshara.." },
			[17] = { str = "turn in #TURNIN\"Betrayed\"# ... accept #ACCEPT\"Betrayed\"# " },
...
-----------54-54 Felwood
	[5454] = {
		...
		items = {
			...
			[3] = { str = "Go accept #ACCEPT\"Forces of Jaedenar\"# and #ACCEPT\"Verifying the Corruption\"# (at the Emerald Sanctuary #COORDS[51,82]#).", x = 51, y = 82, zone = "Felwood" },
			[4] = { str = "Go accept #ACCEPT\"Cleansing Felwood\"# at #COORDS[46,84]#", x = 46, y = 84, zone = "Felwood" },
			[5] = { str = "I start killing oozes, I make sure I kill about 30/40 oozes here total for the quest #DOQUEST\"A Sample of Slime...\"# at #COORDS[40,68]#", x = 40, y = 68, zone = "Felwood" },
			[6] = { str = "Then go complete #DOQUEST\"Forces of Jaedenar\"# at #COORDS[38,60]#", x = 38, y = 60, zone = "Felwood" },
			[7] = { str = "Then go to BloodVenom Post. at #COORDS[34,52]#", x = 34, y = 52, zone = "Felwood" },
...
-----------54-55 Winterspring
	[5455] = {
		...
		items = {
			...
			[3] = { str = "Go to Donova Snowden at #COORDS[31,45]#", x = 31, y = 45, zone = "Winterspring" },
			[4] = { str = "Turn in #TURNIN\"The New Springs\"# and #TURNIN\"It's a Secret to Everybody\"# and accept #ACCEPT\"Strange Sources\"#" },
			[5] = { str = "NOTE: I SKIP \"#NPCThe Videre Elixir\"# and the rest of that chain." },
			[6] = { str = "Go to Everlook.. at #COORDS[61,38]#", x = 61, y = 38, zone = "Winterspring" },
			...
			[26] = { str = "Then hearth to Everlook and accept #ACCEPT\"A Strange One \"#" },
			[27] = { str = "Go turn in #TURNIN\"Are We There, Yeti?\"# ... accept #ACCEPT\"Are We There, Yeti?\"# part3" },
			[28] = { str = "go scare Legacki with the mechanical yeti for the quest #DOQUEST\"Are We There, Yeti?\"# part3" },
...
-----------55-55 Felwood
	[5554] = {
		...
		items = {
			...
			[3] = { str = "Go turn in #TURNIN\"Cleansing Felwood\"# ... then get a cenarion beacon for the quest #DOQUEST\"Salve Via Hunting\"# (just talk to the NPC to get it) at #COORDS[46,83]#", x = 46, y = 83, zone = "Felwood" },
			[4] = { str = "Go turn in #TURNIN\"Verifying the Corruption\"# and #TURNIN\"Forces of Jaedenar\"# ... accept #ACCEPT\"Collection of the Corrupt Water\"# at #COORDS[51,82]#", x = 51, y = 82, zone = "Felwood" },
			...
			[24] = { str = "If you happen to see #NPCWarcaller Gorlach#, accept #ACCEPT\"A Call To Arms: The Plaguelands!\"# " },
			[25] = { str = "Fly to Thunder Bluff, then directly to Camp Mojache, Ferelas" },
			[26] = { str = "Turn in #TURNIN\"The Strength of Corruption\"# " },
			[27] = { str = "Then fly to Tanaris..." },
			[28] = { str = "Go scare #NPCSprinkle# with the mechanical yeti for the quest #DOQUEST\"Are We There, Yeti?\"# part3" },
...
------------55-55 Silithus
	[5555] = {
		...
		items = {
			...
			[3] = { str = "go do: #DOQUEST\"Securing the Supply Lines\"# and #DOQUEST\"Deadly Desert Venom\"# (do these 2 quests northeast of Cenarion Hold)" },
			[4] = { str = "then turn them in and accept new quests." },
			[5] = { str = "then go do:" },
			[6] = { str = "#DOQUEST\"Stepping Up Security\"# " },
			[7] = { str = "#DOQUEST\"The Twilight Mystery\"# " },
			...
			[15] = { str = "turn in #TURNIN\"Noggle's Lost Satchel\"# " },
			[16] = { str = "then go to Marshal's Refuge in Un'Goro Crater." },
			[17] = { str = "go scare Quixxil with the mechanical yeti for the quest #DOQUEST\"Are We There, Yeti?\"# part3" },
...
-----------55-56 Western Plaguelands
	[5556] = {
		...
		items = {
			...
			[4] = { str = "Turn in #TURNIN\"The Everlook Report\"# " },
			[5] = { str = "Accept and complete #DOQUEST\"Argent Dawn Commission\"# " },
			[6] = { str = "Accept #ACCEPT\"A Plague Upon Thee\"# " },
			[7] = { str = "Go into the Western Plaguelands (Felstone field at #COORDS[37,56]#) and...", x = 37, y = 56, zone = "Western Plaguelands" },
...
-----------56-57 Eastern Plaguelands
	[5657] = {
		...
		items = {
			...
			[7] = { str = "#DOQUEST\"Blood Tinged Skies\"# " },
			...
			[24] = { str = "#DOQUEST\"Augustus' Receipt Book\"# (get this quest in the hut at #COORDS[13,34]#, the book is upstairs in the inn at #COORDS[15,33]#)", x = 15, y = 33, zone = "Eastern Plaguelands" },
			...
			[34] = { str = "Turn in #TURNIN\"Better Late Than Never\"# ... accept #ACCEPT\"The Jeremiah Blues\"# " },
			[35] = { str = "Turn in #TURNIN\"The Jeremiah Blues\"# (just right underneath the bank) ... accept #ACCEPT\"Good Luck Charm\"# " },
...
-----------57-58 Western Plaguelands
	[5758] = {
		...
		items = {
			...
			[16] = { str = "Turn in #TURNIN\"A Strange Historian\"# (at #NPCChromie# up stairs in the inn at #COORDS[39,68]#) ... accept #ACCEPT\"The Annals of Darrowshire\"# and #ACCEPT\"A Matter of Time\"# ", x = 39, y = 68, zone = "Western Plaguelands" },
			...
			[24] = { str = "Turn in #TURNIN\"A Plague Upon Thee\"# part3" },
			[25] = { str = "Turn in #TURNIN\"All Along the Watchtowers\"# ... accept #ACCEPT\"Scholomance\"# " },
			[26] = { str = "Turn in #TURNIN\"Scholomance\"# at the undead guy right next to him ... accept #ACCEPT\"Skeletal Fragments\"# " },
...
------------58-60 Winterspring
	[5860] = {
		...
		items = {
			...
			[4] = { str = "turn in #TURNIN\"Are We There, Yeti?\"# part3" },
			[5] = { str = "accept: #ACCEPT\"Luck Be With You\"# (Elite) and #ACCEPT\"Ursius of the Shardtooth\"# (Elite)" },
			[6] = { str = "then go tame a Winterspring Screecher (for Claw Rank8) (head south to do this)" },
			[7] = { str = "then use that pet to do #DOQUEST\"Luck Be With You\"# (just use your pet to distract the giants while picking up the Frostmaul Shards)" },
			...
			[14] = { str = "#DOQUEST\"Wild Guardians\"# part2 (i grind away at owls at the Owl Wing Thicket for a few hours, before leaving here)" },
			[15] = { str = "then when im a few bars away from 59, i go back up to Everlook (DONT hearth).." },
			[16] = { str = "turn in #TURNIN\"Luck Be With You\"# and #TURNIN\"Brumeran of the Chillwind\"# ... i SKIP #NPC\"Shy-Rotam\"# (Elite)" },
			...
			[24] = { str = "turn in #TURNIN\"Wild Guardians\"# part3 and #TURNIN\"Guarding Secrets\"# ... accept #ACCEPT\"Guarding Secrets\"# part2" },
