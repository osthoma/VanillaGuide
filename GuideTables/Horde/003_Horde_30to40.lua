...
-----------30-30 Arathi Highlands
	...
	[3030] = {
		...
		items = {
			...
			[3] = { str = "02) #DOQUEST\"The Hammer May Fall\"# at #COORDS[34,45]#", x = 34, y = 45, zone = "Arathi Highlands" },
			[4] = { str = "03) Then run to Hammerfall at #COORDS[73,36]#", x = 73, y = 36, zone = "Arathi Highlands" },
			...
			[9] = { str = "08) Then do #DOQUEST\"Raising Spirits\"# (just to the left of Hammerfall all around #COORDS[64,37]#).  Then turn it in ... accept #ACCEPT\"Raising Spirits\"# part2", x = 64, y = 37, zone = "Arathi Highlands" },
...
-----------30-31 Stranglethorn Vale
	...
	[3031] = {
		...
		items = {
			...
			[3] = { str = "02) Go up north #COORDS[35,10]# and start doing the STV hunt quests:", x = 35, y = 10, zone = "Stranglethorn Vale" },
			[4] = { str = "03) #DOQUEST\"Welcome to the Jungle\"# (just accept this and turn in in right there)" },
			[5] = { str = "04) #DOQUEST\"Tiger Mastery\"# (#NPCYoung Stranglethorn Tigers#) #COORDS[33,10]#", x = 33, y = 10, zone = "Stranglethorn Vale" },
			[6] = { str = "05) #DOQUEST\"Panther Mastery\"# (#NPCYoung Panthers#) #COORDS[41,9]#", x = 41, y = 9, zone = "Stranglethorn Vale" },
			[7] = { str = "06) #DOQUEST\"Panther Mastery\"# (#NPCPanthers#) #COORDS[30,11]#", x = 30, y = 11, zone = "Stranglethorn Vale" },
			[8] = { str = "07) #DOQUEST\"Tiger Mastery\"# (#NPCStranglethorn Tigers#) #COORDS[30,10]#", x = 30, y = 11, zone = "Stranglethorn Vale" },
			[9] = { str = "08) #DOQUEST\"Raptor Mastery\"# (#NPCStranglethorn Raptors#) #COORDS[25,15]#", x = 25, y = 15, zone = "Stranglethorn Vale" },
			...
			[16] = { str = "15) Go east into Shimmering Flats at #COORDS[77,77]#...", x = 77, y = 77, zone = "Thousand Needles" },
			--[17] = { str = "." },
			--[18] = { str = "." },
		}
	},
...
-----------31-32 Thousand needles (Shimmering Flats)
	...
	[3132] = {
		...
		items = {
			...
			[17] = { str = "16) Go south into Tanaris to get FP in Gadgetzan at #COORDS[51,25]#", x = 51, y = 25, zone = "Tanaris" },
			[18] = { str = "17) Hearth to XRs." },
			[19] = { str = "18) Fly to Orgrimmar" },
			[20] = { str = "19) Turn in #TURNIN\"The Swarm Grows\"# at #COORDS[75,34]# ... accept #ACCEPT\"The Swarm Grows\"# part2", x = 75, y = 34, zone = "Orgrimmar" },
			[21] = { str = "20) Accept #ACCEPT\"Alliance Relations\"# (get it from Craven Drok in the Cleft of Shadow, #COORDS[47,50]#)", x = 47, y = 50, zone = "Orgrimmar" },
			[22] = { str = "21) Then go to #NPCKeldran# in Orgrimmar #COORDS[23,53]# to accept #ACCEPT\"Alliance Relations\"# part2.", x = 23, y = 53, zone = "Orgrimmar" },
...
-----------32-34 Desolace
	...
	[3234] = {
		...
		items = {
			...
			[2] = { str = "01) First thing to do here is start killing mobs at the Thunder Axe Fortress #COORDS[55,24]#...", x = 55, y = 24, zone = "Desolace" },
			...
			[5] = { str = "04) #DOQUEST\"Kodo Roundup\"# (starts at #COORDS[60,61]#) (don't have to finish all of it now)", x = 60, y = 61, zone = "Desolace" },
			[6] = { str = "05) Then go to Ghost Walker Post #COORDS[56,59]#", x = 56, y = 59, zone = "Desolace" },
			...
			[13] = { str = "12) #DOQUEST\"Befouled by Satyr\"# #COORDS[75,22]#  (Keep step #13 in mind)", x = 75, y = 22, zone = "Desolace" },
			[14] = { str = "13) #DOQUEST\"The Corrupter\"# Part2 (collect a Shadowstalker Scalp from a Hatefury shadowstalker)" },
			[15] = { str = "14) #DOQUEST\"Khan Dez'hepah\"# #COORDS[73,48]#", x = 73, y = 48, zone = "Desolace" },
			[16] = { str = "15) #DOQUEST\"Gelkis Alliance\"# #COORDS[68,71]#", x = 68, y = 71, zone = "Desolace" },
			[17] = { str = "16) Go back to Ghost Walker Post #COORDS[56,59]#, and turn in #TURNIN\"Khan Dez'hepah\"# .. accept #ACCEPT\"Centaur Bounty\"# .  Turn in #TURNIN\"Befouled by Satyr\"# .  Turn in #TURNIN\"The Corrupter\"# Part2 .. accept #ACCEPT\"The Corrupter\"# Part3.", x = 56, y = 59, zone = "Desolace" },
			[18] = { str = "17) Then run to Shadowprey Village (stopping along the way to turn this in: #TURNIN\"Gelkis Alliance\"# at #COORDS[36,79]#) ... accept #ACCEPT\"Stealing Supplies\"# ", x = 36, y = 79, zone = "Desolace" },
			[19] = { str = "18) Accept all quests at Shadowprey Village at #COORDS[24,71]#, which include:  #ACCEPT\"Hunting in Stranglethorn\"# #ACCEPT\"Hand of Iruxos\"# #ACCEPT\"Clam Bait\"# and #ACCEPT\"Other Fish to Fry\"# ", x = 24, y = 71, zone = "Desolace" },
			...
			[25] = { str = "24) Then accept #ACCEPT\"Claim Rackmore's Treasure!\"# (the chest/wrecked boat along the shore, #COORDS[36,30]#)  (the silver key is dropped by a drysnap, and the golden key is dropped by a Slitherblade)", x = 36, y = 30, zone = "Desolace" },
			[26] = { str = "25) Go accept #ACCEPT\"Sceptre of Light\"#   (the argent dawn dude, at #COORDS[38,27]#)", x = 38, y = 27, zone = "Desolace" },
			[27] = { str = "26) Then go do following at Thunder Axe Fortress #COORDS[54,29]#:", x = 54, y = 29, zone = "Desolace" },
			[28] = { str = "27) #DOQUEST\"The Burning of Spirits\"# " },
			[29] = { str = "28) #DOQUEST\"Sceptre of Light\"# " },
			[30] = { str = "29) #DOQUEST\"Hand of Iruxos\"# " },
			[31] = { str = "30) Then grind your way back to the argent dawn dude #COORDS[38,27]#...", x = 38, y = 27, zone = "Desolace" },
			...
			[36] = { str = "35) #DOQUEST\"Book of the Ancients\"# #COORDS[27,6]# ", x = 27, y = 6, zone = "Desolace" },
			...
			[39] = { str = "38) Then turn in #TURNIN\"Claim Rackmore's Treasure!\"# at the little chest #COORDS[29,8]#", x = 29, y = 8, zone = "Desolace" },
			[40] = { str = "39) Turn in #TURNIN\"Book of the Ancients\"# #COORDS[38,27]#", x = 38, y = 27, zone = "Desolace" },
			[41] = { str = "40) Then go accept #ACCEPT\"Bone Collector\"#   #COORDS[62,38]# (grinding mobs along the way)", x = 62, y = 38, zone = "Desolace" },
			[42] = { str = "41) Go to Ghost Walker Post #COORDS[56,59]#, turn in #TURNIN\"Catch of the Day\"# accept and turn in #TURNIN\"The Burning of Spirits\"# #TURNIN\"The Corrupter\"# Part3 .. accept and then turn in #TURNIN\"The Corrupter\"# Part4. Accept #ACCEPT\"Alliance Relations\"# Skip \"#NPCThe Corrupter\"# Part5.", x = 56, y = 59, zone = "Desolace" },
			[43] = { str = "43) Then go do:" },
			[44] = { str = "44) #DOQUEST\"Bone Collector\"# (done at the kodo graveyard, #COORDS[51,58]#)", x = 51, y = 58, zone = "Desolace" },
			[45] = { str = "45) Then #DOQUEST\"Centaur Bounty\"# and #DOQUEST\"Stealing Supplies\"# #COORDS[70,74]#", x = 70, y = 74, zone = "Desolace" },
			[46] = { str = "46) Then go turn in #TURNIN\"Centaur Bounty\"# #COORDS[56,59]#", x = 56, y = 59, zone = "Desolace" },
			[47] = { str = "47) Then turn in #TURNIN\"Bone Collector\"# #COORDS[62,38]#", x = 62, y = 38, zone = "Desolace" },
			...
			[51] = { str = "51) Turn in #TURNIN\"Stealing Supplies\"# #COORDS[36,79]# and accept #ACCEPT\"Ongeku\"# ", x = 36, y = 79, zone = "Desolace" },
			[52] = { str = "52) Fly to CT (In the Barrens). (the flight master is on the docks in Shadowprey Village)" },
			[53] = { str = "53) Once at CT, run south-east into Dustwallow Marsh (#COORDS[51,79]# in the Barrens).", x = 51, y = 79, zone = "The Barrens" },
			...
			[58] = { str = "58) Now run to Brackenwall Village #COORDS[35,29]#", x = 35, y = 29, zone = "Dustwallow Marsh" },
...
-----------34-35 Stranglethorn Vale
	...
	[3435] = {
		...
		items = {
			...
			[8] = { str = "07) #DOQUEST\"Singing Blue Shards\"# #COORDS[25,19]#", x = 25, y = 19, zone = "Stranglethorn Vale" },
			[9] = { str = "08) #DOQUEST\"Tiger Mastery\"# (#NPCElder Stranglethorn Tigers#) #COORDS[31,19]#", x = 31, y = 19, zone = "Stranglethorn Vale" },
			...
			[19] = { str = "18) #DOQUEST\"Headhunting\"# along with finishing up #DOQUEST\"Bloody Bone Necklaces\"# #COORDS[21,14]#", x = 21, y = 14, zone = "Stranglethorn Vale" },
			[20] = { str = "19) #DOQUEST\"The Vile Reef\"# along with #DOQUEST\"Encrusted Tail Fins\"# #COORDS[24,24]# Use a breath potion if you can.", x = 24, y = 24, zone = "Stranglethorn Vale" },
			[21] = { str = "20) Then go to Nesingwary's Expedition #COORDS[35,10]#... turn in ALL quests, accept all new ones (except \"#NPCThe Green Hills of Stranglethorn\"# ).  Then go do:", x = 35, y = 10, zone = "Stranglethorn Vale" },
			[22] = { str = "21) #DOQUEST\"Tiger Mastery\"# (#NPCSin'Dall#)  (he is usually on top of the hill at #COORDS[31,17]#).  Once that is done, go turn it in, then go do:", x = 31, y = 17, zone = "Stranglethorn Vale" },
			[23] = { str = "22) #DOQUEST\"Hostile Takeover\"# along with #DOQUEST\"Goblin Sponsorship\"# #COORDS[44,19]#", x = 44, y = 19, zone = "Stranglethorn Vale" },
			[24] = { str = "23) #DOQUEST\"Panther Mastery\"# along with #DOQUEST\"Mok'thardin's Enchantment\"# (kill #NPCshadowmaw panthers#) #COORDS[48,21]#", x = 48, y = 21, zone = "Stranglethorn Vale" },
			[25] = { str = "24) #DOQUEST\"The Defense of Grom'gol\"# part2 #COORDS[36,30]#, once that's done...", x = 36, y = 30, zone = "Stranglethorn Vale" },
			...
			[32] = { str = "31) Once in the UC, turn in 60 Silk Cloth for #TURNIN\"A Donation of Silk\"# quest at #COORDS[71,28]#.", x = 71, y = 28, zone = "Undercity" },
			[33] = { str = "32) Accept #ACCEPT\"To Steal From Thieves\"# #COORDS[63,49]#", x = 63, y = 49, zone = "Undercity" },
...
-----------35-37 Arathi Highlands
	...
	[3537] = {
		...
		items = {
			...
			[6] = { str = "05) Then go west of hammerfall and accept #ACCEPT\"The Princess Trapped\"# #COORDS[62,33]#", x = 62, y = 33, zone = "Arathi Highlands" },
			...
			[12] = { str = "11) Then do:" },
			[13] = { str = "12) #DOQUEST\"Stones of Binding\"# (first key, just west of hammerfall #COORDS[66,29]#)", x = 66, y = 29, zone = "Arathi Highlands" },
			[14] = { str = "13) Then do: #DOQUEST\"To Steal From Thieves\"# at #COORDS[54,40]#", x = 54, y = 40, zone = "Arathi Highlands" },
			[15] = { str = "14) Go down south a little and get the next key for #DOQUEST\"Stones of Binding\"# #COORDS[52,50]#", x = 52, y = 50, zone = "Arathi Highlands" },
			[16] = { str = "15) Then go down and do:" },
			[17] = { str = "16) #DOQUEST\"Call to Arms\"# (killing ogres) and #DOQUEST\"Guile of the Raptor\"# (killing Highland Fleshstalkers, around #COORDS[50,75]#)", x = 50, y = 75, zone = "Arathi Highlands" },
			[18] = { str = "17) Then go up and do #DOQUEST\"Foul Magics\"# at #COORDS[31,28]#", x = 31, y = 28, zone = "Arathi Highlands" },
			[19] = { str = "18) Then go west and get the last key for #DOQUEST\"Stones of Binding\"# #COORDS[25,31]#", x = 25, y = 31, zone = "Arathi Highlands" },
			[20] = { str = "19) Go discover Stromguard, and turn in #TURNIN\"Stones of Binding\"# (at the Circle of Inner Binding) #COORDS[36,57]#", x = 36, y = 57, zone = "Arathi Highlands" },
...
-----------37-37 Alterac Mountains
	...
	[3736] = {
		...
		items = {
			...
			[11] = { str = "10) Once in Orgrimmar, turn in #TURNIN\"Alliance Relations\"# at #NPCKeldran#. at #COORDS[21,53]#", x = 21, y = 53, zone = "Orgrimmar" },
...
-----------37-37 Thousand Needles
	...
	[3737] = {
		...
		items = {
			...
			[3] = { str = "02) Turn in #TURNIN\"The Swarm Grows\"# ... accept #ACCEPT\"The Swarm Grows\"# part2 #COORDS[67,63]#", x = 67, y = 63, zone = "Thousand Needles" },
			...
			[7] = { str = "06) #DOQUEST\"The Swarm Grows\"# and #DOQUEST\"Parts of the Swarm\"# (quest starts from an item drop) #COORDS[71,85]#", x = 71, y = 85, zone = "Thousand Needles" },
			[8] = { str = "07) Then go turn in #TURNIN\"The Swarm Grows\"# #COORDS[67,63]#", x = 67, y = 63, zone = "Thousand Needles" },
...
-----------37-38 Dustwallow Marsh
	...
	[3738] = {
		...
		items = {
			...
			[3] = { str = "02) go slightly south of Brackenwall Village and accept #ACCEPT\"Hungry!\"# (the ogre at #COORDS[35,37]#)", x = 35, y = 37, zone = "Dustwallow Marsh" },
			...
			[5] = { str = "04) #DOQUEST\"Theramore Spies\"#, #DOQUEST\"The Black Shield\"# #DOQUEST\"Hungry!\"#  (I do #DOQUEST\"Hungry!\"# at #COORDS[58,23]#)", x = 58, y = 23, zone = "Dustwallow Marsh" },
			[6] = { str = "05) I stop at Jarl's cabin #COORDS[55,25]# and get #ACCEPT\"The Lost Report\"# quest (the dirt mound next to his cabin)", x = 55, y = 25, zone = "Dustwallow Marsh" },
			[7] = { str = "06) and turn in #TURNIN\"Soothing Spices\"# ... accept #ACCEPT\"Jarl Needs Eyes\"#" },
			[8] = { str = "07) Go south at #COORDS[54,56]# to retrive the Seaforium Booster for Razzeric", x = 54, y = 56, zone = "Dustwallow Marsh" },
			[9] = { str = "08) go do #DOQUEST\"Jarl Needs Eyes\"# (while focusing on the others too)" },
			[10] = { str = "09) I do the escort quest: #DOQUEST\"Stinky's Escape\"# (starts at #COORDS[47,18]#) (grind mobs during this quest)", x = 47, y = 18, zone = "Dustwallow Marsh" },
			[11] = { str = "10) I'll stop at the big raptor spot at #COORDS[47,17]#, and grind it clear several times." , x = 47, y = 17, zone = "Dustwallow Marsh" },
			[12] = { str = "11) stop at Brackenwall Village and turn in all quests, accept new ones." },
			[13] = { str = "12) turn in #TURNIN\"Hungry!\"#" },
			[14] = { str = "13) stop back at Jarl's cabin at #COORDS[55,25]#, go to the dirt mound once again to get \"#NPCThe Severed Head#\"", x = 55, y = 25, zone = "Dustwallow Marsh" },
			...
			[18] = { str = "17) #DOQUEST\"The Theramore Docks\"# the Captain's Documents are under the water at #COORDS[71,51]#" , x = 71, y = 51, zone = "Dustwallow Marsh" },
...
-----------38-40 Stranglethorn Vale
	...
	[3840] = {
		...
		items = {
			...
			[7] = { str = "06) Go do:" },
			[8] = { str = "07) #DOQUEST\"Raptor Mastery\"# along with #DOQUEST\"Mok'thardin's Enchantment\"# #COORDS[31,41]#  (Kill #NPCJungle Stalkers#)", x = 31, y = 41, zone = "Stranglethorn Vale" },
			[9] = { str = "08) grind away at raptors/cold eye ballisks till level 39, then do:" },
			[10] = { str = "09) #DOQUEST\"Venture Company Mining\"# at #COORDS[40,42]#", x = 40, y = 42, zone = "Stranglethorn Vale" },
			...
			[12] = { str = "11) Then do #DOQUEST\"Panther Mastery\"# (#NPCBhag'thera#) (he has 3 different spawn points, either at #COORDS[48,20]#, #COORDS[49,23]#, or #COORDS[47,26]#)", x = 48, y = 20, zone = "Stranglethorn Vale" },
			[13] = { str = "12) Then turn in #TURNIN\"Panther Mastery\"# (#NPCBhag'thera#) and #TURNIN\"Raptor Mastery\"# (#NPCJungle Stalkers#) at Nesingwary's Expedition #COORDS[35,10]#", x = 35, y = 10, zone = "Stranglethorn Vale" },
			...
			[18] = { str = "17) #DOQUEST\"The Bloodsail Buccaneers\"# (just slightly north-west of BB at #COORDS[27,69]#, there's a little note on a barrel, click on it, accept new quest). ", x = 27, y = 69, zone = "Stranglethorn Vale" },
			[19] = { str = "18) #DOQUEST\"Scaring Shaky\"# along with #DOQUEST\"Mok'thardin's Enchantment\"# part3 #COORDS[32,66]#", x = 32, y = 66, zone = "Stranglethorn Vale" },
