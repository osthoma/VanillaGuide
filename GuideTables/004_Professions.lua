...
-----------1-300 Alchemy
	[7002] = {
		...
		items = {
			...
			[2] = { str = "#Q_Aprx. Mats Required#: #VIDEO60#x #I_[Peacebloom]# #VIDEO60#x #I_[Silverleaf]# #VIDEO75#x #I_[Empty Vial]# " ..
				"#VIDEO80#x #I_[Briarthorn]# #VIDEO30#x #I_[Bruiseweed]# #VIDEO65#x #I_[Leaded Vial]# " ..
				"#VIDEO15#x #I_[Mageroyal]# #VIDEO40#x #I_[Stranglekelp]# #VIDEO30#x #I_[Liferoot]# #VIDEO30#x #I_[Kingsblood]# " ..
				"#VIDEO45#x #I_[Goldthorn]# #VIDEO5#x #I_[Steelbloom]# #VIDEO70#x #I_[Sungrass]# " ..
				"#VIDEO15#x #I_[Khadgars Whisker]# #VIDEO90#x #I_[Crystal Vial]# #VIDEO20#x #I_[Arthas Tears]# " ..
				"#VIDEO40#x #I_[Blindweed]# #VIDEO40#x #I_[Golden Sansam]# #VIDEO40#x #I_[Mountain Silversage]# " },
...
-----------1-300 Blacksmithing
	[7003] = {
		...
		items = {
			...
			[2] = { str = "#Q_Aprx. Mats Required#: #VIDEO90#x #I_[Rough Stone]# #VIDEO380#x #I_[Copper Bar]# #VIDEO20#x #I_[Coarse Stone]# " ..
				"#VIDEO5#x #I_[Silver Bar]# #VIDEO120#x #I_[Bronze Bar]# #VIDEO150#x #I_[Heavy Stone]# " ..
				"#VIDEO5#x #I_[Gold Bar]# #VIDEO200#x #I_[Iron Bar]# #VIDEO30#x #I_[Green Dye]# " ..
				"#VIDEO380#x #I_[Steel Bar]# #VIDEO80#x #I_[Solid Stone]# #VIDEO230#x #I_[Mithril Bar]# " ..
				"#VIDEO20#x #I_[Dense Stone]# #VIDEO430#x #I_[Thorium Bar]# #VIDEO10#x #I_[Core of Earth]# " ..
				"#VIDEO90#x #I_[Mageweave Cloth]# #VIDEO60#x #I_[Rugged Leather]# " },
...
-----------1-300 Enchanting
	[7006] = {
		...
		items = {
			...
			"#VIDEO150#x #I_[Strange Dust]# #VIDEO90#x #I_[Soul Dust]# #VIDEO170#x #I_[Vision Dust]# " ..
			"#VIDEO300#x #I_[Dream Dust]# #VIDEO90#x #I_[Illusion Dust]# #VIDEO15#x #I_[Simple Wood]# " ..
			"#VIDEO15#x #I_[Lesser Magic Essence]# #VIDEO25#x #I_[Greater Magic Essence]# #VIDEO15#x #I_[Lesser Astral Essence]# " ..
			"#VIDEO2#x #I_[Greater Astral Essence]# #VIDEO25#x #I_[Lesser Mystic Essence]# #VIDEO2#x #I_[Greater Mystic Essence]# " ..
			"#VIDEO15#x #I_[Lesser Nether Essence]# #VIDEO10#x #I_[Greater Nether Essence]# #VIDEO40#x #I_[Purple Lotus]# " ..
			"#VIDEO20#x #I_[Crystal Vial]# #VIDEO4x# #I_[Greater Eternal Essence]# #VIDEO2#x #I_[Large Brilliant Shard]# " ..
			"#VIDEO1#x #I_[Shadowgem]# #VIDEO1x# #I_[Iridescent Pearl]# #VIDEO1#x #I_[Black Pearl]# " ..
			"#VIDEO1#x #I_[Golden Pearl]# #VIDEO1x# #I_[Copper Rod]# #VIDEO1#x #I_[Silver Rod]# " ..
			"#VIDEO1#x #I_[Golden Rod]# #VIDEO1#x #I_[Truesilver Rod]# #VIDEO1#x #I_[Arcanite Rod]# " },
...
-----------1-300 Engineering
	[7007] = {
		...
		items = {
			...
			[2] = { str = "#Q_Aprx. Mats Required#: " ..
			"#VIDEO90#x #I_[Rough Stone]# #VIDEO80#x #I_[Coarse Stone]# #VIDEO75#x #I_[Heavy Stone]# " ..
			"#VIDEO90#x #I_[Solid Stone]# #VIDEO50#x #I_[Dense Stone]# #VIDEO10#x #I_[Wooden Stock]# " ..
			"#VIDEO29#x #I_[Weak Flux]# #VIDEO50#x #I_[Heavy Leather]# #VIDEO10#x #I_[Wool Cloth]# " ..
			"#VIDEO10#x #I_[Mageweave Cloth]# #VIDEO33#x #I_[Rune Cloth]# #VIDEO51#x #I_[Copper Bars]# " ..
			"#VIDEO10#x #I_[Silver Bars]# #VIDEO55#x #I_[Bronze Bars]# #VIDEO19#x #I_[Iron Bars]# " ..
			"#VIDEO4#x #I_[Steel Bars]# #VIDEO126#x #I_[Mithril Bars]# #VIDEO129#x #I_[Thorium Bars]# " },
...
-----------1-300 Leatherworking
	[7008] = {
		...
		items = {
			...
			"#VIDEO275#x #I_[Light Leather]# #VIDEO20#x #I_[Light Hide]# #VIDEO25#x #I_[Medium Hide]# " ..
			"#VIDEO420#x #I_[Heavy Leather]# #VIDEO10#x #I_[Heavy Hide]# #VIDEO30#x #I_[Bolt of Silk Cloth]# " ..
			"#VIDEO10#x #I_[Iron Buckles]#" },
			...
			[16] = { str = "#VIDEO[205-250]# #Q_Aprx. Mats Required#:                                            " ..
				"#ACCEPTElemental Leatherworking#: #VIDEO405-455#x #I_[Thick Leather]#                                            " ..
				"#ACCEPTDragonscale Leatherworking:# #VIDEO441-483#x #I_[Thick Leather]# #VIDEO40#x #I_[Scorpid Scale]# #VIDEO10#x #I_[Worn Dragonscale]#                                            " ..
				"#ACCEPTTribal Leatherworking#: #VIDEO427-449#x #I_[Thick Leather]# #VIDEO112#x #I_[urtle Scale]# #VIDEO11#x #I_[Wildvine]# #VIDEO2#x #I_[Cured Thick Hide]#" },
			...
			[32] = { str = "#VIDEO[250-300]# #Q_Aprx. Mats Required#: #VIDEO160#x #I_[Thick Leather]# #VIDEO470#x #I_[Rugged Leather]#" },
...
-----------1-300 Tailoring
	[7009] = {
		...
		items = {
			...
			[2] = { str = "#Q_Aprx. Mats Required#: #VIDEO160#x #I_[Linen Cloth]# #VIDEO200#x #I_[Wool Cloth]# #VIDEO760#x #I_[Silk Cloth]# " ..
			"#VIDEO520#x #I_[Mageweave Cloth]# #VIDEO900#x #I_[Runecloth]# #VIDEO120#x #I_[Rugged Leather]# " ..
			"#VIDEO75#x #I_[Coarse Thread]# #VIDEO135#x #I_[Fine Thread]# #VIDEO5#x #I_[Gray Dye]# " ..
			"#VIDEO30#x #I_[Blue Dye]# #VIDEO10#x #I_[Bleach]# #VIDEO60#x #I_[Red Dye]# " ..
			"#VIDEO45#x #I_[Silken Thread]# #VIDEO60#x #I_[Heavy Silken Thread]# #VIDEO40#x #I_[Rune Thread]# " },
